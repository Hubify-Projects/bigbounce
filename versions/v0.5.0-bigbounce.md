...
We outline—but do not execute—a full Bayesian parameter-inference framework (Section 3.6) that would be necessary to quantitatively assess whether this model alleviates the Hubble (H₀: Planck ~67 km s⁻¹ Mpc⁻¹ vs SH0ES ~73 km s⁻¹ Mpc⁻¹, ~5σ tension as of 2026) and matter-clustering (S₈: CMB ~0.81–0.83 vs weak lensing ~0.75–0.78, ~2–3σ discrepancy) tensions. Without marginalized posterior distributions, Bayes factors, or MCMC fits comparing this model to ΛCDM, we cannot claim tension alleviation; we present only qualitative motivation for why geometric effects might contribute. Recent DESI/DES 2026 data reveal evolving dark energy properties and potential deviations from ΛCDM but do not directly test Big Bounce cosmologies or confirm tension relief in spin-torsion frameworks. Any quantitative assessment is deferred to future work. This manuscript focuses on rigorous theoretical derivations, transparent statement of assumptions, and falsifiable observational predictions to guide experimental tests over the coming decade.
