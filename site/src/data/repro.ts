...
export const reproExperiments: ReproExperiment[] = [
  ...
  },
  {
    ...
    "reproduction": {
      ...
      "parallelizable": true,
      "resume_support": true,
      "notes": "The AUG-011 clean rerun is complete and receipt-verified: 36,634/36,634 shard groups scored, 28,425,963 raw rows, 27,547,223 unique TARGETIDs, 878,740 duplicate rows removed, and 52,188 candidates above the sealed anomaly_score>5.0 threshold. The full corpus and derived sample artifacts are not in this checkout. A 2026-08-26 authenticated audit found B2 retains exactly 36,634 shard objects and 36,634 receipt objects under aug-011-clean-rerun/; Hugging Face exposes a partial private mirror (10,000 receipt files plus sealed inputs/checkpoints). Do not describe the corpus as anonymously public or forkable from this repository. Remaining active work is downstream sample selection, validation, taxonomy, external-catalog joins, and manuscript drafting."
    },
    "outputs": [
      {
    ...
    "provenance": [
      ...
      "2026-08-26 authenticated provider audit: B2 aug-011-clean-rerun/ contains 36,634 receipts and 36,634 shards; Hugging Face bamfai/bigbounce-aug-011-clean-rerun exposes 10,000 receipt files plus sealed inputs/checkpoints, so it is a partial private mirror rather than the complete corpus",
