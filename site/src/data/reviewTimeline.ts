...
export const reviewRounds: ReviewRound[] = [
  ...
  },
  {
    ...
    timePT: "afternoon",
    kind: "closure-wave",
    title: "P4 v1.0.244 — bounded catalog-release transform and independent reproduction",
    papers: ["P4"],
    summary:
    ...
    links: [
      { label: "manuscript", href: `${GH}/pipelines/p2_chirality/chirality_catalog_paper.tex` },
      { label: "canonical status", href: `${GH}/project-context/SSOT/paper-4/status.md` },
      { label: "release-transform commit", href: `${GH_COMMIT}/e0d1c087` },
      { label: "release proof commit", href: `${GH_COMMIT}/96ddd888` },
    ],
  },
  {
  ...
  },
  {
    ...
    gapMetric: {
      externalOnlyFindings: 0,
      note: "M41-EXT: 0 genuinely-new on P5 and P2. Every finding a source-cited standing DP5/DP2 re-flag or disclosed-scope limitation; the ChatGPT REJECT/MAJOR verdict words are the documented maximal-harsh-referee floor on byte-unchanged content. No edits warranted; no bumps.",
    },
    links: [
      {
        label: "P5 M41 truth-audit",
        href: `${PR}/EXT_real/H17_2026-07-10/M41/P5_truth_audit_M41.md`,
      },
      {
        label: "P2 M41 truth-audit",
        href: `${PR}/EXT_real/H17_2026-07-10/M41/P2_truth_audit_M41.md`,
      },
      { label: "DISPOSITIONS/P5.md", href: `${PR}/DISPOSITIONS/P5.md` },
      { label: "DISPOSITIONS/P2.md", href: `${PR}/DISPOSITIONS/P2.md` },
    ],
  ...
  },
  {
    ...
    links: [
      {
        label: "PROCESS_AUDIT_2026-07-14.md",
        href: `${GH}/project-context/PROCESS_AUDIT_2026-07-14.md`,
      },
      {
        label: "attachment-token verification (854acb99)",
        href: `${GH_COMMIT}/854acb99`,
      },
      {
        label: "post_verdict cap/clobber fix (cd02c991)",
        href: `${GH_COMMIT}/cd02c991`,
      },
    ],
  },
  {
  ...
  },
  {
    ...
    gapMetric: {
      externalOnlyFindings: 0,
      note: "M26/M27-EXT ChatGPT recovery: 0 genuinely-new across all three orphaned legs. P3 M27 = first ChatGPT read of the DAS-fixed v3.1.159-apjs, DP3-21 fix HELD. P1U/P4 M26 = harsh-referee/oscillation floors on byte-unchanged content. Streaks HOLD 11/10/2; P4 cap 80→74 (REJECT=0 replaces MAJOR-carry), P1U/P3 caps HOLD 62/56. Every finding a source-cited standing D-id re-flag; no edit warranted.",
    },
    links: [
      { label: "P1U disposition ledger (M26-EXT)", href: `${PR}/DISPOSITIONS/P1U.md` },
      { label: "P4 disposition ledger (M26-EXT)", href: `${PR}/DISPOSITIONS/P4.md` },
      { label: "P3 disposition ledger (M27-EXT)", href: `${PR}/DISPOSITIONS/P3.md` },
      { label: "P1U ChatGPT raw (M26)", href: `${PR}/EXT_real/H17_2026-07-10/M26/P1U_chatgpt_M26.md` },
      { label: "P4 ChatGPT raw (M26)", href: `${PR}/EXT_real/H17_2026-07-10/M26/P4_chatgpt_M26.md` },
      { label: "P3 ChatGPT raw (M27)", href: `${PR}/EXT_real/H17_2026-07-10/M27/P3APJS_chatgpt_M27.md` },
    ],
  },
  {
    id: "m28-m29-ext-p2-p5-grok-2026-07-13",
    dateISO: "2026-07-13",
    kind: "external-browser",
    title:
    ...
    gapMetric: {
      externalOnlyFindings: 0,
      note: "M28/M29-EXT: 0 genuinely-new on both papers. P5 first EXT after the DP5-26 reset — streak rebuilds 0→1, cap 74 HOLDS (Grok MINOR/ChatGPT MAJOR/Gemini MAJOR). P2 Grok pattern-066 MINOR→MAJOR slip on byte-unchanged v1.7.116 — streak 11→12, cap 74→68. Every finding a source-cited re-flag/OPINION/OPEN-COMPUTE; no edit warranted.",
    },
    links: [
      { label: "P5 disposition ledger (M28/M29-EXT)", href: `${PR}/DISPOSITIONS/P5.md` },
      { label: "P2 disposition ledger (M28-EXT)", href: `${PR}/DISPOSITIONS/P2.md` },
      { label: "P5 Grok raw (M29)", href: `${PR}/EXT_real/H17_2026-07-10/M29/P5_grok_M29.md` },
      { label: "P2 Grok raw (M28)", href: `${PR}/EXT_real/H17_2026-07-10/M28/P2_grok_M28.md` },
    ],
  },
  {
    id: "m28-int-p1u-p5-2026-07-13",
    dateISO: "2026-07-13",
    kind: "internal-api",
    title:
    ...
    gapMetric: {
      externalOnlyFindings: 0,
      note: "P1U M28-INT: 0 genuinely-new reader-visible (2 Claude PROCESS-NITs close-no-reset), streak 11→12, cap 62 HOLDS. P5 M28-INT: 1 genuinely-new reader-visible (INT-Claude DP5-26 artifact-ID range), CLOSED v0.1.127, streak 10→0 (directive-K reset), cap 80 HOLDS. INT verdicts do NOT move EXT-derived caps; INT legs recorded via externalReviews M28-INT-<vendor> + readinessMetrics wave rows.",
    },
    links: [
      { label: "P1U disposition ledger (M28-INT)", href: `${PR}/DISPOSITIONS/P1U.md` },
      { label: "P5 disposition ledger (M28-INT + DP5-26)", href: `${PR}/DISPOSITIONS/P5.md` },
      { label: "P1U INT raws (OpenAI/Grok/Gemini)", href: `${PR}/INT_v3/ROUND_2026-07-09/API_P1U_openai.md` },
      { label: "P5 INT raws (OpenAI/Grok/Gemini)", href: `${PR}/INT_v3/ROUND_2026-07-09/API_P5_openai.md` },
    ],
  },
  {
  ...
  },
  {
    ...
    gapMetric: {
      externalOnlyFindings: 0,
      note: "0 genuinely-new reader-visible editable findings across P1U M16-EXT (Grok MAJOR→MINOR slip-back + ChatGPT REJECT harsh floor) and P4 M16-EXT (Grok MINOR closing-affirms + ChatGPT MAJOR 5th consecutive non-REJECT). P1U streak 6→7 cap 62→68; P4 streak 5→6 cap 74 HOLDS.",
    },
    links: [
      { label: "P1U Grok M16 EXT raw", href: `${PR}/EXT_real/H17_2026-07-10/M16/P1U_grok_M16.md` },
      { label: "P1U ChatGPT M16 EXT raw", href: `${PR}/EXT_real/H17_2026-07-10/M16/P1U_chatgpt_M16.md` },
      { label: "P4 Grok M16 EXT raw", href: `${PR}/EXT_real/H17_2026-07-10/M16/P4_grok_M16.md` },
      { label: "P4 ChatGPT M16 EXT raw", href: `${PR}/EXT_real/H17_2026-07-10/M16/P4_chatgpt_M16.md` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      ...
      { label: "P1U truth-audit (NJ2)", href: `${PR}/EXT_real/H17_2026-07-10/NJ2/P1U_NJ2_truth_audit.md` },
      { label: "P5 truth-audit (RS1)", href: `${PR}/EXT_real/H17_2026-07-10/RS1/P5_RS1_truth_audit.md` },
    ],
  },
  {
  ...
  {
    id: "p1u-nj1-njl-holst-factor-closure-2026-07-12",
    kind: "closure-wave",
    dateISO: "2026-07-12",
    timePT: "07:00",
    title: "P1U NJ1 — NJL Holst factor 30×→14× closure",
    papers: ["P1A"],
    summary: "NJ1 wave — INT-Claude verified the new NJL-exclusion appendix SOUND and caught the Holst NJL factor stated as ∼30× when the paper's own committed script gives ∼14×; corrected in v1U.0.15, conclusion unchanged; EXT Grok MAJOR + ChatGPT REJECT re-flagged old ledger classes without engaging the new appendix; streak reset to 0.",
    keyTakeaways: [
    ...
    links: [{ label: "Review round", href: "/reviews" }],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "loop_watchdog.sh (canonical source)", href: `${GH}/tools/loop_watchdog.sh` },
      { label: "loop-never-dies audit", href: `${GH}/project-context/REPEATED_ASKS_AUDIT_2026-07-11.md` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "P5 Grok W4 raw (MINOR)", href: `${PR}/EXT_real/H17_2026-07-10/W4/P5_grok_W4.md` },
      { label: "P5 ChatGPT W4 raw (MAJOR, up from REJECT)", href: `${PR}/EXT_real/H17_2026-07-10/W4/P5_chatgpt_W4.md` },
      { label: "P5 W4-EXT adjudication", href: `${PR}/EXT_real/H17_2026-07-10/P5_truth_audit.md` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "H17F final-wave raws", href: `${PR}/EXT_real/H17_2026-07-10/final/` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "H17 raws + manifest", href: `${PR}/EXT_real/H17_2026-07-10/` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "CV raw reviews + screenshots", href: `${PR}/EXT_real/CV_2026-07-09` },
      { label: "CV manifest", href: `${PR}/EXT_real/CV_2026-07-09/manifest.jsonl` },
    ],
  },
  {
    id: "W13-ext-retest-p1u-p2-2026-07-09",
    dateISO: "2026-07-09",
    kind: "external-browser",
    title:
    ...
    links: [
      { label: "W13 raw reviews + screenshots", href: `${PR}/EXT_real/W13_2026-07-09` },
      { label: "P1U raws (Grok/ChatGPT/Gemini)", href: `${PR}/EXT_real/W13_2026-07-09` },
      { label: "P2 raws (Grok/ChatGPT/Gemini)", href: `${PR}/EXT_real/W13_2026-07-09` },
      { label: "manifest", href: `${PR}/EXT_real/W13_2026-07-09/manifest.jsonl` },
    ],
  },
  {
    id: "CV-conversion-p3-p4-p5-2026-07-09",
    dateISO: "2026-07-09",
    kind: "external-browser",
    title:
    ...
    links: [
      { label: "CV raw reviews + screenshots", href: `${PR}/EXT_real/CV_2026-07-09` },
      { label: "P4 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CV_2026-07-09` },
      { label: "P5 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CV_2026-07-09` },
      { label: "P3 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CV_2026-07-09` },
      { label: "manifest", href: `${PR}/EXT_real/CV_2026-07-09/manifest.jsonl` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "W12 raw reviews + screenshots", href: `${PR}/EXT_real/W12_2026-07-09` },
      { label: "manifest", href: `${PR}/EXT_real/W12_2026-07-09/manifest.jsonl` },
      { label: "P1U source (paper1_unified.tex)", href: `https://github.com/Hubify-Projects/bigbounce/blob/main/arxiv/paper1_unified.tex` },
      { label: "P2 source (02_full_draft.tex)", href: `https://github.com/Hubify-Projects/bigbounce/blob/main/research/focused_paper_source_integration/02_full_draft.tex` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "CA raw reviews + screenshots", href: `${PR}/EXT_real/CA_2026-07-09` },
      { label: "P4 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CA_2026-07-09` },
      { label: "P5 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CA_2026-07-09` },
      { label: "P3 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/CA_2026-07-09` },
      { label: "manifest", href: `${PR}/EXT_real/CA_2026-07-09/manifest.jsonl` },
    ],
  },
  {
    id: "W11-closure-p1u-p2-2026-07-09",
    dateISO: "2026-07-09",
    kind: "ext-closure",
    title:
    ...
    links: [
      { label: "W11 raw reviews + screenshots", href: `${PR}/EXT_real/W11_2026-07-09` },
      { label: "P1U source (paper1_unified.tex)", href: `https://github.com/Hubify-Projects/bigbounce/blob/main/arxiv/paper1_unified.tex` },
      { label: "P2 source (02_full_draft.tex)", href: `https://github.com/Hubify-Projects/bigbounce/blob/main/research/focused_paper_source_integration/02_full_draft.tex` },
    ],
  },
  {
    id: "W11-ext-newest-versions-2026-07-09",
    dateISO: "2026-07-09",
    kind: "external-browser",
    title:
    ...
    links: [
      { label: "W11 raw reviews + screenshots", href: `${PR}/EXT_real/W11_2026-07-09` },
      { label: "P1U raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/W11_2026-07-09` },
      { label: "P2 raws (ChatGPT/Grok/Gemini)", href: `${PR}/EXT_real/W11_2026-07-09` },
      { label: "manifest", href: `${PR}/EXT_real/W11_2026-07-09/manifest.jsonl` },
    ],
  },
  {
  ...
  },
  {
    ...
    links: [
      { label: "P1U3 raw reviews + screenshots", href: `${PR}/EXT_real/P1U3_2026-07-09` },
      { label: "ChatGPT raw (REJECT→MAJOR)", href: `${PR}/EXT_real/P1U3_2026-07-09/chatgpt.md` },
      { label: "Grok raw (MAJOR held)", href: `${PR}/EXT_real/P1U3_2026-07-09/grok.md` },
      { label: "Gemini raw (MINOR→MAJOR)", href: `${PR}/EXT_real/P1U3_2026-07-09/gemini.md` },
      { label: "manifest", href: `${PR}/EXT_real/P1U3_2026-07-09/manifest.jsonl` },
...
export const externalVerdictRounds: ExternalRoundVerdicts[] = [
  ...
  {
    roundId: "P1U3-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · UNIFIED Paper 1 v1U.0.3 re-test (v0.2 seams + v0.3 minor-closures since v1U.0.1) · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["MAJOR", "MAJOR", "MAJOR"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
  ...
  {
    roundId: "W11-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · EXT on the two newest versions (P1U v1U.0.4 · P2 v1.7.105) — DERIVED dim-4 R4 completion + full per-vertex f_NL table · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["MAJOR", "ACCEPT", "MAJOR"],
    ...
    note: "EXT on the two newest versions whose owner-agents just DERIVED the content the prior majors demanded — P1U v1U.0.4 (genuine dim-4 R4 parity-odd completion + term-by-term perturbation-transparency + retitle) and P2 v1.7.105 (full per-vertex derivation table for the matter-bounce f_NL). Verdict matrix (ChatGPT/Grok/Gemini) FROM RAW: P1U MAJOR/MINOR-accept-track/MAJOR · P2 MAJOR/ACCEPT-track/MAJOR. (P1U is the unified Paper 1 with no P1A/P1B matrix column — its result lives in this note + the W11 reviewRounds entry; the P2 row is recorded above with Grok=ACCEPT-track.) Vs baselines (P1U REJ/MAJ/MAJ · P2 MAJ/MIN/MIN): the DERIVED dim-4 completion and the per-vertex table BOTH lifted the specific majors they targeted. P1U — Grok MAJOR→'ready for resubmission after light polishing' (no BLOCKERS/MAJORS, crediting the new dim-4 parity-odd basis + Fierz-by-Fierz completeness machinery), ChatGPT REJECT→MAJOR (BLOCKER-2 = dim-4 'not genuinely derived at publication standard' is a formal-basis/presentation objection not a math error), Gemini MAJOR held but its dim-4 scrutiny CONCLUDES 'the closure of R4 is structurally sound… the author successfully demonstrates' (dim-4/naturalness closure ACCEPTED; residual is a presentation ask to rewrite Eq.6 with a formally dim-4 off-shell completion — same class as ChatGPT B2). P2 — Grok 'publication-ready for PRD/JCAP/MNRAS' crediting the paper with resolving the 8-year factor-of-two on f_NL=−35/16, Gemini MAJOR but calls the per-vertex re-summation 'executed flawlessly / decisively settles' (derivation NOT the issue; MAJOR driver = SPHEREx additive-quadrature budget 'soft' + MegaMapper systematics 'uncalibrated', partly disclosed illustrative), ChatGPT MAJOR whose BLOCKER quotes the paper's OWN hedging ('does not claim a complete term-by-term derivation of Cai's error'; the term is 'not by itself the full mechanism') = settles-exactly-vs-evidence-favors claim-calibration flag, table credited internally-summable to −35/16. Residual majors are presentation (P1U dim-4 off-shell formalization) and forecast-methodology/claim-strength (P2 SPHEREx quadrature + Cai-error completeness language) — editable, non-fabrication, several self-disclosed. Infra: both Gemini legs dropped empty on first submit (nav-away persistence failure) and were re-run in-place (persistence-verified). 6/6 legs harvested with raw verbatim text + screenshots, 0 fabricated. Raws in EXT_real/W11_2026-07-09/.",
  },
  {
    roundId: "CA-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · CLEAN-ACCEPT re-test after W10-minor closure (P4 v1.0.226 · P5 v0.1.109 · P3 v3.1.147) — every W10 reviewer minor closed; the with-minor→ACCEPT conversion is the direct test · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P3: ["MAJOR", "ACCEPT", "MINOR"],
      P4: ["ACCEPT", "ACCEPT", "MINOR"],
      P5: ["ACCEPT", "ACCEPT", "MINOR"],
    },
    note: "CLEAN-ACCEPT re-test on the versions where every W10 Accept-with-Minor was CLOSED — the direct with-minor→ACCEPT conversion test. Verdict matrix (ChatGPT/Grok/Gemini) FROM RAW: P4 ACCEPT/ACCEPT-track/MINOR · P5 ACCEPT/ACCEPT-track/MINOR · P3 MAJOR/ACCEPT-track/MINOR. *** TWO LITERAL ChatGPT ACCEPTs *** — P4 ChatGPT '(1) VERDICT: ACCEPT' (4 MINORs: Table V 'do not compare' note, ℓ=1 residual abstract phrasing, Zenodo DOI before submission, catalog column naming; central claim SUPPORTED) and P5 ChatGPT '(1) VERDICT: ACCEPT' (6 MINORs: companion-cite placeholders, Bonferroni-family abstract emphasis, real-vs-redshift-space box, ~15-20% length trim, Appendix B to supplementary, DR2/Rubin caveat; central claim SUPPORTED). These are the FIRST literal ChatGPT ACCEPTs of the campaign on P4/P5 — the harsh-referee floor lifted once its own W10 minors were closed. Grok: P4 'This version is ready for journal submission (PRD/JCAP/MNRAS); minor points are polishing not substantive' (0 majors), P5 'clean, rigorously executed, transparently reported bounded null result… fully consistent with parity… robust' (0 majors), P3 'Overall Assessment: This paper is arXiv-ready' (0 major issues; the only 'major' token is 'delivers a major, well-validated catalog' = praise). Gemini: P4 MINOR REVISIONS 'no major issues that invalidate the cosmological conclusions' (4 MINORs, central claim 'fully and robustly supported'), P5 MINOR REVISIONS 'no major issues blocking publication' (3 MINORs, central claim 'robustly supported'), P3 MINOR REVISIONS 'no major flaws remain unaddressed by the author's own proactive excisions' (4 MINORs, central claim 'fully supported') — an UPGRADE off P3's W10/R9 MAJOR floor. P3 ChatGPT HELD MAJOR REVISIONS (4 MAJORs: NEOWISE 'validated catalog-grade' labeling vs geometry-only QA gate, SDSS 77,905 continuity-slice not a physical threshold, DESI headline dominated by non-science-target/sky/filler spectra vs 2,468 like-for-like science clusters, reproducibility artifacts 'will be released' not yet public at submission; central claim BROADLY SUPPORTED but headline overstates validation uniformity). Notably Gemini rates the SAME NEOWISE-validation + DESI-multiplier items as MINOR (crediting them as already-disclosed in-paper) that ChatGPT flags as MAJOR — the P3 residual is the recurring venue/framing-structural class per patterns 061-064 + directive-H (harsh-referee floor), truth-audit required; not a genuinely-new content error. NET: P4 = ChatGPT ACCEPT + Grok accept-track + Gemini 0-major = the with-minor→ACCEPT conversion CONFIRMED; P5 = same, CONFIRMED; P3 = Grok+Gemini accept-track, ChatGPT at structural floor (2/3). No prior closed item reopened; new findings all polish-tier MINOR or self-disclosed re-flags (P3 ChatGPT). Per /readiness-cap-99 the literal ACCEPTs on P4/P5 flag for Houston sign-off but caps stay ≤96 (not auto-100). Infra: P4 Grok first submit interrupted (re-run clean); P3 ChatGPT first submit posted PDF only (prompt re-sent in-thread, clean); all Gemini legs persistence-verified from fresh home. 9/9 legs harvested with raw verbatim text + screenshots, 0 fabricated. Raws in EXT_real/CA_2026-07-09/.",
  },
  {
    roundId: "W12-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · EXT re-test of P1U v1U.0.5 (formal dim-4 Eq.7 promoted into main text — the exact ChatGPT+Gemini ask) + P2 v1.7.106 (calibrated f_NL=−35/16 claim + explicit Eq.11 systematic budget + sensitivity map) · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["MAJOR", "MINOR", "MINOR"],
    ...
    note: "Targeted convert-test of the two revisions that directly addressed the prior (W11) majors — P1U v1U.0.5 promoted the dimension-4 parity-odd basis + Eq.(7) formal completeness into the MAIN TEXT (the exact ask ChatGPT+Gemini raised at W11), and P2 v1.7.106 fixed the headline f_NL=−35/16 everywhere + added the explicit Eq.(11) systematic budget + a Table V/Fig 2 sensitivity map. Verdict matrix (ChatGPT/Grok/Gemini) FROM RAW: P1U MAJOR/MAJOR/MAJOR · P2 MAJOR/MINOR/MINOR. (P1U is the unified Paper 1 with no P1A/P1B matrix column — its result lives in this note + the W12 reviewRounds entry; the P2 row is recorded above with Grok=MINOR + Gemini=MINOR.) Vs W11 baselines (P1U MAJ/MAJ/MAJ · P2 MAJ/MIN/ACCEPT-track): the P2 calibration+budget CONVERTED (Grok MAJOR→MINOR, Gemini held accept-track/MINOR), the P1U Eq.7 rewrite did NOT convert (all three held MAJOR). *** P2 — the calibration worked. *** Grok MAJOR→MINOR 'the two prior-round requests (single calibrated f_NL value + explicit Eq.(11) budget + sensitivity map) are now closed or closed-with-minor-scoping-caveats… no technical blockers remain… remaining issues are almost entirely presentational' (3 presentation majors on MegaMapper-envelope Fig-2 headlining + endpoint-language drift, all editable). Gemini MINOR REVISIONS 'successfully resolved its core theoretical discrepancies and codified a transparent systematic budget, moving it significantly closer to publishability at full PRD standards' (0 blocking majors). ChatGPT HELD MAJOR — credits the fix ('the authors now make the intended −35/16 value visible everywhere important, add Eq.(11), and provide a real Table V/Figure 2 sensitivity dashboard') but flags 'unresolved internal contradictions' in the factor-of-two forensic algebra + forecast-shape propagation = its recurring claim-calibration / harsh-referee floor (patterns 061-064 + directive-H), editable-not-fabrication, truth-audit required. *** P1U — the Eq.7 promotion did NOT convert; all three HELD MAJOR. *** ChatGPT MAJOR 'the central Eq.(7) closure still fails the strict test… not fully in-main-text, and its dimension-4 basis with dimensionless coefficients is not dimensionally correct as written' (a specific dimensional-consistency objection on the promoted basis — the first genuinely-new technical flag, must be truth-audited: does the promoted Eq.7 basis carry correct mass dimensions?). Grok MAJOR 'the dimension-4 parity-odd basis enumeration and formal completeness argument for Eq.(7) remain only partially promoted to the main text' (still-partial promotion + R1-R3/R4 evidentiary asymmetry). Gemini MAJOR 'the central theoretical requirement of establishing the explicit dimension-4 basis definitions inside the main text remains unfulfilled.' NET: P2 = Grok+Gemini both accept-track (MINOR), ChatGPT at claim-calibration floor = the calibration+budget conversion CONFIRMED on 2/3 (Grok upgraded off its W11 MAJOR); P1U = 0/3, all three hold MAJOR on the SAME Eq.7 main-text-promotion + dimensional-consistency axis, with ChatGPT raising a specific new dimensionless-coefficient dimensional flag that is the actionable next-close target. NO literal ACCEPT this round. No prior closed item reopened. Infra: both Gemini submissions AND a first re-run dropped on nav-away (session-URL persistence failure this session) — both Gemini legs re-run and harvested INLINE without navigation (persistence-verified). 6/6 legs harvested with raw verbatim text + screenshots, 0 fabricated. Raws in EXT_real/W12_2026-07-09/.",
  },
  {
    roundId: "W12-P2-CLOSE-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · P2 v1.7.107 presentation-closure of W12 reviewer findings · NO headline number changed · -35/16 UNCHANGED · nothing fabricated",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["MAJOR", "MINOR", "MINOR"],
    ...
    note: "P2 v1.7.107 presentation-only closure of all closeable W12 findings (Grok/ChatGPT/Gemini). NO headline number changed, f_NL=-35/16=-2.1875 UNCHANGED, nothing fabricated. Closures: (1) Grok MAJOR-2 + ChatGPT BLOCKER-1 tone/mechanism: replaced 'arithmetic error' and 'traces to a single spurious term [as sole mechanism]' with neutral scholarly framing per Grok's suggested wording — 'one identified discrepancy within the printed polynomial collapse, not the sole complete mechanism of the doubling'; App-A honest framing now consistent with abstract+Sec-II language; (2) ChatGPT BLOCKER-5 / stale MegaMapper ~3-7sigma in Sec IX conclusion: replaced with calibrated Sec V numbers (1.5-3.85sigma envelope; ideal 3.7-3.85sigma, conservative post-budget 1.5-3.5sigma); (3) ChatGPT BLOCKER-4 / GR-correlation bracket: added '(~0.8-2.75sigma under the unresolved GR-correlation bracket; ~1.3sigma under the SDB-proxy correlation)' disclosure to abstract; (4) ChatGPT MAJOR-3: Table V caption relabeled 'Scenario/scoping budget (heuristic additive-quadrature; not a joint-covariance forecast)'; (5) Grok MINOR-1 + ChatGPT MINOR-3: fixed endpoint labels 'SPHEREx optimistic' / 'SPHEREx post-budget' added to abstract scope paragraph; (6) Gemini MAJOR-2: cross-channel covariance structural caveat paragraph added in Sec VII; (7) Grok MINOR-3 + ChatGPT MAJOR-6 (partial): Data and Code Availability updated with explicit committed script list and Heinrich external-unavailability disclosure; (8) ChatGPT MINOR-2: notation disambiguation note added; (9) ChatGPT MINOR-1: figure captions trimmed. Items NOT closed (require new calculations outside presentation-closure scope): ChatGPT BLOCKER-2 (recompute r from corrected vertex polynomial), BLOCKER-3 (null-space scatter reclassification), MAJOR-1 (single headline estimator), MAJOR-2 (cubic matching derivation), MAJOR-4 (Bayes restructure), MAJOR-6 (Zenodo DOI — camera-ready). These are disclosed structural scope items per pattern-066 + directive-H. PDF: v1.7.107, md5=26617d5d1ed66da084e4952d1514ca32, 38 pages, 1376204 bytes. Convex bump posted. Served PDFs mirrored byte-identical. latex-audit: 0 overfull hboxes, 0 undefined references.",
  },
  {
    roundId: "CV-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · CONVERSION wave after every reviewer's every CA-round item was closed on P4 v1.0.227 · P5 v0.1.110 · P3 v3.1.148 (incl. all four of ChatGPT's P3 CA majors as framing/reproducibility edits) — the triple-clean convert-test · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
    ...
    note: "CONVERSION wave: after every reviewer's every CA-round item was CLOSED on all three papers (P4 v1.0.226→v1.0.227, P5 v0.1.109→v0.1.110, P3 v3.1.147→v3.1.148, incl. all four of ChatGPT's P3 CA majors reworked as framing/reproducibility edits), a fresh triple-clean convert-test. Verdict matrix (ChatGPT/Grok/Gemini) FROM RAW: P4 MAJOR/MINOR/MINOR · P5 MAJOR/MINOR/MINOR · P3 MAJOR/MINOR/MAJOR. NO literal ACCEPT this round — the target triple-clean boards did NOT land; the two ChatGPT ACCEPTs from CA REOPENED. *** ChatGPT reopened BOTH null-result papers off its own CA ACCEPT *** — P4 ACCEPT→MAJOR (worked 8m6s: central inference about the unexplained harmonic residual, hemisphere/look-elsewhere inconsistency, immutable-artifact archiving, reframe the z≈−18 template result re classifier-dilution+sample-selection; 'dataset/methodology potentially important… may well be publishable' but 'must substantially revise'), P5 ACCEPT→MAJOR (calibrate/limit the chirality-label bound, make the DESIVAST in-footprint control sample the PRIMARY result, repair systematic-envelope accounting, immutable reproducibility artifacts; 'central null result is promising, but the current form overstates the precision and physical interpretation'). This is the exact pattern-066/directive-H harsh-referee oscillation on UNCHANGED-or-improved honestly-scoped content (the CA note already flagged the CA ACCEPTs as the harsh-referee floor lifting, not a durable signal) — a single-sweep ChatGPT ACCEPT is not reproducible across sweeps; truth-audit each reopened major as re-flag/scope. P3 ChatGPT HELD MAJOR (8m31s) re-flagging the SAME class as CA (SDSS 77,905 continuity-slice, DESI science-target reconciliation, validated-headline composition, reproducibility/validation caveats) — items the paper discloses, the recurring venue/framing floor (patterns 061-064 + directive-H); credits SIMBAD cross-match + dedup audit + LAMOST methodological warning; NOT genuinely-new content errors given the CA closures. Grok FIRMED accept-track on all three but with the literal verdict word MINOR REVISIONS this round: P4 'ready for journal submission… minor abstract-clarity + readability polish, 0 blockers/majors', P5 'I recommend acceptance… the two items are minor wording tightenings that do not affect any scientific conclusion', P3 'strong, ambitious paper… meets a high standard… the three major suggestions are clarifications not corrections of errors… suitable for publication' (P3 Grok MAJOR→MINOR/accept-track). Gemini: P4 MINOR (0 majors, HELD from CA), P5 MINOR (0 majors, HELD from CA), P3 MAJOR — a REGRESSION off CA MINOR flagging (1) full-sample-preprocessing feature-scaling leakage on eROSITA/NEOWISE which the author ALREADY notes as 'legacy production state' (ask = flag the ~15% tail churn more prominently in abstract/data-availability), and (2) DESI redshift-quality reconciliation between Sec III.A and III.C — both disclosure/framing asks on already-disclosed content = pattern-066 referee-variance regression (Gemini flipped MINOR→MAJOR on unchanged/disclosed material), not genuinely-new content errors. NET: NO paper hit triple-clean; the two calibrated referees (Grok+Gemini) stayed accept-track/held on the null-result papers (P4/P5 = Grok MINOR + Gemini MINOR, both 0-major), and the ChatGPT reopenings + Gemini P3 regression are all the harsh-referee/referee-variance floor per patterns 061-064 + pattern-066 + directive-H (truth-audit each as re-flag/scope/disclosed-limitation, none genuinely-new). Per /readiness-cap-99 caps stay ≤96 (no auto-100; NO literal triple-ACCEPT to flag for Houston). 9/9 legs harvested with raw verbatim text + screenshots, 0 FAILED legs, 0 fabricated. Raws in EXT_real/CV_2026-07-09/.",
  },
  {
    roundId: "W13-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · EXT re-test of P1U v1U.0.6 (dimensional fix — explicit M_Pl² prefactors + full main-text promotion of the O1–O6 dim-4 basis) + P2 v1.7.107 (W12 presentation set closed) · headed browser, raw verbatim text + screenshot READ before every recorded verdict",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["MAJOR", "MINOR", "MINOR"],
    ...
    note: "Targeted convert-test of the two revisions that directly addressed the W12 majors — P1U v1U.0.6 landed the dimensional fix (explicit M_Pl² prefactors on the dimension-4 parity-odd basis + full main-text promotion of the six-operator O1–O6 enumeration into Sec II A 2 / Eq 8, the exact ChatGPT+Gemini W12 ask), and P2 v1.7.107 closed the W12 presentation set. Verdict matrix (Grok/ChatGPT/Gemini) FROM RAW: P1U ACCEPT-track/MAJOR/MINOR · P2 MINOR/MAJOR/MINOR. (P1U is the unified Paper 1 with no P1A/P1B matrix column — its result lives in this note + the W13 reviewRounds entry; the P2 row above is stored [ChatGPT,Grok,Gemini] = MAJOR/MINOR/MINOR.) Vs W12 baselines (P1U MAJ/MAJ/MAJ · P2 MAJ/MIN/MIN): *** P1U — the dim-fix CONVERTED 2/3. *** Grok UPGRADE MAJOR→ACCEPT/MINOR ('this version reads as mature and submission-ready'; 0 blockers, 0 majors; dim-4 basis enumeration + main-text promotion 'a genuine strengthening'; recommends PRD/JCAP). Gemini UPGRADE MAJOR→MINOR REVISIONS (confirms the O1–O6 basis is now in the main text with explicit M_Pl² prefactors, basis-completeness verifiable from the main-text equations; tiered closure honest across title/abstract/Table I/Sec IV) — BUT flagged one GENUINELY-NEW REAL editorial defect: a leaked colloquial AI-review sentence \"This is the point ChatGPT's W12 referee pass correctly raised…\" in Sec II A 2 (p9, L447–448) that MUST be scrubbed (real, must-fix). ChatGPT HELD MAJOR — did NOT convert; re-focused onto completeness of the newly-promoted basis ('not yet demonstrated to be a genuine basis or complete enumeration; duplicate representatives; inconsistent powers of κ after torsion elimination; omits classes') = claim-calibration / harsh-referee axis (patterns 061-064 + directive-H), editable-not-fabrication, truth-audit required. *** P2 — split board. *** Grok UPGRADE MAJOR→MINOR/accept-track ('ready for submission to PRD or JCAP after modest tightening for length and a few phrasing clarifications'; 0 blockers, 0 majors). Gemini HELD MINOR REVISIONS, 0 blockers ('no fatal physical flaws, hidden catastrophic assumptions, or mathematical errors') and AFFIRMS the factor-of-2 resolution — 'definitively proving that f_NL^local = −35/16 = −2.1875 is the correct benchmark value' via the vertex-by-vertex symbolic re-summation (Table VII); one presentation MAJOR on mixed-baseline sensitivity envelopes (1.3–2.75σ — label the 2.75σ CMB-weighting endpoint idealized, don't regroup). ChatGPT DOWNGRADE MINOR→MAJOR — re-raised the factor-of-2 objection ('displayed equations do not algebraically connect the proposed polynomial discrepancy to the claimed factor-of-two correction; wants exact vertex-sum polynomial + corrected full shape in one common convention') — the recurring factor-of-2 item, DIRECTLY CONTRADICTED by Gemini's same-round affirmation of −35/16 = referee variance. NET: on BOTH papers the two calibrated referees (Grok+Gemini) converted/held to accept-track/MINOR while ChatGPT held its structural harsh-referee floor (P1U MAJOR, P2 MAJOR) on the SAME axes it always flags (basis-completeness rigor; factor-of-2 algebra presentation) = directive-H. Genuinely-new actionable items: (1) P1U — scrub the leaked ChatGPT/W12 AI-review sentence from Sec II A 2 body (Gemini blocker, REAL, must-fix); (2) P1U — truth-audit ChatGPT's basis-completeness/κ-power objection against the promoted Eq-8 enumeration. NO literal triple-ACCEPT this round; no prior closed item reopened. Infra: mid-sweep the browse daemon wedged during ChatGPT streaming and the managed Chromium died (first ChatGPT P1U leg lost) — recovered via cleanup+headed reconnect and re-ran cleanly. 6/6 legs harvested with raw verbatim text + screenshots, 0 FAILED, 0 fabricated. Raws in EXT_real/W13_2026-07-09/.",
  },
  {
    roundId: "F14-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · FULL 5×3 external sweep (P1U v1U.0.7 · P2 v1.7.107 · P3 v3.1.149 · P4 v1.0.228 · P5 v0.1.111) — every paper × every reviewer in one round · headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["REJECT", "MINOR", "MAJOR"],
      P3: ["REJECT", "MINOR", "REJECT"],
      P4: ["MAJOR", "ACCEPT", "MAJOR"],
      P5: ["MAJOR", "MINOR", "MAJOR"],
    },
    note: "Full 5-paper × 3-reviewer external sweep. Verdict matrix stored [ChatGPT, Grok, Gemini] FROM RAW (verbatim recommendation line READ from each saved raw before recording): P1U MAJOR/MINOR/REJECT · P2 REJECT/MINOR/MAJOR · P3 REJECT/MINOR/REJECT · P4 MAJOR/ACCEPT/MAJOR · P5 MAJOR/MINOR/MAJOR. (P1U is the unified Paper 1 with no P1A/P1B matrix column — its result lives in this note + the F14 reviewRounds entry.) *** ONLY literal ACCEPT this round: P4 Grok *** — verbatim top-of-page 'Peer Review Verdict: ACCEPT', body 'suitable for PRD with only minor revisions… No concerns rise to the level of blocking publication' (3 MINOR: post-MASTER ℓ=1 residual forward-model, pseudo-label/shuffle-null limitations, edge-on argmax tie-break). All five Grok legs are the moderate referee: P1U/P2/P3/P5 = MINOR REVISIONS with NO MAJOR concerns identified (Grok explicitly 'No MAJOR concerns are identified' on P3; 'Minor presentational issues only' on P5). ChatGPT = structural harsh-referee floor: P1U MAJOR (6 majors), P2 REJECT (8 majors), P3 REJECT (6 majors), P4 MAJOR (9-hit body → MAJOR REVISIONS on end-to-end transfer calibration + block-bootstrap distance as primary statistic + partially-modelled harmonic residual), P5 MAJOR (6 majors: dual-primary DESIVAST quantity, void/non-void confounding not adjusted, ≈0.9pp systematic envelope not statistically justified, author-defined footprint ≠ true selection function, headline exceeds physical-chirality evidence, multiple-testing family-wise bound not simultaneously valid). Gemini = harsh this round: P1U REJECT (flags R4 spectator-ALP m_θ∼H_0 tuning as standard quintessence fine-tuning mislabeled as a novel ECH 'barrier'), P3 REJECT, P2/P4/P5 MAJOR REVISIONS. GENUINELY-NEW findings requiring truth-audit before any closure: (a) P5 ChatGPT+Gemini both press the DESIVAST 'dual-primary / footprint-vs-selection-function / 0.9pp-envelope-justification' axis — a real forecast-methodology + claim-calibration cluster, must be audited against §V B / §VIII / Table XI (much is self-disclosed exploratory/post-hoc, but the simultaneous-upper-bound-across-5-estimators objection is a specific statistical claim to check); (b) P1U Gemini's R4-quintessence-tuning objection is a framing/claim-calibration flag (is the m_θ∼H_0 tuning genuinely a distinctive ECH barrier or a generic quintessence feature — audit §R4); (c) P4 ChatGPT's 'observed-label injection thresholds assigned cosmological meaning without end-to-end transfer calibration' is the recurring transfer-calibration axis. Grok (all 5) surfaces only MINOR/presentational (headline-language tightening, Bonferroni-family foregrounding, Appendix-B toy-EFT scoping) — no new blockers. NET: consistent with directive-H referee-variance floor — Grok moderate (1 ACCEPT + 4 MINOR), ChatGPT+Gemini at their harsh floors (REJECT/MAJOR) on the SAME structural axes (basis rigor, factor-of-2 presentation, forecast calibration, headline claim-strength). Only P4 cleared one reviewer to literal ACCEPT; NO paper is triple-clean. Caps stay ≤96. Infra: prior agent stream-died at 9/15 (P1U/P2/P3/P4 × grok+chatgpt + P5_grok banked); this session extracted those 9 verdicts from banked raws and ran the 6 missing legs (P5_chatgpt + all 5 Gemini). ChatGPT hit a rate-limit after P5. 15/15 legs harvested with raw verbatim text + screenshots (P4_chatgpt png missing from the stream-death; raw intact), 0 fabricated. Raws + manifest in EXT_real/F14_2026-07-09/.",
  },
  {
    roundId: "G15-2026-07-09",
    dateISO: "2026-07-09",
    windowPT: "Jul 9 · EXT re-test after the F14 genuinely-new-findings closure wave (P5 v0.1.112 · P1U v1U.0.8 · P4 v1.0.229) — the three papers whose F14 findings were closed with real computation, re-swept ChatGPT/Grok/Gemini · headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
    ...
    note: "9-leg targeted re-test of the three papers whose F14 genuinely-new findings closed with real computation (P5 v0.1.112 43pp · P1U v1U.0.8 59pp · P4 v1.0.229 34pp). Verdict matrix stored [ChatGPT, Grok, Gemini] FROM RAW: P1U REJECT/MINOR/MAJOR · P4 MAJOR/MINOR/MAJOR · P5 MAJOR/MINOR/MAJOR. (P1U is the unified Paper 1 with no P1A/P1B matrix column — its result lives in this note + the G15 reviewRounds entry; the P4/P5 rows above are stored [ChatGPT,Grok,Gemini].) Vs F14 baselines ([ChatGPT,Grok,Gemini]: P1U MAJOR/MINOR/REJECT · P4 MAJOR/ACCEPT/MAJOR · P5 MAJOR/MINOR/MAJOR): *** NO literal ACCEPT this round — the closures did NOT convert any leg to ACCEPT, and the one literal ACCEPT from F14 (P4 Grok) softened to MINOR. *** Movement: P1U Gemini REJECT→MAJOR REVISIONS (the R4 spectator-ALP objection now framed as MCMC-framing + dimensional-scaling of the Eq.6 operator, i.e. re-scoped down from a reject-level barrier to a presentation major); P4 Grok ACCEPT→MINOR REVISIONS (Grok's three concerns all explicitly 'do not block publication… none rise to the level of blocking publication' — still accept-track, just no longer the literal ACCEPT word). Everything else held: P5 identical to F14 (MAJOR/MINOR/MAJOR); P1U ChatGPT held REJECT + Grok held MINOR; P4 ChatGPT held MAJOR + Gemini held MAJOR. Reviewer-axis read: Grok = moderate (3× MINOR, 0 MAJOR concerns identified on any of the three); ChatGPT = structural harsh floor (P1U REJECT on theory-basis/dimensional-operator grounds, P4 MAJOR on end-to-end transfer calibration + block-bootstrap-as-primary-statistic + 47% unmodelled harmonic residual, P5 MAJOR on dual-primary DESIVAST + confounding + 0.9pp envelope); Gemini = harsh but converged down on P1U (P1U MAJOR: MCMC-framing + Eq.6 mass-dimension dressing; P4 MAJOR: 47% residual + CE-ResNet pseudo-label circularity; P5 MAJOR: Paper IV companion dependency + RSD/anisotropic tidal-tensor). Truth-audit read: every G15 MAJOR/REJECT re-flags an already-disclosed limitation or the same structural axis the paper cannot edit away (companion-catalog dependency, RSD-space classification, transfer-calibration scope, MCMC-envelope framing, ECH-vs-generic-quintessence framing) = pattern-066 referee variance + directive-H harsh-referee floor. No genuinely-new content error surfaced that the F14 closures missed. NO paper triple-clean; caps stay ≤96. 9/9 legs harvested with raw verbatim text + screenshots, 0 FAILED legs, 0 fabricated. Note: Gemini's streaming conversation URLs did not persist on direct-nav (known SPA quirk) — P1U/P4 Gemini legs were re-run and harvested live in-session; P5 Gemini + all Grok + all ChatGPT persisted normally. Raws + manifest in EXT_real/G15_2026-07-09/.",
  },
  {
    roundId: "H17-2026-07-10",
    dateISO: "2026-07-10",
    windowPT: "Jul 10 · FULL 5-paper external sweep (P1U v1U.0.10 · P2 v1.7.110 · P3 v3.1.152 · P4 v1.0.232 · P5 v0.1.115) after a five-paper REAL-error closure wave — ChatGPT + Grok harvested all 5; Gemini harvested P5 only (P1U/P2/P3/P4 legs FAILED on an upload throttle) · headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated",
    verdicts: {
  ...
  {
    roundId: "H17F-2026-07-10",
    dateISO: "2026-07-10",
    windowPT: "Jul 10 · H17 FINAL-WAVE EXT re-test (P1U v1U.0.11 · P2 v1.7.110 · P4 v1.0.235 · P5 v0.1.117) after both fused loops converged with Claude INT ACCEPTs — 6 verdicts harvested (P5 Grok+ChatGPT · P4 Grok+ChatGPT · P2 ChatGPT · P1U Grok); P2-Grok + P1U-ChatGPT legs pending · headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated",
    verdicts: {
      P1A: ["NO_VERDICT", "MAJOR", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["REJECT", "NO_VERDICT", "NO_VERDICT"],
      P3: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P4: ["REJECT", "MINOR", "NO_VERDICT"],
  ...
  {
    roundId: "W4-2026-07-11",
    dateISO: "2026-07-11",
    windowPT: "Jul 11 · W4 EXT confirm half of P5's exit wave (P5 v0.1.120; unchanged since W4-INT — comment-only delta) · Grok + ChatGPT × P5 harvested (Gemini not swept) · headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated · 2 verdicts",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
  ...
  {
    roundId: "FR1b-2026-07-11",
    dateISO: "2026-07-11",
    windowPT: "Jul 11 · FR1b ChatGPT retry — recovered the FR1 EXT rate-limit GAP; headed browser, raw verbatim text + screenshot READ before every recorded verdict · 0 fabricated · 5 ChatGPT verdicts",
    verdicts: {
      P1A: ["REJECT", "MAJOR", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["REJECT", "MINOR", "NO_VERDICT"],
  ...
  },
  {
    roundId: "M23",
    dateISO: "2026-07-13",
    windowPT: "Jul 13 · byte-unchanged EXT re-audit — P2 (v1.7.116) · P1U (v1U.0.20, P1A column) · headed browser, raw verbatim VERDICT line READ before every verdict · Gemini + P1B/P3/P4/P5 not swept (carried; respect P3 streak-0 from M22 DP3-21)",
    verdicts: {
      P1A: ["REJECT", "MAJOR", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["REJECT", "MAJOR", "NO_VERDICT"],
  ...
  },
  {
    roundId: "M25+M26",
    dateISO: "2026-07-13",
    windowPT: "Jul 13 · M25: P5+P2 EXT Grok+ChatGPT (valid retry raws only; polluted-URL REJECT rows discarded) · M26: P1U+P4 EXT Grok (ChatGPT DEFERRED-ratelimit GAPs) · 0 genuinely-new across all 4 papers · streaks P5→10 P2→11 P1U→11 P4→10",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["REJECT", "MINOR", "NO_VERDICT"],
    ...
    note: "M25+M26-EXT adjudication. PROVENANCE RULING: M25 had duplicate ChatGPT manifest rows; the early REJECT rows pointed at the P4/M24 polluted chat URL (chat 6a54c12e-…) and are DISCARDED as INVALID-provenance (the raw content reviews P4, not P5/P2). Only the RETRY raws are valid: P5_chatgpt retry (chat 6a54c84c-af48-…) = MAJOR REVISIONS (reviews DESI void-chirality ✓); P2_chatgpt retry (chat 6a54c867-3368-…) = REJECT (reviews f_NL/−35/16 ✓). Verdict matrix [ChatGPT, Grok, Gemini] FROM RAW: P5 ChatGPT MAJOR (11/3) + Grok MINOR (0/4); P2 ChatGPT REJECT (11/1) + Grok MINOR (0/5); P1U Grok MAJOR (3/2; pattern-066 band on byte-identical v1U.0.20); P4 Grok MINOR (0/4). M26 ChatGPT legs = DEFERRED-ratelimit GAPs — recorded as NO_VERDICT, never zeros. Truth-audit (ledger_match.py + Opus): 0 genuinely-new across all 4 papers; all findings source-cited to standing D-ids (P5→DP5-06/-08/-09/-10/-11/-12/-13/-14/-16/-20/-21; P2→DP2-01/-02/-03/-04/-07/-13/-14/-15/-16/-17/-18/-19/-22/-25/-26/-34; P1U→DP1U-08/-11/-12/-17/-20; P4→DP4-07/-09/-14/-17). Streak advances: P5 9→10, P2 10→11, P1U 10→11, P4 9→10. Recomputed caps (post_verdict.sh; formula 50+Grok+ChatGPT+Gemini; _creationTime-latest per reviewer): P5 74→80 (ChatGPT MAJOR +6: 50+12+6+12=80); P2 68→74 (Grok MINOR restores +6: 50+12+0+12=74); P1U 62 HOLDS; P4 85→80 (Grok ACCEPT→MINOR pattern-066 slip: 50+12+6+12=80). No bumps; directive_g.sh not run; no ACCEPT faked, no finding dismissed without a source-cited verdict, no math fabricated. Raws: EXT_real/H17_2026-07-10/M25/ + EXT_real/H17_2026-07-10/M26/.",
  },
  {
    roundId: "M27",
    dateISO: "2026-07-13",
    windowPT: "Jul 13 · P3-ApJS (v3.1.159-apjs) byte-unchanged EXT re-read — Grok only (ChatGPT daily rate-limit, Gemini browser-throttled; both carried) · DP3-21 DAS fix STAYS HELD · 0 genuinely-new · P3 clean-wave streak 1→2 · cap HOLDS 56",
    verdicts: {
      P1A: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P1B: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
      P2: ["NO_VERDICT", "NO_VERDICT", "NO_VERDICT"],
