...
export const predictions: Prediction[] = [
  {
    ...
    description: "The decisive bounce-vs-inflation discriminator. The matter bounce predicts f_NL = -35/16 = -2.1875, parameter-free and mechanism-independent across all matter bounce variants. Inflation predicts |f_NL| < 1. One measurement settles the question.",
    currentConstraint: "σ(f_NL) ≈ 4.1 (Planck + DESI combined, external). Our DESI multi-tracer central forecast: 9.4% improvement (empirical α, consistent with no improvement at <1σ). SPHEREx forecast: 2.6–5σ conditional detection if f_NL = -2.1875.",
    ...
    keyResults: [
      "f_NL = -35/16 derived across 3 bounce models (mechanism-independent, parameter-free)",
      "Current Planck alone: σ ≈ 5.1, f_NL = -0.9 ± 5.1",
      "Combined Planck + DESI: σ ≈ 4.1 (our -2.1875 at ~0.5σ)",
