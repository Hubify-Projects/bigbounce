...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 86,
    status: "86% — v1.0.51 (R-round-3 minor sweep, 4 minors + 1 nit closed). CE-ResNet pathway softened (residual ViT inductive bias acknowledged as alternative), §IX item-5 axis-agnostic reframed, fig:binned_cw_fraction caption arithmetic clarified (1.41% fracdev spread = 2.9σ statistically significant, not small-N), McNemar Z one-sided convention clarified, 3 grammatically-awkward 'uniform across 7 equatorial coordinate slabs' sites rewritten. PDF 28pp / 25.87 MB / 0 undef refs / sha256 834885fe...",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.87 MB · 28 pp · May 13, 2026, v1.0.51",
    artifacts: [
