...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.268 confirmation board (reviews the G1 manifest-retained retrain + G2 training-disjoint validation closures computed 2026-07-17) before any DOI publication",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.268.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.268.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
