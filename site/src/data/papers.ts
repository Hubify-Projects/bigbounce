...
export const papers: Paper[] = [
  {
    ...
    keyResults: [
      ...
      "w0–wa discussed theoretically only (no free-w0-wa samples in the frozen posterior; earlier 'quintom-B 98.6%' was a bookkeeping error, corrected fire #25)",
  ...
  },
  {
    slug: "paper-3",
    number: 3,
    title: "Multi-Survey Anomaly Catalog: 319K Anomalies from 37.3M Sources Across 8 Surveys",
    version: "v0.5",
    pages: "~18",
    refs: "TBD",
    readiness: 95,
    ...
    statusVariant: "blue",
    target: "ApJS",
    description: "The catalog paper. Documents the first multi-survey AI anomaly sweep across 8 astronomical archives. 37,292,042 sources scored, 319,443 anomalies found (post eROSITA top-cut correction). Demonstrates 6.1% f_NL improvement via latent-space multi-tracer selection.",
    keyResults: [
      "319,443 anomalies across 8 surveys from 37,292,042 sources (Paper 3 Table 1 canonical totals)",
