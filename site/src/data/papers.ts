...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 58 pp · v1U.0.1 · updated Jul 8, 2026 · md5 27c19f4d — P1B merged in as appendices (self-contained)",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1_unified_v1U.0.1.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1_unified_v1U.0.1.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
