...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.250",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). The exact v1.0.250 board is MINOR/MAJOR/MAJOR; training replay, spatial covariance, DOI, and bounded manuscript defects remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.250 uses AASTeX 7 and retains only apodization robustness and multipole coherence in the strict FS-C synthesis. Its exact board supports that narrow result but requires training replay, spatial covariance, a DOI-backed archive, bounded manuscript closure, and human review.",
    keyResults: [
    ...
    remainingWork: [
      "Close the truth-audited v1.0.250 table, transfer-wording, MC-tail, schema, metadata, bibliography, and presentation defects, then obtain an exact v1.0.251 board; no acceptance is claimed",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.250 · updated Jul 15, 2026 · sha256 1c8af85c — AASTeX 7 presentation release; readiness holds 80 pending exact and human review.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.250.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.250.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
