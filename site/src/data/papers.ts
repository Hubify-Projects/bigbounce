...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1S.0.9",
    lastUpdated: "2026-09-18",
    tldr: "R3VERIFY closed 2 ESSENTIAL + 3 MAJOR genuinely-new-real defects: the v1S.0.8 A2 closing amendment had landed in the Appendix only, leaving Sec. III's stale -5/2 contradicting the Appendix's corrected -55/16 in the served PDF for 11 days; a raw unicode character also threw a LaTeX error and silently dropped text. Both fixed, plus a leaked internal-review-process paragraph rewritten and a footnote miscount corrected. New open item S12 (translation-term monopole generality, n_s=1 assumption) gates the next round. Readiness 70 -> 72; rounds stopped again pending S12.",
    path: publicationPath({}),
    pages: "7",
    refs: "—",
    readiness: 72,
    ...
    remainingWork: [
      "S12 (new, R3VERIFY 2026-09-18): translation-term monopole generality (n_s=1 assumption) — no further review round until resolved or deferred.",
      "R3VERIFY CLOSED (2026-09-18): 2 ESSENTIAL + 3 MAJOR genuinely-new-real defects closed in v1S.0.9 (main-text/appendix value contradiction, LaTeX unicode error, leaked review-process prose, footnote miscount). Rounds STOP again pending S12.",
      "Venue/arXiv-category selection not yet finalized (candidate: gr-qc or astro-ph.CO); note is now 7 pp., over a strict PRD-Letter limit — Letter vs. Brief Report form also undecided.",
      "See project-context/SSOT/paper-su/status.md for the full close-the-gap section",
    ],
    preprintId: "HUBIFY-2026-SU",
    pdfMeta: "PDF · 7 pp · v1S.0.9 · created Sep 18, 2026 · md5 fcc3383afa72efebd7e4cf888c5851e0 — R3VERIFY closed 2 ESSENTIAL + 3 MAJOR genuinely-new-real defects (Sec. III/Appendix A5 value contradiction, LaTeX unicode error, leaked review-process prose, footnote miscount). Readiness 70 -> 72; rounds stopped again pending new open item S12.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.9.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.9.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
