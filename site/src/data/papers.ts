...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 7 pp · v1A.0.125 · updated Jul 21, 2026 · md5 ca511c351f41948acdcfb967bf80b552 — archival deposit PUBLISHED (Houston go): DOI 10.5281/zenodo.21481838 (CC-BY-4.0) embedded in the availability paragraph; exact v1A.0.124 board previously truth-audited to 0 genuinely-new-real, P1A CONVERGED to human gates. Readiness cap 62 HOLDS.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.125.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.125.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "Software metapaper · 6 pp · v2B.0.13 · package 0.1.7 · 41 tests · md5 a55d0c6774afba38a49cb6463ba8cc28 · BOTH archival DOIs published (Houston go) and embedded: software 10.5281/zenodo.21481753 + manuscript deposit 10.5281/zenodo.21481842 (CC-BY-4.0) — the boards' persistent-identifier major is fully closed · readiness holds 56 pending human gates",
    artifacts: [
