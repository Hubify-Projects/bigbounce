...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.128.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.128.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r13 · updated Jul 22, 2026 · md5 17a24eb80c2b907e8352527970c6d3b7 — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. DOI BACK-PATCH: embeds the minted Zenodo archival DOI 10.5281/zenodo.21461888 (concept 21461887) in the Data Availability section, closing the archival-DOI Houston-gate; the distinct AAS journal digital-asset DOI stays honestly open. The record archives the exact bytes of the reviewed v3.2.0-r10 release (md5 9fb6e882068a4613132792633a9d7a60). Readiness cap 56 HOLDS (no uplift claimed).",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r13.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r13.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v1.0.271 · md5 80eda096226540d8a44d5f1b3202798f — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. DOI BACK-PATCH: embeds the minted Zenodo archival DOI 10.5281/zenodo.21461899 (concept 21461898) in the abstract, Data Availability paragraph, and catalog itemize, closing the DOI Houston-gate; the complete systematics-metadata sidecar stays honestly open. The record archives the exact bytes of the reviewed v1.0.268 release (md5 4e139b56b0718c70b73ae7295e4ee7b1). Readiness holds 80 (no uplift claimed).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.271.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.271.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
