...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.255",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.255 closes the exact v1.0.254 release-integrity majors with a clean bootstrap, exact quarantine identity/HC equivalence, and corrected immutable HF cards; exact v1.0.255 review plus standing training, covariance, metadata, DOI, and human gates remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. The audited v1.0.255 PDF records byte-verified dataset/model contracts, a clean-directory semantic bootstrap, and exact disk-backed identity and HC-flag equivalence across all 8,474,531 primary plus 249,066 quarantine rows. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact v1.0.255 review, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit one exact non-Anthropic review on the audited v1.0.255 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.255 · sha256 f9b011a8 · md5 bf487faf — release-integrity and source-to-claim audits pass; exact rereview pending. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.255.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.255.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "v0.1.134 truthfully bounds the retained 145,789-row A39/A40 archive to the released-GALZONE/VoidFinder control; the historical full DESIVAST join is unavailable and is not claimed as frozen",
      "v0.1.134 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified A1–A40 links remain required before submission",
    ],
    ...
    pdfMeta: "PDF · 39 pp · v0.1.134-2026-07-15 · updated Jul 15, 2026 · sha256 c2ecb845 — proactive portfolio preflight found and closed a false retained-artifact claim; the exact A39/A40 scope is now explicit. Full-page visual QA, retention, mirrors, and Convex sync pass. Readiness remains 74; Paper IV, public-release/DOI, external-data/power, exact review, and human AJ gates remain open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.134-2026-07-15.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.134-2026-07-15.pdf", kind: "secondary", download: true },
      {
