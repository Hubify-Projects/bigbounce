...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Derives f_NL = −35/16 for the stated matter-contraction background and cubic action, then maps that result conditionally to published and in-house large-scale-structure sensitivity estimates. v1.7.123 adds a computed model-specific Einstein-Cartan four-fermion torsion bound, converting assumption (f) from asserted to bounded. The observational forecasts are illustrative, not a completed detection claim.",
    path: publicationPath({}),
    pages: "11",
    refs: "39",
    readiness: 80,
    ...
    keyResults: [
      ...
      "G3 model-specific torsion bound (v1.7.123, Eq. 5): |δf_NL^tor| ≲ (35/16)(3/16)[γ²/(1+γ²)] κ n_ψ,c²/ρ_c via a sympy Einstein-Cartan four-fermion estimate anchored to the companion P1A's convention-audited contact term (benchmark reproduced to 0.1%); within EFT validity (x_ψ<1) the bound saturates at prefactor 0.022 (γ=0.2375) to 0.21 (γ=1) — torsion never exceeds ~1-10% of the -35/16 amplitude, <<1e-3 for sub-Planckian n_ψ,c — converting assumption (f) from asserted to bounded",
    ],
    ...
    remainingWork: [
      ...
      "Direct cubic bounce transfer (dressed-metric intermediate now regulator-independent to <1%, IC-epoch placement + quantum-mass term remain) and survey-native SPHEREx covariance/likelihood remain open; the model-specific torsion bound is now computed and bounded (v1.7.123)",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-002",
    pdfMeta: "PDF · 11 pp · v1.7.123 · updated Jul 17, 2026 · md5 ff8fc6f5aac9699f5d176f6b021e1125 — G3 REAL COMPUTE CLOSURE: new Eq. 5 model-specific Einstein-Cartan four-fermion torsion bound on assumption (f) (prefactor 0.022-0.21 within EFT validity, <<1e-3 for sub-Planckian abundances), anchored to the P1A convention-audited contact term (0.1% benchmark reproduction). Exact v1.7.123 confirmation board pending; no DOI, submission, or journal acceptance is claimed.",
    changelog: [
      "G3 model-specific torsion bound (v1.7.123): new Eq. 5 + bounded-disclosure paragraph converts assumption (f) (fermion-sourced torsion negligible) from asserted to bounded — |δf_NL^tor| ≲ (35/16)(3/16)[γ²/(1+γ²)] κ n_ψ,c²/ρ_c, sympy Einstein-Cartan four-fermion estimate anchored verbatim to the companion P1A's convention-audited axial contact term (benchmark reproduced to 0.1%). n_ψ,c carried as an explicit symbolic model parameter, never fixed. No headline number changed, −35/16 unchanged, nothing fabricated. Artifacts: research/cubic_bounce_transmission/g3_torsion_fourfermion_bound.{py,json}.",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.123.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.123.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "Re-stage the Zenodo deposit at r10 (prior r8 staging does not cover r9 or r10; r9 re-staging was never completed)",
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r10 · updated Jul 16, 2026 · md5 9fb6e882068a4613132792633a9d7a60 · sha256 627899f1bfa030b56502150224b174b66186b3d0beb3e608a68b2aab68ae0cd6 — integrity-reframe closure: the exact v3.2.0-r9 board's genuinely-new-real circularity finding (sub-0.1-arcsec core = expected seed self-recovery, not independent association evidence) closed at every claim site; Zenodo deposit re-staging at r10 is still open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r10.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r10.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1.0.265",
    lastUpdated: "2026-07-17",
    tldr: "Classifies 8.47M galaxies. The strict safe-sample observed-label statistic remains null-consistent (z=0.63465, p=0.23768). A coverage-calibrated OBSERVED-LABEL 95% upper limit on the primary dipole is now computed (A_95^obs ~0.98%) via 2,000 random-axis injections through the exact primary estimator and null — an observed-label sensitivity floor, not a physical bound. Training, complete covariance, archive, exact re-review, and human gates remain; readiness holds 80.",
    path: publicationPath({}),
    pages: "28",
    refs: "18",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The exact v1.0.264 confirmation board (Claude MAJOR / Grok MAJOR / Gemini MINOR) truth-audited to 2 genuinely-new-real findings; v1.0.265 closes M3 with a coverage-calibrated OBSERVED-LABEL 95% upper limit on the primary real-space dipole amplitude, A_95^obs ~=0.98% (linear-interp; logistic cross-check 0.955%), computed via 2,000 random-axis injections per amplitude through the EXACT committed primary estimator (uniform-pixel healpy.fit_dipole) and the EXACT committed 10^4-draw fixed-occupancy null; the headline (A_obs=0.00466520, z=+0.63465, p=0.23768) was reproduced exactly as a hard gate before any injection. This is an OBSERVED-LABEL sensitivity floor, not a physical parity-amplitude bound, which remains gated on the morphology transfer function. Integrated at 7 manuscript sites (abstract, Table 1 rows vii/viii, Table 2 row viii, new Sec 4.2 + Eq 7, disclaimer, injection caption, Conclusions) plus a Ge1 editorial fix (review-process narration removed from Sec 4.5). No science number changed; the primary remains null-consistent and harmonic results remain systematics diagnostics only. Training replay, the MASTER-decoupled/full-likelihood covariance legs, complete metadata, a DOI-backed archive, exact v1.0.265 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.265 confirmation board (reviews the new coverage-calibrated observed-label A_95^obs closure computed 2026-07-17) before any DOI publication",
      "Prove the exact training split/seed/realization (G1 pipeline smoke test + manifest-retained retrain, A4000 pod); extend the computed 3x3 joint covariance to the MASTER-decoupled leg and full joint likelihood; run the G4 monopole-mechanism injection (H200, after G1); derive the morphology transfer function needed to convert A_95^obs into a physical parity-amplitude bound",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-004",
    pdfMeta: "PDF · 28 pp · v1.0.265 · md5 dec7176eb1138779db5b727e3ccc6054 — computes a coverage-calibrated OBSERVED-LABEL 95% upper limit on the primary dipole (A_95^obs~=0.98%, 2,000 random-axis injections through the exact primary estimator + exact fixed-occupancy null); not a physical bound — the transfer-function gate remains open. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.265.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.265.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
