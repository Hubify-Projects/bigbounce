...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.131",
    tldr: "v1.0.131 (2026-05-26 cron fire #92 tick 214): 🎯 REAL N=10,000 MASTER-decoupled monopole-only null EXECUTED locally (vs prior N=500). Results stable: null mean 7.59e-7 (vs 8.01e-7); null std 1.13e-6 (vs 1.19e-6); moment-z +5.14 (vs +4.84); empirical-rank p=22/10000=0.0023 (vs 2/500=0.006) — 2.6× tighter p, same conclusion. Closes ChatGPT-M3 (MC≥10^4 for headline) with actual run not just claim. Also closed ChatGPT-M5: new 7-row data-vector definitions table immediately after headline summary specifying per-row map/weights/denominator/monopole/mask/null/MC for each estimator. Combined with v1.0.130 closures (ChatGPT-B1+B7+M9+S4), ALL 6 universal/cross-vendor BLOCKERs + key MAJORs from Houston-external wave now closed. Phase 3 compute-bound (joint model fit, systematics-preserving null, full template regression) still pending pod. PDF 51pp/26.25MB/0 undef/3 overfulls.",
    blockingItems: [
      "Houston personal sign-off (the final 1%)",
