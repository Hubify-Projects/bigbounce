...
function publicationPath(overrides: {
  ...
  return [
    ...
    },
    {
      ...
      state: "active",
      note: "P1B v108 and P4 v244 remain unre-reviewed after closure changes",
    },
    overrides.external ?? {
...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Standalone P1B is restored alongside the retained P1U history. Its exact NaMaster bandpower-window validation recovers β=0.269° from a +0.270° injection (bias −0.001°) on a synthetic native-coordinate latitude window. v1B.0.109 conditions the spectator-ALP prior-predictive accounting on the paper's physical spectator requirement. Exact v1B.0.109 confirmation is pending; readiness remains capped at 56 and no automated or human ACCEPT is claimed.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis that recovers ΛCDM; an exact-bandpower-window NaMaster validation on synthetic ΛCDM polarization skies using the executed native-coordinate latitude window; and an ALP prior-predictive diagnostic reported both before and after the physical spectator condition Ω_a<0.01. P1U remains part of the project history but does not erase this standalone state. These are fixed-background Monte Carlo frequencies, not evidence, posterior probabilities, or a sky detection.",
    keyResults: [
    ...
    remainingWork: [
      "Exact v1B.0.109 confirmation review is pending; no automated ACCEPT or human acceptance is claimed",
      "Human review, immutable release tag/archive/DOI, venue disposition, and submission metadata remain open; readiness holds at 56",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "Standalone companion · 20 pp · v1B.0.109 · sha256 36b8fc984b5be164f5ece1e2f0c3f661dfb49c9f99faa76e2b050e2bd0674a78 · exact confirmation pending; readiness holds 56",
    artifacts: [
  ...
  },
  {
    ...
    version: "v1.0.245",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies for spiral handedness and finds a null HC real-space chirality dipole under the primary fixed-occupancy galaxy-label randomization (z=0.7053, one-sided p=0.22468). The older pixel-asymmetry permutation is retained only as robustness (z=0.5491, p=0.26517). Exact v1.0.245 confirmation is pending; the catalog is not called public before upload.",
    path: publicationPath({}),
    pages: "26",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with rotational-equivariance correction. The primary HC real-space statistic is consistent with isotropy under a fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); the former pixel-asymmetry permutation is retained only as a robustness diagnostic (z=0.5491, p=0.26517). The result concerns observed classifier labels, not true three-dimensional galaxy spins or a primordial parity bound. The immutable catalog upload/archive and DOI remain open.",
    keyResults: [
      ...
      "Confidence-cut profile: the primary HC selection is explicit (p_eq ≥ 0.6, N=949,584); its fixed-occupancy label-randomization result is z=+0.7053, while the former pixel-permutation result z=+0.5491 is retained only as robustness",
    ...
    remainingWork: [
      "Exact v1.0.245 confirmation review and independent human ApJS scientific review remain pending",
      "Immutable release tag, catalog/source/PDF archive, and real release DOI",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-004",
    pdfMeta: "PDF · 26 pp · v1.0.245 · updated Jul 15, 2026 · sha256 e37d0af7 — primary fixed-occupancy label shuffle z=0.7053, p=0.22468; old pixel permutation retained as robustness only. Exact confirmation, immutable tag/archive/DOI, and human ApJS review remain open; readiness holds 80.",
    changelog: [
