...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.2. v2B.0.3 closes a verified concurrent receipt-validation race and adds Windows CI while preserving the real-PyMaster benchmark. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "25 automated tests across Linux Python 3.10–3.13 plus Windows 3.12, including a concurrent publication race regression",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.3",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.3 · package 0.1.2 · 25 tests · sha256 05f28b195ba4ee62c57acc0314a3c9566f27375a5ec3e22287473918191b6911 · concurrent receipt-validation race closed · Linux/Windows CI · exact confirmation pending · readiness holds 56",
    artifacts: [
