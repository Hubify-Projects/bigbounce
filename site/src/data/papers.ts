...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.250",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.250 is the AASTeX 7 presentation release; exact training replay, spatial covariance, DOI, and re-review remain major gates. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    remainingWork: [
      "Obtain an exact v1.0.250 confirmation board; v1.0.248 was MAJOR/MINOR/MAJOR and no v1.0.249 or v1.0.250 acceptance is claimed",
