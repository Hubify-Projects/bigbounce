...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 15 pp \u00b7 v3M.0.13 \u00b7 created Sep 4, 2026 \u00b7 md5 02251c80882da4eda5fa07c92917c86d \u2014 abstract trimmed to <=307 words (PRD-regular cap); all quantitative claims preserved at evidential strength. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.13.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.13.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
