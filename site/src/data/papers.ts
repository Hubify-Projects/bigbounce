...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "30+",
    readiness: 78,
    status: "78% — R44 BLOCKERs B1+B2 closed (9.9σ reframe + convention-reversal harmonization, Wave 14-HHHH); 4 R44 MAJORs still open (Bayes factor 8–17 vs 11 reconciliation, curvaton prior reframing, Heinrich Eq. X normalization citation, DBI → axion-curvaton/QSFI); Maldacena:2003 cite still undefined; R45 self-review + cross-vendor non-Anthropic round + Houston sign-off pending",
    statusVariant: "green",
