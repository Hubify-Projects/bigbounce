...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.257",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.257 closes two wording defects from the exact v1.0.256 confirmation board; exact v1.0.257 confirmation plus standing training, covariance, metadata, DOI, and human gates remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. The audited v1.0.257 PDF correctly bounds the two-bin GZ1 campaign proxy and the raw/equivariant comparison after the exact v1.0.256 confirmation board. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact v1.0.257 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit exact non-Anthropic confirmation on the audited v1.0.257 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.257 · sha256 726acd8b · md5 1fc1140e — truth-audited v1.0.256 confirmation-board closure; Convex row k57ef9rvv6m5c3vv4bz0j82r658anf9r synchronized. Exact v1.0.257 confirmation pending. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.257.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.257.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "v0.1.136 makes the reduced K=13 model focal and retains the 78-column fit as a flexible sensitivity; the 99,999-draw null-imposed wild-cluster test remains null (p=0.67345)",
      "v0.1.136 corrects Paper IV training provenance, removes unsupported release identifiers, and repairs Figure 5 prediction and Figure 9 T-Web count labels",
      "v0.1.136 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified artifact links remain required before submission",
    ],
    ...
    remainingWork: [
      ...
      "Run exact-PDF confirmation review on v0.1.136 and keep the secondary T-Web RSD limitation explicit",
    ...
    pdfMeta: "PDF · 40 pp · v0.1.136-2026-07-15 · updated Jul 15, 2026 · sha256 cd3c8e81 · md5 501740e8 — truth-audited v0.1.135 confirmation-board closure; Convex row k570jkw6zm30syyzvkx41ezxqh8amcge synchronized. Readiness remains 74; Paper IV, public-release/DOI, exact v0.1.136 confirmation, and human AJ gates remain open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.136-2026-07-15.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.136-2026-07-15.pdf", kind: "secondary", download: true },
      {
