...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 60 pp · v1U.0.5 · updated Jul 9, 2026 · md5 2878cad1 — W11 EXT presentation-closure: brought the formally dimension-4 off-shell parity-odd operator into the main text at Eq. (6) as the closed O1–O6 basis (Eq. 7), stating the dim-+1 form is an on-shell presentation shorthand with the App B.1 cross-ref (THE ask, ChatGPT B2 + Gemini Blocker-1); closed Grok's polishing list (R4 quintessence/f(R) contrast, Route-2 10-OOM margin robustness, transparency-exclusion rationale) and struck the Sec IV.E editorial cross-talk. No number changed, nothing fabricated.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1_unified_v1U.0.5.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1_unified_v1U.0.5.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 37 pp · v1.7.106 · updated Jul 9, 2026 · md5 8ef2209d — W11 EXT presentation-closure: calibrated the abstract to state the vertex re-summation yields −35/16 exactly + Li's independent derivation decisively favors it (ChatGPT claim-strength; full algebraic map already displayed); made the SPHEREx additive-quadrature budget explicit as a displayed equation bracketed by the ρ=−0.868 marginalized floor (Gemini 'soft'); labeled MegaMapper decisively as an uncalibrated high-z projection (Gemini); fixed the stale f_NL≈−4 → −2 (ChatGPT minor). −35/16 unchanged, nothing fabricated.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.106.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.106.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
