...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "Software metapaper · 16 pp · v2B.0.23 · package 0.1.7 · 41 tests · updated Sep 5, 2026 · md5 60d1a18ab3ea499398106d6a92bc8a35 — all deferred text items from the v2B.0.20 R3 audit closed (batch-3 audit trail, rule-file digests, Table 1 trust category). ROUNDS STOPPED under R2; venue decision next.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.23.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.23.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    tldr: "R10 confirmation board did NOT confirm: 17 genuinely-new-real findings on the exact v3M.0.25 PDF (4 MAJOR), all closed in v3M.0.26. Table V's f_PBH columns were not evaluated at their own row labels; the DBI window 'best case' used an unstated criterion on one background (corrected AGAINST the paper, r_min 12.6 -> 10.3); p.8 and p.13 gave the same tensor amplitude two incompatible shortfalls; two reproducibility citations resolved to nothing. No physics error found in either round. Directive R2 budget spent -- rounds stopped, a scope decision is required before any further board. Readiness 75 COMPUTED; no cap-95 claim.",
    path: publicationPath({}),
    pages: "20",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 20 pp \u00b7 v3M.0.26 \u00b7 created Sep 19, 2026 \u00b7 md5 4dcb996e0a1252e9dca3c9414a33a213 \u2014 R10 confirmation-board closure: Table V f_PBH columns re-evaluated at their labeled grid points, the DBI window minimum restated on the Planck 95% criterion across all three backgrounds (r_min 10.3, 286x BICEP/Keck), the p.8 tensor shortfall corrected to 10^6.2, two unresolvable reproducibility citations fixed, the title scoped to constant sound speed, and seven pieces of drafting-history prose removed. Readiness 75 COMPUTED \u2014 rounds STOPPED under directive R2.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.26.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.26.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Exact-v4P.0.8 re-verification board closed — 6 genuinely-new-real MAJOR + 4 MINOR independently source-verified and fixed — v4P.0.9; readiness 95; directive R2 permits no further consecutive round without a scope decision",
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.9.tar.gz",
    ...
    pdfMeta: "PDF · 14 pp · v4P.0.9 · created Sep 19, 2026 · md5 e31da2ee9cc57fbf0344b8d5c3b9a330 — exact-v4P.0.8 re-verification board closed; primary null result unchanged.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.9.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.9.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1S.0.11",
    lastUpdated: "2026-09-19",
    tldr: "S12 resolved (v1S.0.10): f_deltaN^init = -5 holds for every constant eps AND every n_s, stronger than the paper stated. R4's Claude-opus verdict-blind referee then found the S12 fix left Sec. II/abstract/Fig.1 still stating the n_s=1-specific formulas as general -- a real internal contradiction, closed in v1S.0.11 with matching qualifiers; 2 wording slips in the S12 addition itself also fixed. 3 further real findings (initial-slice convention, a Cai-2009 citation gap, an unerived Appendix A5 weight) are pre-existing, out of this closure's scope, and carried as new gates S13-S15. Grok/Gemini API legs of R4 still not run (shared-checkout preflight gate). Readiness holds at 72 (COMPUTED).",
    path: publicationPath({}),
    pages: "7",
    refs: "—",
    readiness: 72,
    ...
    remainingWork: [
      "R4 Claude-opus leg CLOSED (2026-09-19): found + fixed a real internal-consistency gap the S12 fix introduced (Sec. II/abstract/Fig.1 still stated n_s=1-specific formulas as general) -> v1S.0.11; Grok/Gemini API legs of R4 STILL NOT RUN (shared-checkout preflight gate, now blocked on a different concurrent lane's A3M files) — R4 not yet complete.",
      "S13/S14/S15 (NEW, R4 2026-09-19, real findings, out of scope for this closure): initial-slice/zeta_L(t_i)=0 convention inconsistency across Eq.1-2/USR-lambda/ekpyrosis row; Cai et al. 2009 factor-of-2 erratum claim rests on an unpublished note; Appendix A5's lambda_g asserted not derived. None touch S12 or the headline -5. See SSOT.",
      ...
      "Venue/arXiv-category: 2026-09-19 recommendation is primary astro-ph.CO / cross-list gr-qc (Houston-gated final choice); note is 7 pp., over a strict PRD-Letter limit — Letter vs. Brief Report form also undecided.",
    ...
    pdfMeta: "PDF · 7 pp · v1S.0.11 · created Sep 19, 2026 · md5 c5b0ea962c5b9f965c22bc6d08d93250 — R4 Claude-opus leg closed a real internal-consistency gap the S12 fix left in Sec. II/abstract/Fig.1; 3 pre-existing real findings (S13-S15) carried, out of scope. No science number changed. Readiness holds at 72.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.11.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.11.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
