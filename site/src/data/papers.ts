...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "R2 closure: statistics presentation corrected (class-level detection, no run-level intervals, 90% interval labelled correctly), estimator description fixed, traceability + reproducibility recipe. Batch 2 (35 sealed runs, 7 arms x 5) remains the PRIMARY result: S1-S4 20/20 detected (95% Clopper-Pearson lower bound 0.473 on the class-level rate), honest 0/5, S5 metadata-forgery and S6 effective-multipole both escaped 5/5, pre-declared and disclosed. ROUNDS STOPPED under directive R2 pending a science/venue decision — batch 3, OTS confirmation, PyMaster cross-check remain open.",
    path: publicationPath({}),
    pages: "13",
    refs: "4",
    readiness: 95,
    ...
    pdfMeta: "Software metapaper · 13 pp · v2B.0.19 · package 0.1.7 · 41 tests · updated Sep 4, 2026 · md5 b1c68336fdd183918dcb677fddb9fd72 — R2 closure: statistics presentation corrected, estimator description fixed, traceability + reproducibility recipe. Rounds stopped under R2. No readiness change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.19.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.19.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
