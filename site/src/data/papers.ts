...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Batch 3 (pre-registered) adds R7, a receipt-bound value-level rule recomputing 6 receipt-selected coupling-matrix rows against the declared pseudo-spectrum: 48 sealed runs (8 arms x 6), honest 0/6, S1-S4b structural shortcuts 24/24, S6 effective-multipole now caught 6/6 by R7 alone (closing the open batch-2 item), S5 metadata forgery still escapes 6/6 by forging the declared intermediate. A separate PyMaster (NaMaster 3.0.1) cross-check validates the in-house estimator to floating-point round-off. Rounds remain stopped under directive R2; one verification board permitted after this science change.",
    path: publicationPath({}),
    pages: "15",
    refs: "4",
    readiness: 95,
    ...
    pdfMeta: "Software metapaper · 15 pp · v2B.0.20 · package 0.1.7 · 41 tests · updated Sep 5, 2026 · md5 c22158448310861711838e3544a0e04b — Batch 3 (R7 value-level rule) + PyMaster cross-check integrated. Rounds stopped under R2; one verification board permitted after this science change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.20.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.20.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
