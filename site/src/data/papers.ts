...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "Houston external review round on v1.7.43",
      "Houston personal sign-off (final 1%, gated)",
  ...
  },
  {
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.79.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.79.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.50.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.50.pdf", kind: "secondary", download: true },
      {
