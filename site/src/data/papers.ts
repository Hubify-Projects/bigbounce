...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3.2.0-r16",
    lastUpdated: "2026-08-03",
    tldr: "Recovers 181 public DESI DR1 TARGETIDs from a frozen historical anomaly list, split transparently into 170 high-coordinate-consistency core associations and 11 lower-confidence positional associations. v3.2.0-r16 withdraws an unsupported causal reading of the annular shift deficit, adds an exact core-conditioned audit, restores the manifest-bound r2 Parquet, and reports 18/20 visibly rendered viewer captures. This is an archive-recovery product, not a detection claim.",
    path: publicationPath({}),
    pages: "17",
    refs: "12",
    readiness: 95,
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v3.2.0-r16 PDF after the annular-null, package-payload, and viewer-evidence closures",
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r16 · updated Aug 3, 2026 · md5 5f1d26eeb0cc7b06fca69bb0707edeb2 · sha256 c39f080b07c96b0b8db916330219db37afcefccb809659b0ae7de35cfa3fa753 — annular causal claim withdrawn; exact core-conditioned audit and package-evidence closures included; exact r16 confirmation remains pending.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r16.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r16.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1.0.273",
    lastUpdated: "2026-08-03",
    tldr: "Classifies 8.47M galaxies. The strict safe-sample observed-label statistic remains null-consistent (z=0.63465, p=0.23768), and the v1.0.268 CE-composition audit retained the GZ1-core realization while documenting the honest-negative CE-inclusive retrain. v1.0.273 closes the final ApJS package/class and out-of-page artifact-link defects without changing the science; final-hash confirmation and Houston review remain separate gates.",
    path: publicationPath({}),
    pages: "32",
    refs: "18",
    readiness: 95,
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v1.0.273 PDF; earlier review evidence is not a verdict on this hash",
    ...
    pdfMeta: "PDF · 32 pp · v1.0.273 · updated Aug 3, 2026 · md5 4044ac0c2e159c71350733b319128cab — current AASTeX 7.0.2 class bundled and the 217.5-pt raw artifact-path overflow replaced with a short Data Availability pointer. No scientific claim, number, or caveat changed; no readiness change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.273.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.273.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
