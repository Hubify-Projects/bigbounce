...
export const researchPrograms: ResearchProgram[] = [
  {
    ...
    supportingLinks: [
      ...
      },
      {
        ...
        description:
          "A systematic survey of 7 foundation mechanism classes and 6 observational branches, extracted from the retired P1U barrier catalog, collapsing to 13 distinct mechanism-class constraints across 14 catalog entries and closing four candidate dark-energy routes (R1-R4). Draft v1C.0.9, compiled 20 pp, 0 undefined refs, 0 overfull boxes — closes the R6 confirmation board on the exact v1C.0.8 PDF (Claude INT MINOR REVISIONS, 1 MAJOR/8 MINOR; Grok REJECT; Gemini MAJOR REVISIONS; Perplexity leg failed): the headline closure answers the boards' recurring companion-dependency demand with a new Appendix E carrying the two remaining load-bearing Tier-II companion inputs self-contained by faithful extraction from the P1A source (the Cartan/Freidel-Minic-Takeuchi torsion-elimination chain fixing the -(3kappa/16)[gamma^2/(1+gamma^2)] contact coefficient, and the R1 finite-density benchmark arithmetic kappa n_psi^2 ~ 1e-79 eV^4, 3.6e-69 of rho_Lambda), following the App-D/B14 precedent — nothing invented. Also closed: Eq. (2) left-hand side corrected to the double-normalized budget ratio it actually displays, the nabla.J5 disposal now routes the gravitational Kimura-Delbourgo-Salam R-Rtilde anomaly content to O3 (refs added), the Data & Code pin moved to a commit whose artifact copies are identical to head (drift footnote retired) with the theory_audit prose tag removed, a beta_obs detection-significance sentence (3.6/2.9 sigma), the Fig 1 caption attribution stated plainly, M_Pl^2 kappa^2 = kappa tagged exact-for-reduced-mass, and the alpha_em Thomson-limit convention stated. Grok's 'App. D only cites the theorem' falsified against the compiled App. D proof; Gemini's 2026-dates-anachronism falsified against the calendar. DRAFT: R6 found genuinely-new items, so an R7 confirmation board is required; no readiness score has been computed and no venue/Zenodo kit exists yet.",
        href: "/papers/paper1c_nogo_survey_v1C.0.9.pdf",
        external: true,
      },
    ],
