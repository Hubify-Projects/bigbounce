...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B has been rebuilt as a focused software metapaper around the installable namaster-proof package. It exposes exact pseudo-Cℓ window inference, multipole contracts, and content-bound JSON receipts, with 19 automated tests and an independent synthetic example. Exact-PDF review is pending, so readiness holds 56.",
    path: publicationPath({}),
    pages: "4",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "19 automated tests across Python 3.10–3.13 plus an independent synthetic example recovering an injected 0.25° angle",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic software-paper review and truth-audit every finding",
    ...
    pdfMeta: "Software metapaper · 4 pp · v2B.0.0 · sha256 ad500bd4e8d689628ad3a383e512a1ddd7a1e329b5580e1d41e30637266c75a0 · exact-PDF review pending · readiness holds 56",
    artifacts: [
