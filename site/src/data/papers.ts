...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 94,
    status: "94% — v1.0.60 (9th REAL cross-vendor round on v1.0.59: 4 of 5 vendors FULLY CLEAN). Gemini-2.5-Pro 3RD consecutive endorsement ('definitive null result with exemplary systematics analysis'); Grok-4 no BLOCKERs (downgraded all to MAJORs); Perplexity Sonar Pro 'No BLOCKER or MAJOR Findings'; DeepSeek-V3.2 'No BLOCKERs identified that would prevent arXiv submission'. Only GPT-5.5 still flagging 2 BLOCKERs — GPT-B1 closed: propagated A/2 vs full-A amplitude convention to 2 downstream sites (Conclusions item 1 'statistical-only Poisson floor 0.2%' → '0.2% on CW-fraction half-modulation A/2 / 0.4% conservative full-A / 0.29% Fisher exact'; future LSST scaling 'minimum detectable 0.04%' → '0.04% on A/2 / 0.08% on full A'). GPT-B2 (canonical NaMaster ℓ=1 compute-bound) remains deferred-on-record from v1.0.55 — analytic projection labeled as cross-check not primary; remaining +6.10σ Table III row deviations explicitly attributed to monopole leakage. P4 is now at external-review-gate clean state per 4/5 vendor consensus. PDF 31pp / 25.89 MB / 0 undef refs / sha256 0970ec1d... Cumulative P4 today: 79→84→87→90→91→89→92→93→94 across 9 ticks, +15pp net.",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.89 MB · 31 pp · May 14, 2026, v1.0.60",
    artifacts: [
