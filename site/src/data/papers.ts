...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is now a focused software metapaper around namaster-proof 0.1.1. Its first exact-PDF board exposed real fail-closed input-validation and provenance-wording defects; v2B.0.1 closes them with 23 tests, structured JORS sections, direct artifact hashes, and corrected documentation. Confirmation is pending, so readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "Atomic JSON publication with SHA-256-bound sidecar receipts and fail-closed metadata validation",
      "Deterministic field, bin, and harmonic-limit contracts whose final exclusive bin edge is ℓmax+1",
      "23 automated tests across Python 3.10–3.13, including fail-closed spectrum-support, weight-shape, sign, and finite-input regressions",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.1",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.1 · package 0.1.1 · sha256 5257555381604e6083cb73624f5c2079118c3ea80fe0c3d9f3290bd10dfaf176 · first exact board truth-audited and closed · confirmation pending · readiness holds 56",
    artifacts: [
