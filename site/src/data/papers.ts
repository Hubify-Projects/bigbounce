...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 11 pp · v1.7.125 · updated Jul 18, 2026 · md5 174d52d55719c5955f852d2365fdb9c8 — DRESSED-METRIC TRANSMISSION CLOSURE: in the dressed-metric scheme the bounded bounce is transparent to the conserved mode (T_c(k)=1; |δf_NL| ≤ 6.8e-8 at k·η_B=1e-2, >4 orders of magnitude below the prior OOM reference); effective-fluid scheme-specificity demonstrated (K-integral d_cut^-1/2 divergence, fitted -0.4998). Exact v1.7.125 confirmation board pending; no DOI, submission, or journal acceptance is claimed.",
    changelog: [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v1.0.268 · md5 4e139b56b0718c70b73ae7295e4ee7b1 — CE-composition adjudicated: re-provisioned Jia CE-ResNet catalog reproduces GZ1=6,637 + CE-spirals=17,153 exactly, reproducible non-spiral count 819, resolving the historical 826-vs-846 conflict. Honest-negative: the composition-faithful CE-included retrain collapses to chance on chirality (val 0.5617), root-caused to systematically fainter/lower-confidence CE-only spirals. Exact v1.0.268 confirmation board: Grok ACCEPT (its first). Readiness holds 80.",
    changelog: [
