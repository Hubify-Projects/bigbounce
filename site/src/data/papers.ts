...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "30+",
    readiness: 86,
    status: "86% — R44 MAJORs M1+M2+M3 + nit2 shipped (p_LEE upper-bound, Platt 6 sig figs, McNemar paired test, PUSHBACK token cleanup, Wave 14-GGGG); 4 R44 MAJORs still open (M4 recall asymmetry vs GZ1 prior decomposition, M5 deep-MLP RA/Dec ablation [pod RTX A5000 too slow for 8.47M deep-MLP retrain], M6 MDD N_eff inflation, M7 morphology-bin flatness disclosure in abstract); R45 self-review + cross-vendor non-Anthropic round + Houston sign-off pending",
    statusVariant: "green",
    target: "MNRAS",
