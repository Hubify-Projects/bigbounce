...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "R1 truth-audit closure (23 findings, 21 genuinely-new-real, 8 answered by the pre-registered batch-2 blind test). Batch 2 (35 sealed runs, 7 arms x 5) is now the PRIMARY result: S1-S4 20/20 detected (95% lower bound 0.861), honest 0/5 (FPR upper bound 0.451), S5 metadata-forgery and S6 effective-multipole both escaped 5/5, pre-declared and disclosed. Batch 1 (18 runs) relabelled the pilot round; its post-hoc rule changes are disclosed, not defended. New provenance/attestation-tooling related-work section; sealed digests OpenTimestamps-anchored (pending confirmation).",
    path: publicationPath({}),
    pages: "12",
    refs: "4",
    readiness: 95,
    ...
    pdfMeta: "Software metapaper · 12 pp · v2B.0.18 · package 0.1.7 · 41 tests · updated Sep 4, 2026 · md5 89cbca0fc922f9c1c63f1afaf35f8517 — R1 truth-audit closure: batch-2 sealed blind test (35 runs, 7 arms) is now the primary result, S1-S4 20/20 detected, honest 0/5, S5/S6 escapes pre-declared and disclosed. No readiness change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.18.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.18.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v3M.0.17",
    lastUpdated: "2026-09-04",
    tldr: "D-A3-12 (ledger row 18): the tensor mode's transfer equals the S1 scalar transfer identically, so r_after^S1=24.0 is an identity and r_after^S2\u22489.4\u00d710\u00b2 (39\u00d7 bounce amplification) \u2014 the tensor no-go is scheme-independent. The bounce's own cubic term is now c_s-dependent, sign-flipping at c_s=0.913 and diverging faster than the transmitted term; evaluated at the same c_s the joint (r,f_NL) window strengthens to c_s\u22650.600/r\u226514.4 (400\u00d7 BICEP/Keck, up from 296\u00d7). Single-field matter bounce (canonical or k-essence) remains jointly excluded by r and f_NL; the curvaton route survives. Readiness 75.",
    path: publicationPath({}),
    pages: "18",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 18 pp \u00b7 v3M.0.17 \u00b7 created Sep 4, 2026 \u00b7 md5 b18aafd1288ffddeea2c3a1ee074a23b \u2014 D-A3-12: scheme-independent tensor no-go (r_after^S1=24.0 identity, r_after^S2\u22489.4e2) and c_s-dependent bounce cubic term strengthen the joint (r,f_NL) window to c_s\u22650.600/r\u226514.4 (400\u00d7 BICEP/Keck). Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.17.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.17.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1S.0.2",
    lastUpdated: "2026-09-04",
    tldr: "Reframed per D-PSU-1: the isotropic separate universe computes an exact, invertible change of variable δN_c = ζ_L,f[1 − I/3] + O(k_L²/a²H²), not a 'failure' — the O(1) discrepancy arises only when δN_c is identified with ζ, i.e. iff I = O(1). Label-resolved: initial-label composition is exactly −5 for every constant ε; final-label gives −25/4 + (15/4)μ² at ε = 3/2. R1 board (Claude INT/Grok/Gemini) closed: 21 genuinely-new-real findings, all closed; all three science gates resolved. Readiness 55.",
    path: publicationPath({}),
    pages: "4",
    refs: "—",
    readiness: 55,
    ...
    remainingWork: [
      "R2 verification board in progress (per directive R2, one further round permitted after D-PSU-1; no rounds beyond that without a new science/scope decision)",
    ...
    pdfMeta: "PDF · 4 pp · v1S.0.2 · created Sep 4, 2026 · md5 fcbecd03679fdc4ecae3956c35b9b08c — D-PSU-1 reframe: exact invertible change of variable (not a 'failure'), label-resolved compositions; R1 board closed, all science gates resolved. Readiness 55.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.2.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.2.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
