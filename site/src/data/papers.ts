...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 84,
    status: "84% — v1.0.53 (Houston P4-priority push: 5 substantive MAJORs closed from tick 14 real-cross-vendor round; DeepSeek-B1+M3 deferral CLOSED via new reproducibility script `tools/verify_canonical_numbers.py` which verifies N_CW=1592107 + N_CCW=1609053 = N_spiral=3201160 against 4 independent wave-14 JSONs, emits exact p_CW=0.49735... + σ_bin=2.79e-4 + deviation 9.47σ to outputs/canonical_provenance/global_cw_fraction.json). M3+Grok-M1: Shamir 20σ overclaim → factor 6-12 amplitude ratio (no σ claim). M2: Sky-balance Table 3 dual-denominator (already disclosed). Grok-M4: Jia 2023 SOTA baseline 1.6× primary, Shamir 16× as secondary. Grok-M2: 0.5% empirical primary, 0.29% Fisher statistical secondary (factor-of-2 GPT-B3 now folded in). GPT-M1: TTA per-galaxy soft-prob symmetrization clarified (hard argmax doesn't inherit cancellation; 5.4× depth-coupling suppression is the empirical effect). PDF 29pp / 25.88 MB / 0 undef refs / sha256 c4a3d443...",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.88 MB · 29 pp · May 14, 2026, v1.0.53",
    artifacts: [
