...
export const papers: Paper[] = [
  {
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1_unified_v1U.0.16.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1_unified_v1U.0.16.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
