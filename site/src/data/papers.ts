...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF 1.6 MB · 23 pp · updated Jun 9, 2026",
    artifacts: [
  ...
  },
  {
    ...
    remainingWork: [
      "Houston external review round on v1B.0.51",
      "Houston personal sign-off (final 1%, gated)",
      "arXiv submission (administrative, alongside P1A)",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "PDF 1.0 MB · 13 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.51.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.51.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 812 KB · 22 pp · updated Jun 9, 2026",
    artifacts: [
  ...
  },
  {
    ...
    remainingWork: [
      "Houston external review round on v0.1.52",
      "Houston personal sign-off (final 1%, gated)",
      "arXiv endorsement + submission (last in queue)",
    ],
    preprintId: "HUBIFY-2026-005",
    pdfMeta: "PDF 1.1 MB · 24 pp · updated Jun 9, 2026",
    artifacts: [
