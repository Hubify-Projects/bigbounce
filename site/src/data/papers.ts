...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "Exact-v4P.0.7 confirmation board closed — 7 genuinely-new-real findings independently source-verified and fixed — v4P.0.8; readiness 95",
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.8.tar.gz",
    ...
    pdfMeta: "PDF · 14 pp · v4P.0.8 · created Sep 18, 2026 · md5 b2399780320a50542279c35410b6b545 — exact-v4P.0.7 confirmation board closed; primary null result unchanged.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.8.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.8.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
