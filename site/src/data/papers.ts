...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 79,
    status: "79% — v1.0.52 (3rd REAL cross-vendor round via OpenRouter, 5 vendors). Caught 4 BLOCKERs the 5 prior simulated rounds missed: (GPT-B1) 3.05σ hemisphere framing was internally contradictory — text said 'does not survive LEE' but MC says p_LEE ≤ 10⁻⁴ which means it DOES; plus amplitude 0.17% vs max|A|=0.853% factor-5 discrepancy. (GPT-B3) Dipole σ formula missing factor of 2 since p_CW=½(1+A cosθ) has fitted modulation A/2 not A — ideal 3σ floor is 0.29% not 0.14-0.2%. (Perplexity-SHAMIR3) Shamir:2022 arXiv ID 2207.11885 was a Wang et al. optimization paper (NOT galaxy chirality); removed pending arXiv verification (PASJ 74, 1114 (2022) DOI 10.1093/pasj/psac058 retained). (DeepSeek-B1+B2) N_spiral=3,201,160 and MC seeds for 0.43σ/-0.122σ headlines lack on-disk provenance — deferred on-record. Closed: hemisphere amplitude reconciliation in abstract; explicit deferral paragraph at §Conclusions documenting (i)+(ii)+(iii). PDF 29pp / 25.87 MB / 0 undef refs / sha256 30e5473e...",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.87 MB · 29 pp · May 14, 2026, v1.0.52",
    artifacts: [
