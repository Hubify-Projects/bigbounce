...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3M.0.22",
    lastUpdated: "2026-09-05",
    tldr: "Literature/derivation correction: Sec. II and Appendix A no longer claim the uniform-density delta N value -55/16 is reconciled \u2014 the second-order rho-slice map gives -5/2 at dust, not -55/16 (gap 15/16), attributed to an omitted intrinsic initial-data bispectrum; only the comoving-slice delta N (-5) is fully reconciled. Flagship -35/16 unaffected. Rounds still stopped under R2. Readiness 75.",
    path: publicationPath({}),
    pages: "18",
    refs: "\u2014",
    readiness: 75,
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.22.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.22.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1S.0.6",
    lastUpdated: "2026-09-05",
    tldr: "S9/S10 second-order closure: Appendix A gains the general-admixture constant-mode kernel K_c (closed form, squeezed value -2eps/3, corrected normalisation 1/(lambda_g lambda_1)) and the uniform-density (rho-slice) result f^rho_NL=-5/2 at dust, which does NOT reproduce the separate-universe -55/16 value (gap 15/16; attributed to an omitted intrinsic initial-data bispectrum). Readiness 65 — ROUNDS STOPPED (R2).",
    path: publicationPath({}),
    pages: "6",
    refs: "—",
    readiness: 65,
    ...
    pdfMeta: "PDF · 6 pp · v1S.0.6 · created Sep 5, 2026 · md5 13b2e4b0f935e7275fdde03e93c41f2c — S9b: intrinsic term does not close the gap; residual is an open item in the super-Hubble evolution step. Readiness 65 — ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.6.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.6.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
