...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3.1.56",
    tldr: "R23 + R24 both returned 5/5 reviewers 0/0 — 2 consecutive all-clean rounds. v3.1.56 closed multi-round 9,576 dedup-shortfall via union-find on-disk artifact.",
    blockingItems: [
  ...
  },
  {
    ...
    version: "v1.0.122",
    tldr: "R22 closed GPT-5 + Perplexity findings; R23 + R24 both returned 5/5 reviewers 0/0 — 2 consecutive all-clean rounds. Cap 95% pending Houston sign-off.",
    blockingItems: [
      "Houston personal sign-off (the final 1%)",
    ...
    pdfMeta: "PDF 26.26 MB · 51 pp · May 20, 2026, v1.0.122",
    artifacts: [
  ...
  },
  {
    ...
    version: "v0.1.2-2026-05-21",
    tldr: "Cron fires #1-#4: Phase 1 + Phase 2 + first compiled draft + overfull fix + 3 PNG figures (volume-fraction pie, CW-by-env bar with 95% Jeffreys CI, Phase 2 heatmap). PDF 6pp/447KB / 0 overfull / 0 undef. Tempel+2018 stub in place. First R-round blocked on OpenRouter weekly key-limit.",
    blockingItems: [
