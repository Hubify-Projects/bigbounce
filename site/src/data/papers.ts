...
export const papers: Paper[] = [
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "R24conf clean-after-closures round landed in v1A.0.52 · MCS derivation appendix + Houston round next",
      },
    }),
    pages: "24",
    refs: "72",
    ...
    remainingWork: [
      "MCS derivation appendix (queue #32: θ(t) EOM + line-of-sight rotation integral, numerically bounded against the committed ODE grid)",
    ...
    pdfMeta: "PDF 1.6 MB · 24 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.52.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.52.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Release-pairing swap MCMC (queue #29, pod session) — PR4-consistent low-ℓ/lensing stack vs current pairing, ΔNeff/H0/S8 shift check",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "arXiv submission (administrative, alongside P1A)",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "PDF 1.1 MB · 16 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.53.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.53.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "Continuous-GR-recovery marginalization (c9k): bounce preference robust at BF = 6.0 under a continuous deviation parameter",
    ],
    ...
    remainingWork: [
      "One more cross-vendor round (R25conf, priority) must come back clean on v1.7.47 — R24conf landed two substantive physics fixes (QSFI endpoints, −35/16 attribution) so it does not count",
      "Houston personal sign-off (final 1%, gated)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-002",
    pdfMeta: "PDF 840 KB · 24 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.47.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.47.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Queue #33: re-derive the published eROSITA 0.259 score axis from the production scoring run (or restate Tables I/III on the committed parquet axis)",
      "Next cross-vendor round (R25conf wave) must come back clean on v3.1.82",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "HuggingFace visibility flip on bamfai/galaxy-anomaly-catalog-* (Houston manual on HF dashboard)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-003",
    pdfMeta: "PDF 4.5 MB · 24 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.82.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.82.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: [
      ...
      },
      {
        label: "Cross-vendor rounds clean",
        state: "active",
        note: "R24conf closed 7 local recomputes in v1.0.169 — TWO clean rounds (R25conf+) still required post-retraction",
      },
      {
        label: "External journal-style review",
        state: "active",
        note: "3-vendor round closed in v1.0.151 · next Houston round queued on v1.0.169",
      },
      {
        label: "Houston sign-off",
        state: "blocked",
    ...
    remainingWork: [
      "TWO clean confirmation rounds (R25conf+) on v1.0.169 — post-retraction rule; R24conf found real-but-fixable items (7 local recomputes closed) so it does not count",
      "Pod session for queued recomputes (queue #4/5/9/11–13: MC harmonization, full-sample injection floor, Table IX condition number, area-uniform curve, T7 split, training-log semantics)",
    ...
    pdfMeta: "PDF 25 MB · 20 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v169.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v169.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Pod field rebuilds (queue #15–19: unique-TARGETID T-Web rebuild, completeness-weighted δ, stratified p_LEE rerun, VoidFinder-native membership, z-clamp sensitivity)",
    ...
    pdfMeta: "PDF 1.1 MB · 27 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.54.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.54.pdf", kind: "secondary", download: true },
      {
