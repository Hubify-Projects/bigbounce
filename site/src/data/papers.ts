...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 95,
    status: "95% — v1.0.61 (10th REAL cross-vendor round on v1.0.60: 5 of 5 VENDORS ZERO BLOCKERs — unambiguous external-review-gate clean state). Gemini-2.5-Pro 4TH consecutive endorsement: 'The two BLOCKER-grade findings from the previous review round (GPT-5.5) have been fully addressed. I find no BLOCKER or MAJOR issues that would prevent publication. The paper is at a clean state, ready for external review.' GPT-5.5 DROPPED from 2 BLOCKERs to 'No BLOCKER-grade findings' (convergence achieved). Grok no BLOCKERs. Perplexity 'No BLOCKER or MAJOR Findings'. DeepSeek 'No BLOCKER findings'. Convergent MAJOR (DeepSeek-M1 + GPT-M1): Fisher-floor arithmetic transparency — abstract jumped from σ=0.048% to 3σ-floor 0.29% without showing factor-of-2 explicit. Closed in v1.0.61: abstract now shows full arithmetic '3×0.048%≈0.14% on A/2 → 2×0.144%≈0.29% on full A ideal / 2×0.2%≈0.4% on full A conservative'. Gate (a) of feedback_99_pct_readiness_cap.md SATISFIED. Houston manual sign-off (gate b) needed to lift from 95% cap to 99%; final 1pp from 99% to 100% Houston-only. PDF 31pp / 25.89 MB / 0 undef refs / sha256 52806e81... Cumulative P4 today: 79→84→87→90→91→89→92→93→94→95 across 10 ticks, +16pp net. P4 IS PUBLISH-READY pending Houston sign-off.",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.89 MB · 31 pp · May 14, 2026, v1.0.61",
    artifacts: [
