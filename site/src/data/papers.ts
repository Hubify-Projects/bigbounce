...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Derives f_NL = −35/16 for the stated matter-contraction background and cubic action, then maps that result conditionally to published and in-house large-scale-structure sensitivity estimates. v1.7.124 adds a computed model-specific Einstein-Cartan four-fermion torsion bound, converting assumption (f) from asserted to bounded. The observational forecasts are illustrative, not a completed detection claim.",
    path: publicationPath({}),
    pages: "11",
    refs: "39",
    readiness: 80,
    ...
    keyResults: [
      ...
      "G3 model-specific torsion bound (v1.7.124, Eq. 5): |δf_NL^tor| ≲ (35/16)(3/16)[γ²/(1+γ²)] κ n_ψ,c²/ρ_c via a sympy Einstein-Cartan four-fermion estimate anchored to the companion P1A's convention-audited contact term (benchmark reproduced to 0.1%); within EFT validity (x_ψ<1) the bound saturates at prefactor 0.022 (γ=0.2375) to 0.21 (γ=1) — torsion never exceeds ~1-10% of the -35/16 amplitude, <<1e-3 for sub-Planckian n_ψ,c — converting assumption (f) from asserted to bounded",
    ],
    ...
    remainingWork: [
      ...
      "Direct cubic bounce transfer (dressed-metric intermediate now regulator-independent to <1%, IC-epoch placement + quantum-mass term remain) and survey-native SPHEREx covariance/likelihood remain open; the model-specific torsion bound is now computed and bounded (v1.7.124)",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-002",
    pdfMeta: "PDF · 11 pp · v1.7.124 · updated Jul 17, 2026 · md5 66d86bf273439fdf42b713a1bf1ad374 — G3 REAL COMPUTE CLOSURE: new Eq. 5 model-specific Einstein-Cartan four-fermion torsion bound on assumption (f) (prefactor 0.022-0.21 within EFT validity, <<1e-3 for sub-Planckian abundances), anchored to the P1A convention-audited contact term (0.1% benchmark reproduction). Exact v1.7.124 confirmation board pending; no DOI, submission, or journal acceptance is claimed.",
    changelog: [
      "G3 model-specific torsion bound (v1.7.124): new Eq. 5 + bounded-disclosure paragraph converts assumption (f) (fermion-sourced torsion negligible) from asserted to bounded — |δf_NL^tor| ≲ (35/16)(3/16)[γ²/(1+γ²)] κ n_ψ,c²/ρ_c, sympy Einstein-Cartan four-fermion estimate anchored verbatim to the companion P1A's convention-audited axial contact term (benchmark reproduced to 0.1%). n_ψ,c carried as an explicit symbolic model parameter, never fixed. No headline number changed, −35/16 unchanged, nothing fabricated. Artifacts: research/cubic_bounce_transmission/g3_torsion_fourfermion_bound.{py,json}.",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.124.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.124.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
