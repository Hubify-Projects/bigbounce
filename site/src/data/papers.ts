...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 95,
    status: "95% — v1.0.61 (11th real-vendor round on v1.0.61: 5 of 5 vendors ZERO BLOCKERs MAINTAINED — 2nd consecutive converged round). Gemini-2.5-Pro 5TH consecutive endorsement: 'No BLOCKER or MAJOR issues were found that would prevent publication. The v1.0.61 update to clarify the Fisher-floor arithmetic has landed cleanly. The paper is in a publish-ready state.' DeepSeek: 'Zero BLOCKER-grade findings. The 5/5 vendor zero-BLOCKERs consensus from the prior round is maintained.' GPT-5.5: 'No BLOCKER-grade findings.' Grok-4-fast: 'No blocker findings.' Perplexity Sonar Pro: 'No BLOCKER or MAJOR issues found.' Gate (a) of feedback_99_pct_readiness_cap.md SATISFIED + STABLE across two consecutive rounds. Houston manual sign-off (gate b) needed to lift from 95% cap to 99%; final 1pp from 99% to 100% Houston-only. PDF 31pp / 25.89 MB / 0 undef refs / sha256 52806e81... Cumulative P4 today: 79→84→87→90→91→89→92→93→94→95 across 10 ticks (+16pp net); now stable at 95% across 2 verification rounds. P4 IS PUBLISH-READY pending only Houston sign-off → arXiv.",
    statusVariant: "green",
    target: "MNRAS",
