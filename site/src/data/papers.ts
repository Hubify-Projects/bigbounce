...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "v1B.0.110 closes the S8 burn-in inconsistency, and an executed CAMB 1.6.5 receipt now binds the exact PRIMAT table across all four reproduction YAMLs. Corrected NaMaster production and the version-matched immutable manifest remain open. Readiness holds 56.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis and an ALP prior-predictive diagnostic reported before and after Ω_a<0.01. v1B.0.110 corrects the S8 auxiliary overlay to the declared 30% burn-in. A separate execution receipt verifies CAMB 1.6.5 loading PRIMAT_Yp_DH_ErrorMC_2021.dat for all four public YAMLs. The current NaMaster artifact remains algebraic-only pending corrected production. These are not evidence, posterior probabilities, or a sky detection.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Close the version-matched immutable manifest/release gate; the exact CAMB/PRIMAT BBN execution receipt and 30%-burn S8 overlay are complete",
    ...
    pdfMeta: "Standalone companion · 20 pp · v1B.0.110 · sha256 a06777841125b8576f0acbdee1f4c3147cec913dc8f3dfc091bd286b457f98f0 · S8 and executed-BBN contracts closed; NaMaster production remains open; readiness holds 56",
    artifacts: [
