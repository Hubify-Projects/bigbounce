...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 15 pp \u00b7 v3M.0.14 \u00b7 created Sep 4, 2026 \u00b7 md5 de167ede0c3aa1ea31ded3fe9437fd82 \u2014 R6 closure: T_B mapping corrected (thirteen decades, was eleven), Channel I amplitude re-paired, DESI DR1 v3 reproduction sentence added. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.14.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.14.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
