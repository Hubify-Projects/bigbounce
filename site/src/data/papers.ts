...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 31 pp · v3.1.122 · updated Jun 30, 2026 · md5 e83a4a66",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_draft_v3.1.122.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_draft_v3.1.122.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
