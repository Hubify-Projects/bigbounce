...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    keyResults: [
      ...
      "R26conf: zero arithmetic errors across the round; 9 closures including code-verified tidal-tensor sign documentation (v0.1.58)",
    ],
    ...
    remainingWork: [
      ...
      "R27conf cross-vendor round must come back clean on v0.1.58",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.58.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.58.pdf", kind: "secondary", download: true },
      {
