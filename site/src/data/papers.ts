...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 12 pp \u00b7 v3M.0.9 \u00b7 created Sep 4, 2026 \u00b7 md5 925198c7ddc3485b9a6285a38995fe94 \u2014 R3 truth-audit closure: transmitted-amplitude LSS reach (Table IV), delta N_c derivation appendix, induced-GW IR-slope correction, numeric/definitional fixes. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.9.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.9.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
