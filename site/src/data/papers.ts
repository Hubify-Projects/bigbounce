...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    keyResults: [
      ...
      "v0.1.137 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified artifact links remain required before submission",
    ],
    ...
    remainingWork: [
      ...
      "Run exact-PDF confirmation review on v0.1.137 and keep the sparse interaction and secondary T-Web limitations explicit",
    ...
    pdfMeta: "PDF · 41 pp · v0.1.137-2026-07-16 · sha256 0468d8a6 · md5 42c9d087 — K13 clustering robustness and bounded interaction reporting complete; release, exact re-review, editorial, and human AJ gates remain. Readiness holds 74.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.137-2026-07-16.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.137-2026-07-16.pdf", kind: "secondary", download: true },
      {
