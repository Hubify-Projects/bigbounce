...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3.2.0-r15",
    lastUpdated: "2026-08-03",
    tldr: "Recovers 181 public DESI DR1 TARGETIDs from a frozen historical anomaly list, split transparently into 170 high-coordinate-consistency core associations and 11 lower-confidence positional associations. v3.2.0-r15 preserves the seed-self-recovery integrity framing while adding the current line-numbered AASTeX 7.0.2 ApJS shell, short title, ORCID, and bounded AI-use disclosure. This is an archive-recovery product, not a detection claim.",
    path: publicationPath({}),
    pages: "17",
    refs: "12",
    readiness: 95,
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v3.2.0-r15 PDF; the stale R57 latitude-rate row belonged to the superseded multi-survey draft and is closed by artifact verification",
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r15 · updated Aug 3, 2026 · md5 6659b909c928488873179ba71af8556d — current AASTeX 7.0.2, line numbers, short title, verified ORCID, and an evidence-bounded AI-use disclosure. The abstract science and all reported numbers are unchanged. No readiness change.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r15.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r15.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
