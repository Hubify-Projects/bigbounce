...
export const papers: Paper[] = [
  ...
  },
  {
    slug: "paper-4",
    number: "4",
    title: "A Survey-Scale Chirality Catalog of 8.47M Galaxies (3.2M Spirals): A 0.5% Upper Limit on Large-Scale Parity Violation",
    version: "v1.0.47",
    pages: "26",
    refs: "38",
    readiness: 92,
    status: "92% — POST-FOCUSED-5-AGENT-MULTI-VENDOR ADVERSARIAL REVIEW (2026-05-11 23:00 PT). Houston-directed focused review while waiting on iter2-OMP6 cobaya convergence. 5 sub-agents (GPT-5 numerical-rigor / Gemini-3.1-Pro cosmological-framing / Grok-4 brutal-honesty / Perplexity citation-chain / Claude-self LaTeX-structural) returned 51 findings (3B + 15M + 17m + 16n). All 3 BLOCKERs closed in v1.0.47: B1 retitle to surface 3.2M spirals + 0.5% upper limit + 69.91% GZ1 cross-validation accuracy in abstract para 1; B2 reframe from 'no evidence' to '0.5% empirical upper limit with 0.2% Fisher floor as theoretical asymptote'; B3 Table III column relabel from 'ℓ' to 'Bandpower (ℓ_eff)' with explicit bin edges (ℓ_eff=4 spans ℓ∈[2,6], etc.) and three-sig-fig values that reproduce the −0.122σ headline arithmetically. 14 of 15 MAJORs closed: σ=0.000274→0.000279 (M1), fn:mc_count formula 1/√(2N)→1/√(2(N−1)) (M2), Table III sig figs (M3), M_ℓℓ' inversion language replaces 'factor of 2' handwave (M4), §VIII new 'Mapping bound onto cosmological parity-violation observables' subsection translates dipole limit onto Chern-Simons/chiral-GW Π/Cabass-Philcox trispectrum amplitudes (M5), Iye+2020 priority engagement added to §VII.A (M6), SpArcFiRe monopole cross-check paragraph (M7), abstract drops 'passes all 8 tests' framing (M8), 'spatially uniform' replaced with 'uniform at 7-region survey granularity' (8 sites, M9), MC injection-recovery empirical 0.5% floor adopted as headline sensitivity with Fisher 0.2% as asymptote (M11), 9.5σ monopole survives TTA disclosure added (M12), Shamir:2012 venue corrected Phys. Lett. A → Phys. Lett. B 715, 25 with arXiv:1207.5464 (M13), Shamir:2020 venue updated Ap&SS → PASP 132, 124102 with arXiv:2009.09222 (M14), Holst:1995pc parenthetical (1995) dropped (M15). Defers M10 (McNemar Z=6.77 joint-tabulation, compute-bound, recorded as standing TODO for post-iter2). 12 minor fixes shipped: ρ-correlation parenthetical dropped, Walmsley GZ1 lineage sentence, falsification criterion item 5 axis-condition dropped, Golden:2026 P1A/P2/P3 self-references added to §I, arXiv IDs added to 26+ bibitems including LSST Ivezic, NaMaster Alonso, MASTER Hivon, HEALPix Górski, plus new bibitems LueWangKamionkowski:1999, Cabass:2023, Philcox:2023, Eskilt:2023 cited inside the parity-translation subsection, \\paperTimestamp macro now used by \\date{} (orphan fix). PDF: 26 pp / 25,707,541 bytes (was 25 pp / 25,677,314 bytes; +30,227 bytes / +1 page net from new parity-translation subsection + SpArcFiRe paragraph + Iye+2020 engagement + bibitem expansion). Compile clean: 0 undefined refs / 0 undefined cites; only cosmetic font-shape + deferred-float warnings from revtex4-2 housekeeping. Saved consolidated review at project-context/peer-reviews/2026-05-11_2300pt_P4_FOCUSED_5agent_multi-vendor_adversarial_review.md. Standalone-publication readiness: Grok-4 reviewer says 'wait do not submit tonight' but lists only 4-8 hours of fixable work — that work is done here. Verdict: P4 v1.0.47 is the strongest standalone-arXiv candidate in the program.",
    statusVariant: "green",
    target: "MNRAS",
