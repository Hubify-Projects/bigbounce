...
export const papers: Paper[] = [
  {
    ...
    tldr: "A compact CQG Note deriving the minimal Einstein–Cartan–Holst axial contact interaction and the zero-spin canonical-scalar branch. It fixes conventions, separates coefficient-level statements from state-dependent observables, and provides a commit-pinned hard-cutoff NJL diagnostic. A Claude-leg exact-PDF referee board found 2 MAJOR / 4 MINOR truth-audited to 0 correctness errors and 3 sub-sentence editorial items, closed same-day; human, release, and external-science gates remain.",
  ...
  },
  {
    ...
    version: "v2B.0.9",
    lastUpdated: "2026-07-16",
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.7. v2B.0.9 closes a Claude-leg board's tracked archive/release gate with a REAL standalone wheel-build test (39/41 passing, 2 monorepo-coupled tests skip-guarded), a codemeta.json, and a completed JORS availability template. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "6",
    refs: "4",
    readiness: 56,
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.9",
    ...
    pdfMeta: "Software metapaper · 6 pp · v2B.0.9 · package 0.1.7 · 41 tests (39/41 + 2 skip-guarded standalone) · md5 6bb152af686d465414b46461773858d1 · sha256 e2f3301fe74ba2f64ba41d87ec3648a6e3980e8715562ab27440f80ae448bc68 · closes the tracked archive/release gate with codemeta.json + completed JORS availability template · visual audit passed · exact confirmation pending · readiness holds 56",
    artifacts: [
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "Re-stage the Zenodo deposit at r9 (today's staging pass covered r8 only)",
    ...
    pdfMeta: "PDF · 16 pp · v3.2.0-r9 · updated Jul 16, 2026 · md5 bce975d38a1dedbc8a8b2cca53fe8b68 · sha256 7526e6859cf4544f0b835f1f7b2d8bd990314c3879fc5ed9eae4e743f3274d36 — closes a Claude-leg exact-PDF board (1 MAJOR / 7 MINOR) truth-audited to 0 falsified / 4 bounded editorial items; Zenodo deposit re-staging at r9 is still open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r9.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r9.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
      ...
      {
        label: "r8 Claude-leg truth audit",
        href: "https://github.com/Hubify-Projects/bigbounce/blob/main/project-context/peer-reviews/INT_v3/ROUND_2026-07-16-P3-v3.2.0-r8-EXACTPDF-b5f254f9-CLAUDESTACK/P3_v3.2.0-r8_claude_truth_audit.md",
        kind: "secondary",
        external: true,
      },
      {
  ...
  },
  {
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The exact v1.0.262 confirmation board (Grok MINOR / Gemini MINOR / Claude Opus subagent MAJOR) truth-audited 18 findings to 6 already-tracked gates, 3 disclosed re-flags, 7 venue opinions, 1 falsified, and 1 genuinely-new-real item. v1.0.263 closes that item with a single main-Results sentence surfacing the Appendix-B quarantine stability value (z=+0.48 excluded vs +0.52 baseline, c11b 10^4-permutation) via an Appendix pointer. No science number changed; the primary remains null-consistent and harmonic results remain systematics diagnostics only. Training replay, spatial covariance, complete metadata, a DOI-backed archive, exact v1.0.263 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.263 confirmation board (closes the v1.0.262 board's Appendix-B stability-value main-Results pointer finding on 2026-07-16) before any DOI publication",
    ...
    pdfMeta: "PDF · 26 pp · v1.0.263 · sha256 de12ac78 · md5 f2a6122b — closes the v1.0.262 board's Appendix-B quarantine stability-value main-Results pointer finding; exact re-review and external/human gates remain. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.263.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.263.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
