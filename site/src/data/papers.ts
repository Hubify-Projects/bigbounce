...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 93,
    status: "93% — v1.0.62 (canonical-N MASTER ℓ=1 direct compute closes GPT-B2 with a real artifact, replacing the v1.0.55 analytic projection). Direct 500-MC NaMaster on canonical Catalog C: N_spiral=3,201,160 / f_sky=0.4938 / NSIDE=64 / SEED=42 / wallclock 1432.6s on RunPod Linux pod. σ_canonical_direct = +1.85 (C1_decoupled=2.30e-5, null_mean=8.00e-6, null_std=8.10e-6). Three estimators on record: real-space dipole 0.43σ (full-sky), subsample-mask MASTER -0.12σ (f_sky=0.659 strict-superset), canonical-N direct-MC +1.85σ (f_sky=0.494). The +1.85σ is materially above the v1.0.55 analytic projection (+0.26σ); honest interpretation following v1.0.57 LEE-reframe logic: per-pixel random-label-shuffle null at canonical mask catches the depth-coupled/GZ1-label imaging systematic projecting the 9.5σ monopole onto ℓ=1 — NOT a primordial dipole (full-sky 0.43σ + strict-superset subsample-mask -0.12σ + empirical 0.5% sensitivity floor would have recovered it). No-dipole-at-ℓ=1 verdict preserved by the two independent estimators that bypass the canonical-mask leakage channel; canonical-N direct-MC value recorded as leakage-floor calibration. Readiness rolled back 95→93 per feedback_readiness_oscillation for honest reflection of the +1.85σ canonical-mask finding pending next vendor R-round. PDF 31pp / 25.89 MB / 0 undef refs / sha256 815fdf2a... Companion JSON: pipelines/p2_chirality/outputs/canonical_provenance/canonical_n_master_l1_direct.json.",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.89 MB · 31 pp · May 14, 2026, v1.0.62",
    artifacts: [
