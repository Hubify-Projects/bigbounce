...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.248",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.248 corrects the public null bundle and withdraws two mismatched-support diagnostics; exact training replay, spatial covariance, DOI, and re-review remain major gates. Readiness holds 80.",
    path: publicationPath({}),
    pages: "26",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.248 corrects the public primary-null release and excludes WLS/bootstrap and density-null diagnostics that were not generated on the declared FS-C support. Submission still requires exact training replay, covariance-aware spatial confusion propagation, a DOI-backed paper/source archive, exact re-review, and human review.",
    keyResults: [
      ...
      "Six support-consistent FS-C diagnostics favor a survey-correlated systematic; historical WLS/bootstrap and +3.80σ density-null calculations are excluded because their generators used broader latitude masks",
    ...
    remainingWork: [
      "Obtain an exact v1.0.248 confirmation board; v1.0.247 was MAJOR/MINOR/MINOR and no v1.0.248 acceptance is claimed",
    ...
    pdfMeta: "PDF · 26 pp · v1.0.248 · updated Jul 15, 2026 · sha256 1b1e2497 — exact-board truth-audit closure; corrected null bundle and support claims; readiness holds 80 until exact re-review.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.248.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.248.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
