...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3.2.0-r14",
    lastUpdated: "2026-07-24",
    tldr: "Recovers 181 public DESI DR1 TARGETIDs from a frozen historical anomaly list, split transparently into 170 high-coordinate-consistency core associations and 11 lower-confidence positional associations. v3.2.0-r14 preserves the seed-self-recovery integrity framing while meeting the AAS abstract cap; its bounded confirmation remains version-specific. This is an archive-recovery product, not a detection claim.",
    path: publicationPath({}),
    pages: "17",
    refs: "12",
    readiness: 95,
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r14 · updated Jul 24, 2026 · md5 e9c947e2c56d15851242e74330da93de — v3.2.0-r14 brings the abstract inside the AAS 250-word cap (426 → 249 words, rewritten rather than truncated: every surviving quantitative claim is numerically identical to r13 and to the body, and every integrity caveat is retained) and makes the deposit self-reference computed rather than hand-stamped. No readiness change.",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r14.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r14.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1.0.272",
    lastUpdated: "2026-07-24",
    tldr: "Classifies 8.47M galaxies. The strict safe-sample observed-label statistic remains null-consistent (z=0.63465, p=0.23768), and the v1.0.268 CE-composition audit retained the GZ1-core realization while documenting the honest-negative CE-inclusive retrain. v1.0.272 adds venue-format and provenance fixes; its final-hash bounded confirmation and human review remain separate gates.",
    path: publicationPath({}),
    pages: "32",
    refs: "18",
    readiness: 95,
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v1.0.272 PDF; earlier review evidence is not a verdict on this hash",
    ...
    pdfMeta: "PDF · 32 pp · v1.0.272 · updated Jul 24, 2026 · md5 27f38f209edd65d7d1dd973c861effd7 — v1.0.272 cuts the abstract to the AAS 250-word cap (339 → 236 words; no number re-rounded, no caveat cut) and relocates raw SHA-256 digests, immutable revisions, and bare artifact filenames out of the narrative into a new full-width artifact provenance register (A1–A12). That MAJOR had been raised twice as a MINOR and dismissed twice as a PROCESS-NIT; both dismissals were improper under AGENT_RULES 2.4 and are recorded as such. No readiness change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.272.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.272.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v0.1.146-2026-07-24 PDF and keep the sparse interaction and secondary T-Web limitations explicit",
      "Finalize Paper IV labels, weights, and provenance, then reverify P5 against that independently reviewable release",
      "Verify the current public archive and every A1–A48 link against the final version before submission",
    ...
    pdfMeta: "PDF · 43 pp · v0.1.146-2026-07-24 · updated Jul 24, 2026 · md5 3717017920458a944a2a8bfa7de17d7d — v0.1.146 puts the unmodelled target-program leakage where readers actually see it: an abstract caveat clause (rendered abstract 244 words, under the AAS 250-word cap), a Limitations bullet carrying the 0.81pp bright/dark residual with both partial bounds and their stated limits, and a Conclusions sentence making the focal non-detection explicitly conditional on that unclosed systematic. Prose only, zero reported numbers changed, no recompute. No readiness change.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.146-2026-07-24.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.146-2026-07-24.pdf", kind: "secondary", download: true },
      {
