...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. v1.0.258 reruns the primary estimator on the strict release-safe sample and binds all FSC harmonic diagnostics to the exact checksummed support. The primary is null-consistent; harmonic results are systematics diagnostics only. Training replay, spatial covariance, complete metadata, a DOI-backed archive, exact re-review, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit exact non-Anthropic confirmation on the audited v1.0.258 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 25 pp · v1.0.258 · sha256 e9b69665 · md5 412d3036 — strict safe-sample and exact FSC-support computational closures; exact re-review and external/human gates remain. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.258.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.258.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "v0.1.138 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified artifact links remain required before submission",
    ],
    ...
    remainingWork: [
      ...
      "Run exact-PDF confirmation review on v0.1.138 and keep the sparse interaction and secondary T-Web limitations explicit",
    ...
    pdfMeta: "PDF · 41 pp · v0.1.138-2026-07-16 · sha256 3c47ccf7 · md5 83566c8d — K13 clustering robustness and bounded interaction reporting complete; equation overflow removed; release, exact re-review, editorial, and human AJ gates remain. Readiness holds 74.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.138-2026-07-16.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.138-2026-07-16.pdf", kind: "secondary", download: true },
      {
