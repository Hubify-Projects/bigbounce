...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    lastUpdated: "2026-09-22",
    tldr:
      "Publishes a provenance-sealed candidate catalogue of 1,244 spectroscopically unusual DESI DR1 objects (the top 5.7×10⁻⁵ of 21,793,550 science-target spectra), now retitled to carry the null result explicitly. The anomaly score is uncorrelated with exposure quality/brightness, and is almost entirely explained by the blue spectrograph arm's own residual (full-model R²=0.78, collapsing to R²=0.01 without it; the blue arm alone, univariately, explains R²=0.20). A known-object recovery benchmark clears no reference class at its pre-declared bar. R1's INT board closed 17 of 20 findings, most consequentially downgrading a 'supports one' z≈4.3 quasar candidate to 'undecidable.' An R2 confirmation board (2026-09-22) on the never-before-reviewed vAF.0.5 PDF found and closed 9 further real items across three independent legs — most consequentially a genuine statistical-attribution error (a headline R² value had conflated a full-model regression with a univariate one) — leaving the honest verdict unchanged: 'refutes one of four, cannot decide the other three.'",
    path: publicationPath({}),
    pages: "18",
    refs: "—",
    readiness: 80,
    ...
    remainingWork: [
      "4 findings honestly disclosed as open, not closed: the archived autoencoder's undocumented training corpus/architecture, the deduplication rule's unquantified near-threshold effect, a blue-arm quality-cut removal quantification (no cut is pre-declared), and a literature-sourced Gunn-Peterson expected flux-ratio citation. The taxonomy's RA-wrap item (DAF-19) was CLOSED 2026-09-22 by a corrected re-clustering (spherical sky embedding), which now replaces Table VIII/IX as the paper's taxonomy",
      ...
      "Directive R2: round 2 of 2 spent (confirmation board ran 2026-09-22, found and closed real items); the DAF-19 closure (2026-09-22) is the directive-R2 intervening-science decision that authorizes one further board, run on the exact vAF.0.7 PDF; readiness 80 COMPUTED, pending that board's outcome",
    ],
    preprintId: "HUBIFY-2026-AF",
    pdfMeta: "PDF · 18 pp · vAF.0.7 · created Sep 22, 2026 · md5 b018c84f924a9ab06d8dceba4f45d173 — DAF-19 closed by adopting a corrected spherical-embedding taxonomy (23 clusters/9 families, was 25/8); not-a-compact-sky-region conclusion reinforced.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/anomaly_flagship_vAF.0.7.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/anomaly_flagship_vAF.0.7.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
