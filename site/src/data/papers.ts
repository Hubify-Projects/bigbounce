...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 19 pp \u00b7 v3M.0.23 \u00b7 created Sep 7, 2026 \u00b7 md5 52f438454b6227083b54eb8e9746dc79 \u2014 S9c derivation-statement update: dropped-evolution-term hypothesis NOT supported; -55/16 and -5 delta N values both well-defined; 15/16 gap relocated to the threading map's lapse monopole A2, under independent adjudication. Readiness 75 \u2014 ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.23.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.23.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 6 pp · v1S.0.7 · created Sep 7, 2026 · md5 89d7965b86fe1961c69b474d2764e54d — S9c: dropped-evolution-term hypothesis NOT supported; -55/16 and -5 delta N values both well-defined; 15/16 gap relocated to the threading map's lapse monopole A2, under independent adjudication. Readiness 65 — ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.7.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.7.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
