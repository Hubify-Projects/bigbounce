...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF 831 KB · 20 pp · May 18, 2026, v1A.0.33 (loop-exit)",
    artifacts: [
  ...
  },
  {
    ...
    pdfMeta: "PDF 26.22 MB · 48 pp · May 18, 2026, v1.0.117",
    artifacts: [
