...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v3.1.125 · updated Jun 30, 2026 · md5 e83a4a66",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_draft_v3.1.125.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_draft_v3.1.125.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
