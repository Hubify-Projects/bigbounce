...
export const papers: Paper[] = [
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "MCS line-of-sight derivation appendix (App C) landed in v1A.0.53 · R26conf coverage + Houston round next",
      },
    }),
    pages: "25",
    refs: "72",
    ...
    remainingWork: [
      "R26conf cross-vendor round (new App C derivation appendix needs review coverage)",
    ...
    pdfMeta: "PDF 1.6 MB · 25 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.53.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.53.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Release-pairing swap MCMC (queue #29) — running on pod; PR4-consistent low-ℓ/lensing stack vs current pairing, ΔNeff/H0/S8 shift check",
      "R26conf cross-vendor round on v1B.0.53",
      "Houston external review round + personal sign-off (final 1%, gated)",
  ...
  },
  {
    ...
    remainingWork: [
      "R26conf cross-vendor round must come back clean on v3.1.84 (count correction + HEALPix/SMICA reproducibility landed this wave; #37/38/39 production-chain artifacts verified absent — disclosed in-text)",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "HuggingFace visibility flip on bamfai/galaxy-anomaly-catalog-* (Houston manual on HF dashboard)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-003",
    pdfMeta: "PDF 4.5 MB · 25 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.84.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.84.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Queue #17–19 CLOSED in v0.1.56 (stratified p_LEE, void membership, z-clamp no-op); #16 completeness-weighted δ blocked — DESI LSS randoms not on disk, documented in-text",
      "R26conf cross-vendor round must come back clean on v0.1.56",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.56.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.56.pdf", kind: "secondary", download: true },
      {
