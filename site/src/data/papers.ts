...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "R26conf cross-vendor round must come back clean on v3.1.83 (queue #33 eROSITA axis CLOSED this wave)",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.83.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.83.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: [
      ...
      },
      {
        label: "External journal-style review",
        state: "active",
        note: "3-vendor round closed in v1.0.151 · next Houston round queued on v1.0.170",
      },
      {
        label: "Houston sign-off",
        state: "active",
    ...
    remainingWork: [
      ...
      "Pod session for queued recomputes (queue #4/5/9/11–13 — non-gating hardening)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v170.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v170.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "Pod field rebuilds (queue #16–19: completeness-weighted δ, stratified p_LEE rerun, VoidFinder-native membership, z-clamp sensitivity) — #15 unique-TARGETID rebuild CLOSED this wave",
      "R26conf cross-vendor round must come back clean on v0.1.55",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.55.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.55.pdf", kind: "secondary", download: true },
      {
