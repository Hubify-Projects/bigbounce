...
export const papers: Paper[] = [
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "3 rigorous review rounds complete (Round A/B/C, INT+EXT, Jun 28-30 2026) on top of the de-biased external validation: 23 real items closed program-wide; final neutral truth-audit found 0 genuinely-new real findings. Verified internally honest; remaining external MAJORs are disclosed caveats + submission-time DOI/arXiv blockers + LLM-referee variance. Houston sign-off pending.",
      },
    }),
    pages: "34",
    refs: "72",
    ...
    remainingWork: [
      "Houston external review sign-off (final 1%, gated)",
    ...
    pdfMeta: "PDF · 34 pp · v1A.0.94 · updated Jul 1, 2026 · md5 3680293e",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.94.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.94.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 24 pp · v1B.0.91 · updated Jul 1, 2026 · md5 b4ad4068",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.91.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.91.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 30 pp · v1.7.84 · updated Jul 1, 2026 · md5 cbd7a097",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.84.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.84.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v3.1.127 · updated Jul 1, 2026 · md5 88f925c4",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_draft_v3.1.127.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_draft_v3.1.127.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 26 pp · v1.0.204 · updated Jul 1, 2026 · md5 2c34e445 · 33 MB",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.204.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.204.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 35 pp · v0.1.99-2026-07-01 · updated Jul 1, 2026 · md5 23820e41",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.99-2026-07-01.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.99-2026-07-01.pdf", kind: "secondary", download: true },
      {
