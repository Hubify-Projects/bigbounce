...
export const researchPrograms: ResearchProgram[] = [
  {
    ...
    supportingLinks: [
      ...
      },
      {
        ...
        description:
          "A systematic survey of 7 foundation mechanism classes and 6 observational branches, extracted from the retired P1U barrier catalog, collapsing to 13 distinct mechanism-class constraints across 14 catalog entries and closing four candidate dark-energy routes (R1-R4). Draft v1C.0.5, compiled 18 pp, 0 undefined refs, 0 overfull boxes — closes the R2 confirmation board on the exact v1C.0.4 PDF (Claude INT minor-revisions, Grok REJECT, Gemini MAJOR; Perplexity leg failed): 7 genuinely-new items closed, including the B10 classification self-contradiction, a non-typechecking O4 torsion-square schematic re-indexed to the Nieh-Yan T-wedge-T form, the Appendix-C Fierz/G_s cross-reference reconciled with the Sec-II gamma-dependent contact operator, the Table-II R1 suppression anchored to P1A's published 3.6e-69 benchmark, LQC-window (0.27-0.41) provenance stated, and the Eq.-(2) denominator normalization made explicit (direct angle-only contraction gives two MORE orders; quoted margin is the conservative side). DRAFT: R2 found genuinely-new items, so an R3 confirmation board is required; no readiness score has been computed and no venue/Zenodo kit exists yet.",
        href: "/papers/paper1c_nogo_survey_v1C.0.5.pdf",
        external: true,
      },
    ],
