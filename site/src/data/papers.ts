...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 93,
    status: "93% — v1.0.59 (8th REAL cross-vendor round on v1.0.58: Gemini AGAIN ENDORSES 'definitive null result, analysis of systematics is exemplary'; Grok no BLOCKERs; 3 surviving BLOCKERs closed). Critical citation catch (PER-B1): Jia:2023 CE-ResNet bibitem had arXiv:2211.03497 which is actually Buoninfante et al. 'Black holes in non-local gravity' (gr-qc, not chirality) — verified via direct arxiv.org fetch; removed bogus arXiv ID, retained ApJ 943, 154 (2023) DOI:10.3847/1538-4357/aca9d8 as canonical venue. Same fused-metadata pattern as tick 14 Shamir:2022 catch. GPT-B1 §VIII.B 0.2% sensitivity floor convention propagation: added paragraph at §VIII.B head clarifying the Fisher σ=0.048% derivation is on the CW-fraction HALF-modulation (A/2), so the corresponding full-amplitude floor is 2× (0.29% Fisher, 0.4% conservative); abstract's 0.5% empirical floor is full-amplitude — readers comparing should multiply by 2. GPT-B2 'systematic-inclusive' deferred as honest reframe (injection at catalog-label/estimator level not end-to-end image; future-work disclosure). PER-B2 Shamir:2022 arXiv removal from tick 14 retained (still no verified arXiv). 3/5 vendors fully clean on v1.0.58: Gemini (endorses again), Grok (no BLOCKERs), DeepSeek-only-1-cosmetic. PDF 31pp / 25.89 MB / 0 undef refs / sha256 6b5f34e2... Cumulative P4 today: 79→84→87→90→91→89→92→93 across 8 ticks, +14pp net.",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.89 MB · 31 pp · May 14, 2026, v1.0.59",
    artifacts: [
