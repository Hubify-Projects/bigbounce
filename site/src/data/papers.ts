...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1S.0.8",
    lastUpdated: "2026-09-07",
    tldr: "A2 monopole reconciled: an independent adjudication confirms A2=eps(3-eps)^2/3 (constraint solve correct) and f^rho_NL=5(eps-7)/8=-55/16 at dust, closing the 15/16 gap via a corrected composition weight (3lambda, not 2lambda). In-in -15/8, comoving delta N -5, and uniform-density delta N -55/16 are now three well-defined variables related by exact threading maps. All S9 science gates closed. Readiness 65 -> 70 — ROUNDS STOPPED (R2); next step is venue.",
    path: publicationPath({}),
    pages: "6",
    refs: "—",
    readiness: 70,
    ...
    pdfMeta: "PDF · 6 pp · v1S.0.8 · created Sep 7, 2026 · md5 87bda8d5faf08102b621a3ea1755d233 — A2 monopole reconciled (A2=eps(3-eps)^2/3 correct; f^rho_NL=5(eps-7)/8=-55/16 at dust via corrected 3lambda composition weight). All S9 science gates closed. Readiness 65 -> 70 — ROUNDS STOPPED (R2); next: venue.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.8.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.8.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
