...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1S.0.10",
    lastUpdated: "2026-09-19",
    tldr: "S12 (translation-term monopole generality) resolved: the trace part does carry a nonzero (n_s-1) monopole, but an exactly compensating in-in tilt term cancels it, so f_deltaN^init = -5 holds for every constant eps AND every n_s -- stronger than the paper stated. Appendix A2/A3/A4 corrected to state this and the -5 claim strengthened accordingly; no science number changed. R4, the one directive-R2-permitted verification board, is in progress on the exact v1S.0.10 PDF (Claude-opus leg dispatched; Grok/Gemini API legs pending a shared-checkout preflight clear). Readiness holds at 72 (COMPUTED) until R4 completes.",
    path: publicationPath({}),
    pages: "7",
    refs: "—",
    readiness: 72,
    ...
    remainingWork: [
      "R4 (directive-R2-permitted verification board) IN PROGRESS on exact v1S.0.10: Claude-opus verdict-blind referee dispatched; Grok/Gemini API legs pending a shared-checkout preflight clear (site data files mid-edit by concurrent lanes) — not yet closed.",
      "S12 RESOLVED + APPLIED (2026-09-19): translation-term monopole generality — the trace carries a nonzero (n_s-1) monopole, exactly cancelled by a compensating in-in tilt term, so f_deltaN^init=-5 for every constant eps and n_s. Appendix A2/A3/A4 corrected in v1S.0.10; no longer gating.",
    ...
    pdfMeta: "PDF · 7 pp · v1S.0.10 · created Sep 19, 2026 · md5 c6457c37f51a8ba0a92f57f1aed5d650 — S12 (translation-term monopole generality) resolved and applied: Appendix A2/A3/A4 corrected for general n_s, f_deltaN^init=-5 claim strengthened to hold for every n_s; no science number changed. R4 verification board in progress. Readiness holds at 72.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.10.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.10.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
