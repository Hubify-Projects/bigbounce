...
export const papers: Paper[] = [
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "R23conf cleanest round (E:0/M:0) closed in v1A.0.51 · R24conf clean round + Houston round next",
      },
    }),
    pages: "24",
    refs: "72",
    ...
    remainingWork: [
      "R24conf confirmation round on v1A.0.51 must come back clean (R23conf found real findings: birefringence factor-of-2, ε-correction, fig-6 collision — all closed)",
    ...
    pdfMeta: "PDF 1.6 MB · 24 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.51.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.51.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R24conf confirmation round on v1B.0.52 must come back clean (R23conf closed the §VI ALP provenance rewrite to committed-chain truth + c10 robustness battery)",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "arXiv submission (administrative, alongside P1A)",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "PDF 1.0 MB · 15 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.52.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.52.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R24conf confirmation round on v1.7.46 must come back clean (R23conf closed: methods paragraph repaired, Table III rebuilt from c9g, null-space scatter 4.4–6.2σ propagated)",
      "Houston personal sign-off (final 1%, gated)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-002",
    pdfMeta: "PDF 812 KB · 23 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.46.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.46.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R24conf confirmation round on v3.1.81 must come back clean (R23conf closed: abstract 7.9%→9.4% anchored, 4 figure-level contradictions, gold/silver tiers)",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "HuggingFace visibility flip on bamfai/galaxy-anomaly-catalog-* (Houston manual on HF dashboard)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-003",
    pdfMeta: "PDF 4.5 MB · 24 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.81.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.81.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v1.0.168",
    lastUpdated: "2026-06-09",
    tldr: "Classifies 8.47M galaxies for spiral handedness with a rotation-equivariant ViT ensemble and finds a null real-space chirality dipole (+0.41σ, p=0.31) — the earlier −0.122σ subsample-mask null was withdrawn in v1.0.166 after a provenance audit.",
    path: [
      { label: "Draft complete", state: "done" },
      {
        label: "Internal multi-model review",
      ...
      },
      {
        label: "Cross-vendor rounds clean",
        state: "active",
        note: "R23conf closure wave landed in v1.0.168 — TWO clean R24conf+ rounds required post-retraction",
      },
      {
        label: "External journal-style review",
        state: "active",
        note: "3-vendor round closed in v1.0.151 · next Houston round queued on v1.0.168",
      },
      {
        label: "Houston sign-off",
        state: "blocked",
    ...
    keyResults: [
      ...
      "Real-space ℓ=1 dipole at +0.41σ (empirical-rank p=0.31, 10⁴ isotropic-null realizations from the fixed generator; committed generator had an all-CW selection bug, regenerated values agree within MC noise) + template-fit exclusion of a clean 1.7% dipole at z≈−18; earlier −0.12σ subsample-mask null withdrawn (synthetic-footprint provenance)",
      "Per-galaxy label-shuffle null robustness check: 0.58σ; HC selection now explicit (N=949,584); full-sample 4.2σ disclosed as a low-confidence-tail systematics diagnostic",
    ...
    remainingWork: [
      "TWO clean confirmation rounds (R24conf+) on v1.0.168 — post-retraction rule; R23conf found real findings so it does not count",
      "GZ1 Platt recalibration on the public GZ1 table (queued)",
      "Houston personal sign-off (final 1%, gated)",
    ...
    pdfMeta: "PDF 25 MB · 19 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v168.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v168.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R24conf confirmation round on v0.1.53 must come back clean (R23conf closed: Bonferroni misstatement, count ledger unified, Fig 8 generator script still queued)",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "arXiv endorsement + submission (last in queue)",
    ],
    preprintId: "HUBIFY-2026-005",
    pdfMeta: "PDF 1.1 MB · 25 pp · updated Jun 9, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.53.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.53.pdf", kind: "secondary", download: true },
      {
