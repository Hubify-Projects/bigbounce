...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "5 findings honestly disclosed as open, not closed: the archived autoencoder's undocumented training corpus/architecture, the deduplication rule's unquantified near-threshold effect, the taxonomy's RA-wrap and missing clustering hyperparameters, a blue-arm quality-cut removal quantification (no cut is pre-declared), and a literature-sourced Gunn-Peterson expected flux-ratio citation",
      ...
      "Directive R2: round 2 of 2 spent (confirmation board ran 2026-09-22, found and closed real items); readiness 80 COMPUTED — no further board without an intervening science/scope decision",
    ],
    preprintId: "HUBIFY-2026-AF",
    pdfMeta: "PDF · 18 pp · vAF.0.6 · created Sep 22, 2026 · md5 47fca3cb5d827518aebde7499b8dc810 — R2 confirmation board closed 9 real findings (most consequentially a headline R² attribution error); primary null result unchanged.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/anomaly_flagship_vAF.0.6.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/anomaly_flagship_vAF.0.6.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
