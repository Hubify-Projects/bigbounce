...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. v1.0.262 closes both genuinely-new-real findings from the exact v1.0.261 board truth audit: an editorial plain-English gloss of raw_flip_qc_unsafe at its first main-text declaration (Sec 3.2), and a delivered per-region CW-fraction monopole correction map with per-region binomial uncertainty at HEALPix NSIDE=8 and NSIDE=64, reproducing the canonical Table-4 monopole (f_CW=0.49735, -9.47 sigma) bit-for-bit. No science number changed; the primary remains null-consistent and harmonic results remain systematics diagnostics only. Training replay, spatial covariance, complete metadata, a DOI-backed archive, exact v1.0.262 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.262 confirmation board (closes the v1.0.261 board's gloss + delivered monopole correction map findings on 2026-07-16) before any DOI publication",
    ...
    pdfMeta: "PDF · 26 pp · v1.0.262 · sha256 f59fc937 · md5 4cd02794 — closes the v1.0.261 board's editorial gloss + delivered monopole correction map findings; exact re-review and external/human gates remain. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.262.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.262.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
