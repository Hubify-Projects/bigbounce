...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "30+",
    readiness: 76,
    status: "76% — compute-gated on DESI DR2 w0wa cobaya chain. Honest R̂−1 trajectory (full progress file pulled 5/11 17:33 PT after pod IP rotation): 0.55 (5/7) → 0.20 (5/7) → 0.16 (5/8) → 0.12 (5/9) → 0.115 (5/10 04:25) → 0.079 (5/10 23:02, low water) → 0.095 (5/11 17:33, BACKWARD step). 9,127 accepted across 4 chains, 28% acceptance. The earlier 'ETA 1–3 days from 5/8' was extrapolated from a single 0.076 datapoint and is now stale: next decade (0.10 → 0.01) typically takes 3–10× previous decade since slowest eigenmodes dominate. **Honest ETA for R̂−1 < 0.01: 5–15 more days at current trajectory.** §Structural Tension MCMC numbers remain placeholder until convergence. Excluded from R44 self-review for the same reason; R45 + cross-vendor + Houston sign-off all still ahead.",
    statusVariant: "green",
