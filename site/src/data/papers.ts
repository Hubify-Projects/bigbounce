...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "R1 board closed (Claude INT major-revisions, Grok API REJECT, Gemini API REJECT; Perplexity absent/401) — 19/19 canonical real findings closed this round; R2 board dispatched, verdicts pending",
    ...
    pdfMeta: "PDF · 10 pp · v1N.0.2 · created Sep 2, 2026 · md5 5f41629b370a55991a4c25937925a281 — R1 closure (19/19 canonical real findings closed), 2026-09-02. R2 board dispatched, verdicts pending.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1bc_ech_note_v1N.0.2.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1bc_ech_note_v1N.0.2.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R1 board closed on v4P.0.1; R2 board (Grok/Gemini/Claude) dispatched on v4P.0.2 — verdicts pending, never fabricated",
      "Convex paperVersions:bump / activityFeed:add registration (this session)",
    ...
    pdfMeta: "PDF · 10 pp · v4P.0.2 · created Sep 2, 2026 · md5 413705f8cf6ce69da4fe6744b3014ea2 — R1 closure draft folding P4+P5, 2026-09-02 portfolio restructure. R2 board dispatched, verdicts pending.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.2.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.2.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
