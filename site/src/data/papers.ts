...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF 1.7 MB · 27 pp · v1A.0.66 · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.66.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.66.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 1.1 MB · 18 pp · v1B.0.63 · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.63.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.63.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 875 KB · 25 pp · v1.7.58 · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.58.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.58.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 4.4 MB · 28 pp · v3.1.101 · updated Jun 11, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.101.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.101.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 34 MB · 22 pp · v1.0.180 · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v180.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v180.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF 1.1 MB · 30 pp · v0.1.70 · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.70.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.70.pdf", kind: "secondary", download: true },
      {
