...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "v0.1.7 (cron fire #25): added Limitations item closing the RSD gap — pairwise σ_v ≲ 400 km/s gives RSD displacement σ_v/(aH) ≲ 5–8 Mpc/h, which is 3–5× smaller than R_s=25 Mpc/h smoothing → headline null is robust to RSD at V-Web resolution. Paper now spans Phase 1 + Phase 2 (3×3 sensitivity sweep) + Tempel+2014 cross-val (filament concordance 0.026pp) + LEE derivation + 6 figures + RSD-robustness Limitations item. PDF 738KB / 0 overfull / 0 undef. First R-round still API-blocked on OR cap.",
    blockingItems: [
