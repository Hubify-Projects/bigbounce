...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "46",
    readiness: 91,
    status: "91% — v1.0.56 (Houston P4-priority push: 5th-vendor verification round on v1.0.55 found 5 surviving issues; all closed in this commit). GPT-B1 hemisphere 'does not survive' framing inverted at remaining sites — replaced with explicit dual-LEE-method agreement language (analytic Bonferroni/BH penalty + direct 10000-MC null at p_LEE≤10⁻⁴; both agree on null verdict) at Fig 14 caption + §VIII.E enumeration. GPT-B2/DeepSeek-M1 factor-of-2 corrections propagated to 5 more 0.2%→0.29% sites in §intro / §VII.B / §IX.C / §sensitivity. GPT-B3/DeepSeek-B2 '-0.122σ canonical primary' relabeled across 4 sites (abstract + Table III row + 2 prose paragraphs) — now 'subsample mask headline + canonical-N analytic projection +0.2595σ as mask/N-invariance cross-check; both within null band'. DeepSeek-B1 empirical floor restated honestly as `>0.5%` not `≳0.5% at 3σ` (the 50%-recovery threshold isn't demonstrated within tested A∈[0.05,0.50]% grid; P(σ>2)=0.18 at A=0.5%; bounded only above). PDF 30pp / 25.89 MB / 0 undef refs / sha256 d5ae37cb...",
    statusVariant: "green",
    target: "MNRAS",
    ...
    pdfMeta: "PDF 25.89 MB · 30 pp · May 14, 2026, v1.0.56",
    artifacts: [
