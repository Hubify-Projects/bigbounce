...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.130",
    tldr: "v1.0.130 (2026-05-26 cron fire #91 tick 213): Phase 2 closures from Houston-external 3-reviewer wave. (a) ChatGPT-B1 §sec:prereg \"Pre-Registered\" → \"Declared Analysis Hierarchy\" with explicit \"no time-stamped pre-registration was filed; fixed at v1.0.76\" disclosure. (b) ChatGPT-B7 Shamir body rewrite: Shamir-2020 SDSS+Pan-STARRS ~6.4e4+3.3e4 spirals (corrected from ~10^6 framing per external arXiv check); Shamir-2022 DESI Legacy ~2e5 after Ganalyzer cuts (not ~1.3M raw); explicit \"no likelihood-level exclusion\" disclaimer. (c) ChatGPT-M9 §sec:shamir scope narrowing: \"under the present ViT/TTA pipeline and selection\" replaces \"factor of ~6-12 smaller\" framing. (d) S4 Gemini-BL2+ChatGPT-B6 partial: hard-label 21.4% flip propagation caveat added to Table~\\ref{tab:headline_summary} fn(c) extending headline-scope clarification. PDF 51pp/26.24MB/0 undef/2 overfulls.",
    blockingItems: [
      "Houston personal sign-off (the final 1%)",
