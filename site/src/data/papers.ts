...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper1bc_ech_note_arxiv_v1N.0.4.tar.gz",
      "Houston sign-off (readiness 95→100) has not been sought",
    ],
    preprintId: "HUBIFY-2026-001N",
    pdfMeta: "PDF · 12 pp · v1N.0.4 · created Sep 2, 2026 · md5 dcdeb0e1326fd3ef5b396e7d84a60d28 — R3 verification closed (Claude major-revisions, Grok reject, Gemini major-revisions), automated review converged, final author review APPROVE, readiness 95.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1bc_ech_note_v1N.0.4.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1bc_ech_note_v1N.0.4.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "PBH abundance channel: compaction-function row pending",
    ],
    ...
    remainingWork: [
      "PBH compaction-function row pending",
      "One INT board pending",
      "Registered as a draft this session (v3M.0.2); Convex paperVersions:bump / activityFeed:add recorded",
    ...
    pdfMeta: "PDF \u00b7 6 pp \u00b7 v3M.0.2 \u00b7 created Sep 2, 2026 \u00b7 md5 8f17a2dc877c0b58982e91a8dea0fa1b \u2014 draft registration; A3 skeleton + P2\u2032 v2L.0.2 theory folded in.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.2.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.2.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.4.tar.gz",
    ...
    pdfMeta: "PDF · 11 pp · v4P.0.4 · created Sep 2, 2026 · md5 ed6b8f661b407e6845cb5d42c3efd8d2 — R3 verification closed (Claude minor, Grok reject, Gemini minor), automated review converged, final author review APPROVE, readiness 95.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.4.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.4.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
