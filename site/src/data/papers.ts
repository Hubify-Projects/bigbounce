...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    refs: "30+",
    readiness: 96,
    status: "96% — Wave 14-JJ P4-CM-B2 PSF cross-correlation BLOCKER in flight on Pod 3; Gemini B-1 NaMaster recompute + 6 OpenAI compute-heavy MAJORs pending",
    statusVariant: "amber",
    target: "MNRAS",
    ...
    remainingWork: [
      "Wave 14-JJ P4-CM-B2 PSF cross-correlation must confirm close on Pod 3 H200 (patch 3 NaN-row filter applied; ~1-2h)",
