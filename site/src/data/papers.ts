...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3M.0.25",
    lastUpdated: "2026-09-18",
    tldr: "A2 monopole reconciled: an independent adjudication confirms A2=eps(3-eps)^2/3 (correct constraint solve) and f_NL^rho=5(eps-7)/8=-55/16 at dust, closing the 15/16 gap via a corrected composition weight (3lambda, not 2lambda). Sec. II and Appendix A now state the in-in -15/8, comoving -5, and uniform-density -55/16 delta N values as three well-defined variables related by exact threading maps, not competing claims. Flagship -35/16 unaffected. Rounds still stopped under R2. Readiness 75.",
    path: publicationPath({}),
    pages: "19",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 20 pp \u00b7 v3M.0.25 \u00b7 created Sep 18, 2026 \u00b7 md5 d46166cb88b32009cdc6be59bb620547 \u2014 R9 closure (rounds resumed, ledger row 19 CLOSED): reproducibility pin re-pointed after the old commit pin was found to hold none of the ~12 cited artifacts; Eq. (15) re-attributed to Li+2016 Eq. (5.1) with the general-lambda amplitude now primary; and the 10^11 f_NL figure bounded by a committed perturbativity floor (c_s >~ 0.08, where r >~ 1.8 is already 49x BICEP/Keck). Readiness 75 COMPUTED \u2014 confirmation board pending.",
    changelog: [
