...
export const papers: Paper[] = [
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "R26conf: App C verified clean; Cartan factor-2 disclosed · re-derivation + R27conf next",
      },
    }),
    pages: "25",
    refs: "72",
    ...
    keyResults: [
      ...
      "R26conf: App C derivation verified step-by-step clean; Cartan factor-2 normalization inconsistency disclosed (single-convention re-derivation queued, analytic); dimensionally inconsistent thermal clause removed (v1A.0.54)",
    ],
    ...
    remainingWork: [
      "Cartan factor-2 single-convention re-derivation (analytic, queued) + R27conf cross-vendor round on v1A.0.54",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.54.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.54.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "R26conf ROUND CLEAN on v1B.0.54 · Houston external round queued",
      },
      signoff: {
        label: "Houston sign-off",
        state: "active",
        note: "SIGN-OFF-READY — third paper at the gate; submits same-day with P1A",
      },
    }),
    pages: "16",
    refs: "32",
    ...
    pdfMeta: "PDF 1.1 MB · 16 pp · updated Jun 11, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.54.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.54.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: publicationPath({
      external: {
        label: "External journal-style review",
        state: "active",
        note: "R25conf ROUND CLEAN on v1.7.47 → v1.7.48 · Houston external round queued",
      },
      signoff: {
        label: "Houston sign-off",
        state: "active",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.48.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.48.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "R26conf: zero arithmetic errors across the round; 12 textual closures — cluster accounting made exact from the dedup artifact, NANOGrav Eq. E1 claim falsified by rederivation (v3.1.85)",
    ],
    ...
    remainingWork: [
      "1 ESS queued (tabular feature-scaling spec recovery, pod-side) + 2 MAJOR recomputes → R27conf cross-vendor round must come back clean on v3.1.85",
      "Houston external review round + personal sign-off (final 1%, gated)",
      "HuggingFace visibility flip on bamfai/galaxy-anomaly-catalog-* (Houston manual on HF dashboard)",
      "arXiv submission (administrative)",
    ],
    preprintId: "HUBIFY-2026-003",
    pdfMeta: "PDF 4.5 MB · 26 pp · updated Jun 11, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.85.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.85.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: [
      ...
      },
      {
        label: "External journal-style review",
        state: "active",
        note: "3-vendor round closed in v1.0.151 · next Houston round queued on v1.0.171",
      },
      {
        label: "Houston sign-off",
        state: "active",
        note: "SIGN-OFF-READY — first in the submission queue",
      },
      {
        label: "arXiv submission",
        state: "pending",
        note: "First in queue — awaiting Houston sign-off only",
      },
    ],
    pages: "21",
    refs: "46",
    ...
    pdfMeta: "PDF 25 MB · 21 pp · updated Jun 10, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v171.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v171.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "R26conf: zero arithmetic errors across the round; 9 closures including code-verified tidal-tensor sign documentation (v0.1.57)",
    ],
    ...
    remainingWork: [
      ...
      "R27conf cross-vendor round must come back clean on v0.1.57",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.57.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.57.pdf", kind: "secondary", download: true },
      {
