...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 60 pp · v1U.0.4 · updated Jul 9, 2026 · md5 5bb71901 — P1U round-2 REAL-WORK closure: derived the genuine dim-4 parity-odd operator completion (App B, symbolic-verified — single-scale closure survives at dim 4), wrote out the perturbation-transparency proof term-by-term (perturbed tetrad/connection, order-by-order Bianchi vanishing), made the first-principles ΔNeff^(ECH)~1e-43 proxy-validity argument unmissable, and sharpened the title to Channel-Level Constraints (amplitude R1–R3 / naturalness R4)",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1_unified_v1U.0.4.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1_unified_v1U.0.4.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 36 pp · v1.7.105 · updated Jul 9, 2026 · md5 7cfc3239",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.105.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.105.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
