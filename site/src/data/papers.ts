...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.6. v2B.0.8 makes receipt metadata recursively type-strict and rejects malformed broadcastable exact-window operator outputs. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.8",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.8 · package 0.1.6 · 41 tests · sha256 cf7ede299ee5d6c28209817c7a0ee195000fe8dd77c276e830d8d04f5d2c3195 · strict receipt/operator validation · visual audit passed · exact confirmation pending · readiness holds 56",
    artifacts: [
