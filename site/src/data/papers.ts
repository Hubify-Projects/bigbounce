...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "Software metapaper · 16 pp · v2B.0.22 · package 0.1.7 · 41 tests · updated Sep 5, 2026 · md5 843755dc1931e6e469b88150b7de4fc9 — deferred D-R3-21 closed: all three injected-angle recovery sigmas now report mean+-SEM. ROUNDS STOPPED under R2; venue decision next.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.22.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.22.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 18 pp \u00b7 v3M.0.21 \u00b7 created Sep 5, 2026 \u00b7 md5 91d5a6511eb0169054855b5fae85960e \u2014 literature/derivation correction: uniform-density delta N is not reconciled. Readiness 75 \u2014 ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.21.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.21.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 6 pp · v1S.0.5 · created Sep 5, 2026 · md5 780b079e88e4ade112b35517edece020 — S9/S10 second-order closure (K_c closed form, rho-slice -5/2 does not reproduce -55/16). Readiness 65 — ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.5.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.5.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
