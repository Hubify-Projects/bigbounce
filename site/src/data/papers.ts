...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 28 pp · v1A.0.73 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.73.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.73.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 21 pp · v1B.0.70 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.70.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.70.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 29 pp · v1.7.64 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper2_fnl_forecast_v1.7.64.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper2_fnl_forecast_v1.7.64.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 29 pp · v3.1.107 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.107.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.107.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 23 pp · v1.0.187 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v187.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v187.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v0.1.76-2026-06-13 · updated Jun 13, 2026",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.76.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.76.pdf", kind: "secondary", download: true },
      {
