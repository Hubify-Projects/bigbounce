...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      "Independent human ApJS scientific review; v1.0.244 has not been re-reviewed",
      "Immutable catalog/source/PDF archive and real release DOI",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-004",
    pdfMeta: "PDF · 26 pp · v1.0.244 · updated Jul 14, 2026 · sha256 1b1a536d — bounded catalog-release transform reproduced 8,474,531 rows; independent strict-sample check gives A=0.0045971, z=0.5491, empirical-rank p=0.26517. Immutable archive/DOI and human ApJS review remain open; no v1.0.244 re-review or ACCEPT is claimed; readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.244.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.244.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
