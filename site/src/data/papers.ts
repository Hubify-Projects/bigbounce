...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3M.0.5",
    lastUpdated: "2026-09-02",
    tldr: "Track A's flagship submission candidate: folds the A3 multi-channel skeleton (NANOGrav 15-yr free-spectrum \u03b3, PBH abundance, SPHEREx/MegaMapper reach) together with the P2\u2032 v2L.0.2 exact matter-contraction theory (f_NL = \u221235/16, ledger #1 CLOSED independent re-derivation, orientation-dependent squeezed limit, \u03b4N cross-check) per the 2026-09-02 lineage decision. v3M.0.5: R2 CLOSED \u2014 real 30-bin injection-recovery validation, Eq. (8) sigma^2 term restored, Omega_DM label fixed; per directive R2 review rounds now STOP (2/2 consumed), remaining ledger is genre/venue only.",
    path: publicationPath({}),
    pages: "9",
    refs: "\u2014",
    readiness: 70,
    ...
    remainingWork: [
      "Rounds STOP after v3M.0.5 per directive R2 (2/2 review rounds consumed); remaining ledger is genre/length/venue (abstract trim, bibliography DOIs, Zenodo frozen-release minting).",
    ...
    pdfMeta: "PDF \u00b7 9 pp \u00b7 v3M.0.5 \u00b7 created Sep 2, 2026 \u00b7 md5 67e1510e2b300ec683ed2e288ef1aefe \u2014 R2 CLOSED (real 30-bin injection validation, Eq. 8 sigma^2 term, Omega_DM fix, precision/labels); rounds stop per directive R2 (2/2 consumed); residue genre/venue.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.5.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.5.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
