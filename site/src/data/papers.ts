...
export const papers: Paper[] = [
  {
    ...
    refs: "70+",
    readiness: 85,
    status: "85% — R44 BLOCKERs + 4-route no-go appendix + cross-paper bibitems shipped; M4 D_inf prefactor + M5 orphan-label sweep + R45 self-review + cross-vendor non-Anthropic round + Houston sign-off pending",
    statusVariant: "green",
    ...
    pdfMeta: "PDF 768 KB · 15 pp · May 8, 2026, v1A.0.6",
    artifacts: [
