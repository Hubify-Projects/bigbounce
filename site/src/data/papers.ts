...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.266",
    lastUpdated: "2026-07-17",
    tldr: "Classifies 8.47M galaxies. The strict safe-sample observed-label statistic remains null-consistent (z=0.63465, p=0.23768). Two real-compute pod-campaign closures land in v1.0.266: a manifest-retained ViT retrain (val_acc 0.9931) proving the exact training realization, and a training-disjoint validation (accuracy 0.9867, kappa 0.9733 on 3,000 doubly-disjoint GZ1 spirals) — presented like-for-like against, not as a replacement for, the historical kappa=0.40 human-vote figure. CE-ResNet catalog re-provisioning, complete covariance, archive, exact re-review, and human gates remain; readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "18",
    readiness: 80,
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.266 confirmation board (reviews the G1 manifest-retained retrain + G2 training-disjoint validation closures computed 2026-07-17) before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.266 · md5 71db6ac68baedaa84833d36d3de32c8d — two real-compute pod-campaign closures: a manifest-retained ViT retrain (val_acc 0.9931) proving the exact training realization, and a training-disjoint validation (accuracy 0.9867, kappa 0.9733 on 3,000 doubly-disjoint GZ1 spirals), presented like-for-like against the historical kappa=0.40 human-vote figure. CE-ResNet re-provisioning gate remains open. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.266.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.266.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
