...
export const researchPrograms: ResearchProgram[] = [
  {
    ...
    supportingLinks: [
      ...
      },
      {
        ...
        description:
          "A systematic survey of 7 foundation mechanism classes and 6 observational branches, extracted from the retired P1U barrier catalog, collapsing to 13 distinct mechanism-class constraints across 14 catalog entries and closing four candidate dark-energy routes (R1-R4). Draft v1C.0.8, compiled 18 pp, 0 undefined refs, 0 overfull boxes — closes the R5 confirmation board on the exact v1C.0.7 PDF (Claude INT ACCEPT, 0 MAJOR/3 MINOR — the Claude leg's first ACCEPT; Grok REJECT; Gemini MAJOR REVISIONS; Perplexity leg failed): 6 genuinely-new items closed, all bounded citation/wording/provenance-grade — beta_obs = 0.342+-0.094 deg re-attributed to the Eskilt-Komatsu WMAP+Planck analysis with the Minami-Komatsu Planck-2018 first extraction (0.35+-0.14 deg) cited separately, the 30-37 lever-arm endpoints both motivated (mu_IR ~ 1 GeV vs 1 TeV cuts), the unreconstructible ~1e-33 alternative-ordering figure removed (labeled loose/unused; no derivation exists — never-fabricate), Data & Code process-prose neutralized with a planned pre-publication archival deposit stated for this survey's scripts (DOI minting deferred to packaging), and the Fig 1 R4 label harmonized to naturalness/explanatory-deficit. Gemini's claimed Fierz (1,3)=1 typo re-falsified by exact-rational recomputation of the PDF-printed matrix (F_c^2 = identity on all 25 entries; rasterization misread, same root cause as R3). DRAFT: R5 found genuinely-new items, so an R6 confirmation board is required; no readiness score has been computed and no venue/Zenodo kit exists yet.",
        href: "/papers/paper1c_nogo_survey_v1C.0.8.pdf",
        external: true,
      },
    ],
