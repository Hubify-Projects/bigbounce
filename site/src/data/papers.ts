...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.247",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.247 publishes the exact safe/quarantine/null bundle and records the GZ1 supported N=4,963; exact training realization and spatial covariance remain major gates. Readiness holds 80 pending re-review.",
    path: publicationPath({}),
    pages: "27",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with rotational-equivariance correction. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.247 makes the exact safe catalog, quarantine, retained null, checksums, schema, and reproducer public at immutable Hugging Face commits. Submission still requires exact training provenance, covariance-aware spatial confusion propagation, a DOI-backed paper/source archive, and human review.",
    keyResults: [
      ...
      "Public ApJS catalog bundle: immutable HF data commit 58ecc795 contains the safe catalog, 249,066-row quarantine, retained 10,000-draw null, manifest, schema, checksums, and reproducer; provider receipt commit 5a322faa verifies remote paths and byte sizes",
    ...
    remainingWork: [
      "Obtain an exact v1.0.247 confirmation board; v1.0.245 was MAJOR/MINOR/MINOR and no v1.0.247 acceptance is claimed",
    ...
    pdfMeta: "PDF · 27 pp · v1.0.247 · updated Jul 15, 2026 · sha256 a4d91511 — public catalog bundle + exact GZ1 support closure; readiness holds 80 until exact re-review.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.247.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.247.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
