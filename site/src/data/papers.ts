...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Track A's flagship submission candidate: folds the A3 multi-channel skeleton (NANOGrav 15-yr free-spectrum \u03b3, PBH abundance, SPHEREx/MegaMapper reach) together with the P2\u2032 v2L.0.2 exact matter-contraction theory (f_NL = \u221235/16, ledger #1 CLOSED independent re-derivation, orientation-dependent squeezed limit, \u03b4N cross-check) per the 2026-09-02 lineage decision. v3M.0.12: R5 closure C1-C7 (S1/S2 transfer-bound scoping, NANOGrav Omega_GW correction, editorial MINORs, Fig. 1 regeneration) plus DA3M-R5-15 (first-order tensor Omega_GW at nHz, null) and DA3M-R5-18 (gamma_cr grid coverage). Readiness 75.",
    path: publicationPath({}),
    pages: "15",
    refs: "\u2014",
    readiness: 75,
    ...
    predictions: ["f_NL = -35/16", "NANOGrav channel: null for the lab's own spectrum (gamma_pred 5.07, amplitude 14.3 dex below the signal)"],
    ...
    pdfMeta: "PDF \u00b7 15 pp \u00b7 v3M.0.12 \u00b7 created Sep 4, 2026 \u00b7 md5 6c9a16d50efe17e16ac683fdb96807ca \u2014 R5 closure C1-C7 + DA3M-R5-15/18: S1/S2 transfer-bound scoped, NANOGrav Omega_GW corrected, Fig. 1 regenerated, first-order tensor null + gamma_cr coverage inserted. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.12.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.12.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
