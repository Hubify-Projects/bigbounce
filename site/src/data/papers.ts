...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF 28.44 MB · 48 pp · May 29, 2026, v3.1.69 (conclusions retracted-Fisher-form fix; canonical §sec:fnl positivity-envelope framing)",
    artifacts: [
