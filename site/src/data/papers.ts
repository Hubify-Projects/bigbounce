...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 18 pp \u00b7 v3M.0.19 \u00b7 created Sep 4, 2026 \u00b7 md5 fdbf93bfacc6cc644e103ff522d15381 \u2014 D-A3-14: the (r,f_NL) no-go generalizes to the full P(X) k-essence class, r and the bounce cubic term exactly lambda-independent, DBI best case r_min=12.57 (349\u00d7 BICEP/Keck). Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.19.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.19.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.6.tar.gz",
    ...
    pdfMeta: "PDF · 12 pp · v4P.0.6 · created Sep 4, 2026 · md5 4e40b0507b924690310e26aae52e26e5 — row-16 disclosure (pixel calibration, full-parent systematic, structure nulls) integrated; no science-conclusion change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.6.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.6.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 6 pp · v1S.0.3 · created Sep 4, 2026 · md5 afeda89e03a7e0bc688d84c423d164fb — R2 closure: 20 genuinely-new-real findings closed (Eq. 4 sign flip, Cai ratio 4/3, new Appendix A). Readiness 65 — ROUNDS STOPPED (R2).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.3.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.3.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
