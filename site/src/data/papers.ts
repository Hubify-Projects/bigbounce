...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    keyResults: [
      ...
      "Synthetic sky-fraction/sign controls: f_sky=0.85 gives 0.270° (SE 0.001412°), f_sky=0.65 gives 0.268° (SE 0.001582°), and a −0.270° injection gives −0.270° (SE 0.002200°); no resolved multiplicative under-recovery",
      "Spectator-ALP sensitivity is quantified by an unconditional N=100,000, seed-1234 prior-predictive calculation with exact priors and signed-band rule; this is a prior-sensitivity result, not an ECH detection",
    ...
    remainingWork: [
      "v1B.0.107 confirmation returned Grok ACCEPT / Gemini MAJOR / Codex-subscription MAJOR; the two bounded real majors are closed in v1B.0.108, but no v1B.0.108 re-review was run",
      "Human review, immutable release packaging, venue disposition, and submission metadata remain open; readiness holds at 56",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "Standalone companion · 19 pp · v1B.0.108 · sha256 a85f43f93ed7bb53e73304cd21fb0fe68ed0d6627103ccbcf970036d31d9a9fb",
    artifacts: [
