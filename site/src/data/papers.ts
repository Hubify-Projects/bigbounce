...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.251",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.251 closes the bounded exact-board defects; training replay, spatial covariance, a DOI-backed archive, exact confirmation, and human review remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "28",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.251 uses AASTeX 7, retains only apodization robustness and multipole coherence in the strict FS-C synthesis, and closes the bounded defects found by the exact v1.0.250 board. Training replay, spatial covariance, a DOI-backed archive, exact confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      "Publish a fail-closed, versioned morphology/imaging-systematics sidecar with an unambiguous join contract, and correct the public release README column claims",
    ...
    pdfMeta: "PDF · 28 pp · v1.0.251 · updated Jul 15, 2026 · sha256 4f8046df — bounded exact-board closure; readiness holds 80 pending major provenance, exact, and human review.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.251.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.251.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
