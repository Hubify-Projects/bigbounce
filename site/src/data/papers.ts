...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    description:
      "Track B of the 2026-09-02 portfolio restructure (directive R3): P1A's algebraic Cartan elimination (spin-sourced axial contact term, zero-spin scalar branch) merged with P1C's 14-entry structural no-go survey (Route-2/Route-3 amplitude-budget closures, six-member dimension-4 parity-odd operator list) into one Note that states both readings of the same result — what minimal ECH gravity does for the bounce, and what it cannot do for dark energy. As of v1N.0.8, the Introduction and Discussion identify the derived contact term with Popławski's spin-spin bounce mechanism (arXiv:1007.0587; arXiv:1102.5667) as an operator identification only (exact as γ→∞) — the paper does not independently establish the sign of pressure at finite γ; see the v1N.0.8 changelog entry.",
    keyResults: [
    ...
    remainingWork: [
      "SIGN-OFF HOLD RETAINED (2026-09-22, v1N.0.8): DP1N-60/61 CLOSED-BY-WITHDRAWAL, not restored — the repulsive-sign bridge (§II) and the Popławski-rebuttal claim (§VII.D + abstract) are withdrawn with no replacement claim manufactured; readiness dropped 95→85 COMPUTED",
      "A fresh exact-version confirmation board on v1N.0.8 is needed (spends a new directive-R2 round) to re-verify the withdrawal reads cleanly to an independent referee before readiness can climb again",
      "New flagged item, not yet a disposition: the Fierz row's scalar-channel sign (which drives G_s, the NJL no-condensate result) was not checked against the DP1N-60 derivation — lane bb-LS15-fierz-sign is deriving it separately; a further readiness change may follow either direction",
      ...
      "arXiv tarball rebuilt + standalone-smoke-tested: SSOT/arxiv_tarballs/paper1bc_ech_note_arxiv_v1N.0.8.tar.gz",
      "Houston sign-off has not been sought and should not be until a fresh board confirms v1N.0.8",
    ],
    preprintId: "HUBIFY-2026-001N",
    pdfMeta: "PDF · 12 pp · v1N.0.8 · created Sep 22, 2026 · md5 0d1ca775d81c4428a784ba26914aa5ae — SIGN-OFF HOLD RETAINED: DP1N-60/61 closed by withdrawal (readiness 95→85 COMPUTED), not restored.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1bc_ech_note_v1N.0.8.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1bc_ech_note_v1N.0.8.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
