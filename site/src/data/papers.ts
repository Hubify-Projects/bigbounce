...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "The v1B.0.109 exact board is MAJOR/MINOR/ACCEPT. The physical-spectrum and BBN execution contracts are now repaired and tested, but no corrected 500-MC production run or new PDF exists; physical sensitivity, scatter, and bias claims remain withdrawn. Readiness holds 56.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis and an ALP prior-predictive diagnostic reported before and after Ω_a<0.01. The current NaMaster artifact remains useful only as an algebraic window/operator validation. The generator now requires pinned CAMB 1.6.6 raw lensed EE/BB spectra and the YAMLs identify the executed PRIMAT BBN table, but production has not run and the v1B.0.109 PDF still contains superseded physical-sensitivity and BBN wording. These are not evidence, posterior probabilities, or a sky detection.",
    keyResults: [
    ...
    remainingWork: [
      "Run the repaired physical-spectrum pipeline for the full 500-MC and robustness suite; regenerate every affected figure and sensitivity/bias number",
      "Correct the manuscript to the executed PRIMAT BBN provenance, recompute the S8 overlay with the declared 30% burn-in, and close the manifest/release gate",
  ...
  },
  {
    ...
    version: "v1.0.256",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.256 closes truth-audited v1.0.255 artifact, statistical-wording, bias-metric, and interpretation defects; exact v1.0.256 confirmation plus standing training, covariance, metadata, DOI, and human gates remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. The audited v1.0.256 PDF reconciles the retained primary artifact, finite-Monte-Carlo/null-generator wording, committed bias metrics, and causal/spatial/D4 scope after the exact v1.0.255 board. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact v1.0.256 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit exact non-Anthropic confirmation on the audited v1.0.256 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.256 · sha256 6dfccf7c · md5 31057aad — truth-audited exact-board closure; exact v1.0.256 confirmation pending. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.256.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.256.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "v0.1.135 labels the focal sample as a GALZONE-eligibility/VoidFinder-exposure hybrid and adds a post-review K=13 sensitivity plus a 99,999-draw null-imposed wild-cluster test (p=0.67345)",
      "v0.1.135 distinguishes the raw Z3 multiplicity crossing from the monopole-subtracted and empirical-scan results, and removes unsupported target-program independence wording",
      "v0.1.135 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified artifact links remain required before submission",
    ],
    ...
    remainingWork: [
      ...
      "Run exact-PDF confirmation review on v0.1.135 and keep the secondary T-Web RSD limitation explicit",
    ...
    pdfMeta: "PDF · 39 pp · v0.1.135-2026-07-15 · updated Jul 15, 2026 · sha256 7223afcc — exact v0.1.134 board truth-audit closure: hybrid-estimand labeling, bounded covariance-rank/wild-cluster sensitivity, multiplicity summary, target-program wording, and literature scope corrected. Thirteen mirrors and Convex row k578yn7865cz6tsdntttfazyvx8ammyw are synchronized. Readiness remains 74; Paper IV, public-release/DOI, T-Web RSD, exact v0.1.135 confirmation, and human AJ gates remain open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.135-2026-07-15.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.135-2026-07-15.pdf", kind: "secondary", download: true },
      {
