...
export const researchPrograms: ResearchProgram[] = [
  ...
  },
  {
    ...
    status: "P4\u2032 at readiness 95, fresh exact-version confirmation in hand. Paper-af (anomaly-score catalogue) at vAF.0.4, readiness 75, R1 INT board closed (directive R2 round 1 of 2 spent). P3 is provenance support for paper-af. P1B (namaster-proof) is an optional JOSS note.",
  },
];
...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "2 of 4 honest TODOs from vAF.0.2 remain: the absent selection function (OT-1) and a Zenodo DOI",
      "Directive R2: round 1 of 2 spent; readiness 75 COMPUTED — no further board without an intervening science/scope decision",
    ],
    preprintId: "HUBIFY-2026-AF",
    pdfMeta: "PDF · 17 pp · vAF.0.4 · created Sep 19, 2026 · md5 4ae6347c1a4c48538241d3397a5653dd — R1 INT board (Claude opus + Grok + Gemini) closed 17/20 findings; primary null result unchanged.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/anomaly_flagship_vAF.0.4.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/anomaly_flagship_vAF.0.4.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
