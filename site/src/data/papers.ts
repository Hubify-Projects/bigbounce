...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 19 pp \u00b7 v3M.0.24 \u00b7 created Sep 7, 2026 \u00b7 md5 b29ebb90be09f8d0bbc3875647bb150a \u2014 A2 monopole gap reconciled (A2=eps(3-eps)^2/3 correct; f_NL^rho=5(eps-7)/8=-55/16 at dust via corrected 3lambda composition weight). Readiness held at 75 \u2014 ROUNDS STOPPED (R2).",
    changelog: [
