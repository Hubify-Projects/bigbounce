...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.252",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.252 publishes a truthful dataset card and exact morphology join; training replay, spatial covariance, complete systematics metadata, DOI, exact confirmation, and human review remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "28",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.252 uses AASTeX 7, closes the bounded v1.0.250 board defects, corrects the public dataset card, and publishes a fail-closed one-to-one join for every released spiral morphology row. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact confirmation, and human review remain open.",
    keyResults: [
    ...
    pdfMeta: "PDF · 28 pp · v1.0.252 · updated Jul 15, 2026 · sha256 a109f3d1 — public release-integrity closure; readiness holds 80 pending major provenance, exact, and human review.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.252.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.252.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
