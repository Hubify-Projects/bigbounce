...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.253",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). The audited v1.0.253 PDF records the verified public release contracts; exact review plus training, covariance, DOI, and human gates remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. The audited v1.0.253 PDF records the byte-verified public dataset/model cards and fail-closed morphology retrieval/derived-b/a contract that close three bounded release defects from the exact v1.0.252 board. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact v1.0.253 confirmation, and human review remain open.",
    keyResults: [
      ...
      "Release-contract closure: HF dataset revision 2fc392e2 publishes the fail-closed immutable-input validator and derived-b/a schema; HF model revision 3baeab86 publishes the corrected current model card",
    ...
    remainingWork: [
      ...
      "Rebuild and verify the reversible deposit draft against the audited exact v1.0.253 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.253 · sha256 d9030a7b · md5 fc6f13e5 — compiled, audited, and mirrored; exact reviewer confirmation pending. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.253.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.253.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
