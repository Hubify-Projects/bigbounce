...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Reframed from an N2 NaMaster-specific validation layer to a general verification primitive: content-bound execution receipts, tested against a pre-declared, sealed BLIND shortcut-detection protocol (18 runs, 3 per arm). The verifier detected all 4 receipt-visible shortcut classes 12/12 (100%) with 0/3 (0%) false positives on honest runs; a metadata-forgery arm escaped 3/3, reported as the limitation, not a protocol failure. N3-candidate: under a non-adversarial-analyst threat model, receipts alone (no re-run) decide whether an expensive analysis was actually performed.",
    path: publicationPath({}),
    pages: "8",
    refs: "4",
    readiness: 95,
    ...
    pdfMeta: "Software metapaper · 8 pp · v2B.0.17 · package 0.1.7 · 41 tests · updated Sep 4, 2026 · md5 7bc21cbe7a1dfb837f08cae2c8b0f2b3 — novelty lift #3: reframed as a general verification primitive (content-bound execution receipts); sealed blind shortcut-detection test 12/12 detected, 0/3 false positives, S5 metadata forgery escapes 3/3 (disclosed limitation). No readiness change.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.17.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.17.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v3M.0.15",
    lastUpdated: "2026-09-04",
    tldr: "D-A3-10/11 science reframe: the model's own tensor-to-scalar ratio r=16\u03b5=24, ~670\u00d7 above BICEP/Keck; no constant sound speed cures both r and f_NL (windows disjoint 296\u00d7 in c_s), confirming and strengthening Li et al. 2016's no-go 3.8\u00d7 \u2014 single-field matter bounce (canonical or k-essence) excluded jointly by r and f_NL. A curvaton-type spectator is named as the surviving (r, n_s)-viable route, diluting \u221235/16 by (r/24)\u00b2. PBH sign disagreement with Choudhury et al. resolved (in-coverage ratio 1.84\u00b10.03). Readiness 75.",
    path: publicationPath({}),
    pages: "17",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 17 pp \u00b7 v3M.0.15 \u00b7 created Sep 4, 2026 \u00b7 md5 4f2bf5e8204021bf06cbe27e3b8932c9 \u2014 D-A3-10/11 science reframe: joint (r, f_NL) no-go for single-field matter bounces (r=16\u03b5=24, windows disjoint 296\u00d7 in c_s), curvaton route named viable, PBH sign resolved (ratio 1.84\u00b10.03). Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.15.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.15.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.5.tar.gz",
    ...
    pdfMeta: "PDF · 11 pp · v4P.0.5 · created Sep 2, 2026 · md5 f0d874e93cebf95f86e408f780f002e0 — abstract trimmed to 246 words for the venue cap; no science change; REVISE (abstract cap) executed 2026-09-02.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.5.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.5.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    standaloneSubmission: true,
    title: "When the Separate Universe Fails: A Criterion for the Squeezed Bispectrum in Non-Attractor Phases",
    plainTitle: "When the separate-universe shortcut fails for the squeezed bispectrum",
    version: "v1S.0.1",
    lastUpdated: "2026-09-04",
    tldr: "Derives the exact threading identity between Maldacena's comoving ζ and the separate universe's zero-shift δN_c, and states the criterion: δN reproduces the squeezed bispectrum of ζ iff the ζ-growth-weighted mean ⟨ε/c_s²⟩_ζ vanishes. Validated on four backgrounds — dust contraction (O(1) failure), ultra-slow-roll inflation (agreement to O(ε)), attractor slow roll (identity map), ekpyrotic contraction (passes). Draft, readiness 40 — no INT/EXT board has run yet.",
    path: publicationPath({}),
    pages: "4",
    refs: "—",
    readiness: 40,
    ...
    remainingWork: [
      "No INT (Claude/Grok/Gemini) or EXT (browser) review round has run yet — the immediate next step per the standard R-round protocol",
    ...
    pdfMeta: "PDF · 4 pp · v1S.0.1 · created Sep 4, 2026 · md5 b974dc018e0f5a9f62aa92ea8cef697b — draft short note lifted from A3M Appendix A, no new math. Readiness 40.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper_su_criterion_v1S.0.1.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper_su_criterion_v1S.0.1.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
