...
function publicationPath(overrides: {
  ...
  return [
    ...
    overrides.external ?? {
      ...
      state: "done",
      note: "R+D+P complete — INT all-vendor + EXT headed rounds converged to the pattern-066 floor; FINAL_SIGNOFF_AUDIT found 0 unfixed genuinely-new findings (Jul 7 2026)",
    },
    overrides.signoff ?? {
...
export const papers: Paper[] = [
  {
    ...
    remainingWork: [
      "Houston sign-off (the final 1% — R+D+P complete)",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 34 pp · v1.7.99 · updated Jul 7, 2026 · md5 b081ce65",
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.99.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.99.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    path: [
      ...
      },
      {
        label: "arXiv submission",
        state: "pending",
        note: "First in queue — awaiting Houston sign-off",
      },
    ],
    pages: "31",
    refs: "46",
