...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "Software metapaper · 6 pp · v2B.0.17 · package 0.1.7 · 41 tests · updated Sep 4, 2026 · md5 7bc21cbe7a1dfb837f08cae2c8b0f2b3 — v2B.0.16 closes the 2026-07-23 Grok MAJOR. Its literal 'irreconcilable internal contradiction' claim is FALSIFIED: pyproject.toml, codemeta.json, CITATION.cff, __init__.py and Zenodo 10.5281/zenodo.21481753 all read 0.1.7. The legibility gap underneath it was real and closes here — the title-page stamp is now labelled a manuscript revision and a new Software version section states the document-vs-software namespace split. No readiness change.",
    artifacts: [
