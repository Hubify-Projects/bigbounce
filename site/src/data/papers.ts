...
export const papers: Paper[] = [
  ...
  },
  {
    slug: "paper-1b",
    number: "1B",
    title: "Technical Verification Companion to the ECH Spin-Torsion Program: ΛCDM+ΔN_eff MCMC Proxy, Exact-Window NaMaster Pipeline Recovery, and a Spectator-ALP Birefringence Consistency Check",
    version: "v1B.0.106",
    lastUpdated: "2026-07-14",
    tldr: "Standalone P1B is restored alongside the retained P1U history. Its exact NaMaster bandpower-window validation recovers β=0.269° from a +0.270° injection (bias −0.001°); the B-purified control gives the same result, and the full sign/f_sky battery shows no resolved multiplicative under-recovery. This is a synthetic-sky pipeline validation, not a sky measurement. Readiness remains capped at 56 pending exact-artifact review, human review, and release packaging.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    statusVariant: "amber",
    target: "Journal venue pending — standalone companion",
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis that recovers ΛCDM; an exact-bandpower-window NaMaster validation on synthetic ΛCDM polarization skies; and a spectator-ALP consistency check against published cosmic-birefringence constraints. P1U remains part of the project history but does not erase this standalone state. The NaMaster result is estimator calibration only, not a sky detection.",
    keyResults: [
      ...
      "Exact-window NaMaster 500MC on synthetic ΛCDM skies: +0.270° recovered as +0.269° (bias −0.001°); B purification also gives +0.269° (bias −0.001°) — pipeline validation, not a sky detection",
      "Declared-mask controls: f_sky=0.85 gives 0.270° (SE 0.001412°), f_sky=0.65 gives 0.268° (SE 0.001582°), and a −0.270° injection gives −0.270° (SE 0.002200°); no resolved multiplicative under-recovery",
      "Spectator-ALP f_a ~ M_Pl, m ~ H_0 consistent with Eskilt+ joint Planck+ACT 0.342°±0.094° (3.6σ)",
      "Exact-window recovery bias magnitude 0.001° is unresolved at the 500-MC estimator-calibration precision",
    ...
    remainingWork: [
      "Exact-artifact review of v1B.0.106 has not yet returned a final verdict; readiness therefore holds at 56",
      "Human review, immutable release packaging, and submission metadata remain open",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "Standalone companion · 20 pp · v1B.0.106 · sha256 7cb825572d6474e5d0fb88fa61157df31cf5b88730243f11cf39fc25e2512013",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.106.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_mcmc_companion_v1B.0.106.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "Adjusted non-void-minus-void contrast Δf_CW=+0.00125636; NSIDE=4 cluster-sandwich SE=0.00341274, 95% CI [−0.00543249,+0.00794522], p=0.71277",
      "Sensitivity to 3,750 nearest-VoidFinder-MAXIMALS clusters remains null (SE=0.003174, p=0.692); this is classifier-label evidence, not physical environment independence",
      "Focal model is an unpenalized binomial-logit MLE with a 78-column rank-78 design, spline-adjusted covariates, 50 occupied NSIDE=4 clusters, and finite-sample correction 1.020947",
      ...
      "v0.1.133 is a retained local candidate, not an immutable public release; a public tag/archive/DOI and verified A1–A40 links remain required before submission",
    ],
    ...
    remainingWork: [
      ...
      "Publish an immutable P5 tag/archive/DOI and verify every A1–A40 link; local retention is not a public release",
    ...
    pdfMeta: "PDF · 39 pp · v0.1.133-2026-07-14 · updated Jul 14, 2026 · sha256 db18dd93 — exact v0.1.132 ChatGPT-subscription review returned MINOR, not ACCEPT; v0.1.133 closes its sole wording finding under the anti-loop stop rule. Readiness remains 74; Paper IV, public-release/DOI, external-data/power, and human AJ gates remain open.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.133-2026-07-14.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.133-2026-07-14.pdf", kind: "secondary", download: true },
      {
