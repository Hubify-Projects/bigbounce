...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.249",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.249 restricts the FS-C synthesis to two support-bound diagnostics; exact training replay, spatial covariance, DOI, and re-review remain major gates. Readiness holds 80.",
    path: publicationPath({}),
    pages: "26",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.249 restricts the FS-C synthesis to apodization robustness and multipole coherence; six other diagnostics are different-support or support-unproven provenance. Submission still requires exact training replay, spatial covariance, a DOI-backed archive, exact re-review, and human review.",
    keyResults: [
    ...
    remainingWork: [
      "Obtain an exact v1.0.249 confirmation board; v1.0.248 was MAJOR/MINOR/MAJOR and no v1.0.249 acceptance is claimed",
    ...
    pdfMeta: "PDF · 26 pp · v1.0.249 · updated Jul 15, 2026 · sha256 f1ae309a — support-audit closure; only two diagnostics remain in the strict FS-C synthesis; readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.249.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.249.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
