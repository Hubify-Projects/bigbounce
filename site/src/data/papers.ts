...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Ledger row 9 (D-A3-9) CLOSED 2026-09-19 -- the intervening science decision directive R2 required before another board. A scheme-independent Bardeen-potential argument (independently blind-confirmed by a second construction) resolves the S1/S2 bounce-continuation ambiguity in favor of S2 on the Quintin-type background: f_NL^after is now the single value -1.25 there (was the two-scheme band [-1.25,-0.50]; S1's [-0.65,-0.55] retained only for LQC/poly, where S2 is not yet computed), and the tensor no-go strengthens to r_after~9.4e2 (2.6e4x BICEP/Keck, superseding the S1 24.0/670x headline). Propagated into the paper in v3M.0.27 together with a general-tilt (n_s=1) correction to Appendix A's monopole and squeezed-bispectrum formulas (gate S12); no number this paper headlines is affected at its own eps=3/2 dust value. R11 INT board dispatched on this exact PDF.",
    path: publicationPath({}),
    pages: "21",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 21 pp \u00b7 v3M.0.27 \u00b7 created Sep 21, 2026 \u00b7 md5 ea6ebd918399650702ee5a9c81182ab2 \u2014 ledger row 9 (D-A3-9) science-decision propagation: Bardeen-potential argument selects scheme S2 on the Quintin-type background (f_NL^after=-1.25, single value; r_after~9.4e2, tensor no-go strengthened), plus a gate-S12 general-tilt correction to Appendix A (no headline number affected). Readiness 75 COMPUTED \u2014 R11 board dispatched on this exact PDF.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.27.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.27.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    version: "v4P.0.10",
    lastUpdated: "2026-09-21",
    tldr: "Folds P4 (8.47M-galaxy chirality catalog, observed-label dipole null) and P5 (DESIVAST void/non-void environment contrast) into one ≤15 pp ApJS paper, adding a new section reading Popławski's rotating-black-hole-universe papers for a computed dipole prediction. Under the minimal closure needed to make the claim testable, the catalog's own A₉₅ᵒᵇˢ≈0.98% sensitivity floor excludes alignment fractions η>0.98% at ≥95% coverage — a factor of 2–20× below the ~7–33% amplitudes reported by Longo (2011) and Shamir (2012–2025). Confirms the independent reanalyses of Iye, Yagi & Fukumoto (2021) and Patel & Desmond (2024). v4P.0.10: a direct, assumption-light measurement of the observed-to-physical transfer function (a PA-restoring handedness-reversal test) replaces the withdrawn pixel-injection tension claim — the pipeline's own self-contradiction rate across orientations bounds the dilution at D≤0.717±0.005, raising the physical-parity floor to A₉₅ᵖʰʸˢ≥1.37%, consistent with (not in tension with) the illustrative g=0.398 bridge. Science propagation only, no review board this round; primary null result unchanged; readiness unchanged at 95.",
    path: publicationPath({}),
    pages: "15",
    refs: "—",
    readiness: 95,
    ...
    remainingWork: [
      "Row-16(ii-b) science propagation — v4P.0.10: withdrew the invalid pixel-injection tension claim, adopted the measured direct dilution bound (D≤0.717±0.005, A₉₅ᵖʰʸˢ≥1.37%); no review board this round; readiness holds at 95",
      "A fresh INT confirmation board on v4P.0.10 is now due (directive R2 round budget refreshed by this science decision) — not run in this lane",
      "arXiv tarball assembled: SSOT/arxiv_tarballs/paper4prime_chirality_test_arxiv_v4P.0.10.tar.gz",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.10.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.10.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
