...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "v1B.0.110 closes the S8 burn-in inconsistency with a hash-bound 30%-burn receipt: 93,064 post-burn samples from 132,949 raw Planck+BAO+SN samples. The corrected NaMaster production and exact BBN execution contracts remain open. Readiness holds 56.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis and an ALP prior-predictive diagnostic reported before and after Ω_a<0.01. v1B.0.110 corrects the S8 auxiliary overlay to the declared 30% burn-in and binds its raw/post-burn counts and hashes. The current NaMaster artifact remains useful only as an algebraic window/operator validation; corrected production and exact executed-BBN evidence are still required. These are not evidence, posterior probabilities, or a sky detection.",
    keyResults: [
      ...
      "S8 = 0.8273 ± 0.0100 from 93,064 post-burn samples (132,949 raw; declared 30% burn-in); 2.60σ vs DES-Y3 with posterior overlap 0.0539 (hash-bound overlay receipt)",
    ...
    remainingWork: [
      ...
      "Produce exact CAMB/PRIMAT BBN execution evidence and close the version-matched manifest/release gate; the 30%-burn S8 overlay is complete in v1B.0.110",
    ...
    pdfMeta: "Standalone companion · 20 pp · v1B.0.110 · sha256 a06777841125b8576f0acbdee1f4c3147cec913dc8f3dfc091bd286b457f98f0 · S8 burn-in contract closed; NaMaster production and exact BBN execution remain open; readiness holds 56",
    artifacts: [
