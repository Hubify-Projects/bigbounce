...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.3. v2B.0.4 closes a verified concurrent-publisher metadata/byte cross-binding race while preserving the verifier and real-PyMaster closures. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "26 automated tests across Linux Python 3.10–3.13 plus Windows 3.12, including verifier- and publisher-side concurrency regressions",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.4",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.4 · package 0.1.3 · 26 tests · sha256 dfe16983718fc8073f256c86a653d6fc3de7ae5fc99788b015e71b33360748b4 · publisher and verifier concurrency races closed · Linux/Windows CI · exact confirmation pending · readiness holds 56",
    artifacts: [
