...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Classifies 8.47M galaxies. The strict safe-sample observed-label statistic remains null-consistent (z=0.63465, p=0.23768), while exact-support harmonic results remain systematics diagnostics. A real G3 joint estimator covariance is now computed (monopole the only |z|>3 mode); training, complete covariance, archive, exact re-review, and human gates remain; readiness holds 80.",
    path: publicationPath({}),
    pages: "27",
    refs: "18",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. New Sec 4.5 'Joint Estimator Covariance' + Table 9 present a COMPUTED G3 result: N=2000 shared block bootstrap over NSIDE=8 superpixels on the canonical 949,584-row HC sample (immutable HF snapshot cc326f74) gives correlations real-space<->WLS +0.277, real-space<->monopole -0.037, WLS<->monopole -0.093 (z=+2.21/+1.36/-6.57) — the monopole is the ONLY |z|>3 mode and is nearly uncorrelated with both dipole estimators, quantitatively supporting separate-systematic treatment. Six caveat sites are narrowed from 'no joint covariance' to 'computed 3x3 block; MASTER-decoupled leg + full joint likelihood remain open.' No science number changed; the primary remains null-consistent and harmonic results remain systematics diagnostics only. Training replay, the MASTER-decoupled/full-likelihood covariance legs, complete metadata, a DOI-backed archive, exact v1.0.264 confirmation, and human review remain open.",
    keyResults: [
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.264 confirmation board (reviews the new Sec 4.5 G3 joint estimator covariance computed 2026-07-17) before any DOI publication",
      "Prove the exact training split/seed/realization (G1 pipeline smoke test + manifest-retained retrain, A4000 pod); extend the computed 3x3 joint covariance to the MASTER-decoupled leg and full joint likelihood; run the G4 monopole-mechanism injection (H200, after G1)",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-004",
    pdfMeta: "PDF · 27 pp · v1.0.264 · md5 e6b4749337ecaccca9bf499ce7af093a — computes the G3 joint estimator covariance (Sec 4.5, Table 9; monopole the only |z|>3 mode, nearly uncorrelated with both dipole estimators); MASTER-decoupled leg + full joint likelihood remain open. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.264.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.264.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
