...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 25 pp · v1.0.200 · updated Jun 30, 2026 · md5 a644743f · 33 MB",
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.200.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.200.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
