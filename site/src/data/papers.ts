...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 11 pp · v1.7.125 · updated Jul 17, 2026 · md5 174d52d55719c5955f852d2365fdb9c8 — G3 REAL COMPUTE CLOSURE: new Eq. 5 model-specific Einstein-Cartan four-fermion torsion bound on assumption (f) (prefactor 0.022-0.21 within EFT validity, <<1e-3 for sub-Planckian abundances), anchored to the P1A convention-audited contact term (0.1% benchmark reproduction). Exact v1.7.125 confirmation board pending; no DOI, submission, or journal acceptance is claimed.",
    changelog: [
      "G3 model-specific torsion bound (v1.7.125): new Eq. 5 + bounded-disclosure paragraph converts assumption (f) (fermion-sourced torsion negligible) from asserted to bounded — |δf_NL^tor| ≲ (35/16)(3/16)[γ²/(1+γ²)] κ n_ψ,c²/ρ_c, sympy Einstein-Cartan four-fermion estimate anchored verbatim to the companion P1A's convention-audited axial contact term (benchmark reproduced to 0.1%). n_ψ,c carried as an explicit symbolic model parameter, never fixed. No headline number changed, −35/16 unchanged, nothing fabricated. Artifacts: research/cubic_bounce_transmission/g3_torsion_fourfermion_bound.{py,json}.",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.125.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.125.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      ...
      "Run and truth-audit the exact v1.0.267 confirmation board (reviews the G1 manifest-retained retrain + G2 training-disjoint validation closures computed 2026-07-17) before any DOI publication",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.267.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.267.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
