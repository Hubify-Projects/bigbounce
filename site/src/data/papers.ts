...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3M.0.6",
    lastUpdated: "2026-09-02",
    tldr: "Track A's flagship submission candidate: folds the A3 multi-channel skeleton (NANOGrav 15-yr free-spectrum \u03b3, PBH abundance, SPHEREx/MegaMapper reach) together with the P2\u2032 v2L.0.2 exact matter-contraction theory (f_NL = \u221235/16, ledger #1 CLOSED independent re-derivation, orientation-dependent squeezed limit, \u03b4N cross-check) per the 2026-09-02 lineage decision. v3M.0.6: final-review REVISE executed (abstract cut to 307 words); injection on real NANOGrav KDE grids in progress (v3M.0.7 pending). Readiness 70.",
    path: publicationPath({}),
    pages: "9",
    refs: "\u2014",
    readiness: 70,
    ...
    remainingWork: [
      "v3M.0.6: final-review REVISE executed (abstract 307 words); injection on real NANOGrav KDE grids in progress (v3M.0.7 pending). Readiness 70.",
    ...
    pdfMeta: "PDF \u00b7 9 pp \u00b7 v3M.0.6 \u00b7 created Sep 2, 2026 \u00b7 md5 3888085edc5c493fcd2a45c8c386576d \u2014 final-review REVISE executed (abstract 307 words); injection on real NANOGrav KDE grids in progress (v3M.0.7 pending). Readiness 70.",
    changelog: [
      "v3M.0.6: final-review REVISE executed \u2014 abstract cut to PRD length (450\u2192307 words, no claim/qualifier dropped); injection on real NANOGrav KDE grids in progress (real KDE pack not found in local/HF/B2 stores, re-download from Zenodo 10.5281/zenodo.8060824 pending, v3M.0.7). Readiness 70.",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.6.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.6.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
