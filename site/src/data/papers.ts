...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3M.0.31",
    lastUpdated: "2026-09-22",
    tldr: "D-A3-15: the PBH Channel-II headline required-amplitude ratio is re-scoped from 1.84+-0.03 (n=144, all in-coverage points) to 1.81+-0.02 (n=62, the subset perturbatively controlled at both candidate values), closing R12's last open ESSENTIAL item (DA3M-R12-06) BY COMPUTATION rather than disclosure. The per-point diagnostic 1.2|f_NL|sigma_r was re-integrated from the compaction script's own variance integral at each of the 144 headline points' own required amplitude (5 validation gates, 3 exact to machine zero). Table V's caption also corrected an inverted non-perturbative-branch label: measured pointwise, the diagnostic rises with gamma_cr, so the headline window is the more controlled of the two. Reported with equal prominence against the paper: no point of the 144 reaches eps<=0.5 (marginal throughout); the ratio is threshold-conditional (Pearson +0.83 with the diagnostic). Channel II's scientific conclusion is unchanged: still 7.0 dex short, f_PBH=0, a NULL. No review board run this bundle; one confirmation board on the exact v3M.0.31 PDF is now authorized under directive R2 but not spent.",
    path: publicationPath({}),
    pages: "24",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 24 pp \u00b7 v3M.0.31 \u00b7 created Sep 22, 2026 \u00b7 md5 d669a73cd1ec8e330e212963a5930c89 \u2014 D-A3-15: the PBH Channel-II headline is re-scoped 1.84\u00b10.03 (n=144) \u2192 1.81\u00b10.02 (n=62) by the pointwise perturbativity computation, closing DA3M-R12-06 [ESSENTIAL] by computation. Table V's non-perturbative-branch label corrected (inverted pointwise). Channel II's null conclusion unchanged. No board run this bundle; readiness 75 COMPUTED, one confirmation board now authorized under directive R2 but not spent.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.31.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.31.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
