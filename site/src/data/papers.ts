...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "R11 INT board (Grok REJECT, Gemini MAJOR REVISIONS, Claude opus verdict-blind referee MAJOR REVISIONS) ran on the exact v3M.0.27 PDF -- the one board directive R2 permitted after the row-9 (D-A3-9) Bardeen-potential science decision. Truth-audit found 16 genuinely-new-real finding-classes: a recurrence of the internal-audit-language leak (directive Q1), two ESSENTIAL items on the new Bardeen material (its regularity claim was asserted not derived, and f_NL^after[S2]=-1.25 was quoted to 3 sig figs with an undisclosed evaluation-window convention -- both closed using material already in the cited artifact, no new derivation), five MAJOR scheme-labelling/reasoning defects, and a minor cluster (incl. a leaked internal figure-title label, regenerated). No physics error found; no headline number changed. Directive R2 budget spent again -- rounds stopped.",
    path: publicationPath({}),
    pages: "21",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 21 pp \u00b7 v3M.0.28 \u00b7 created Sep 22, 2026 \u00b7 md5 e4a2ca93564bc566a52e68252865c460 \u2014 R11 INT board closure: 16 genuinely-new-real finding-classes closed, incl. two ESSENTIAL items on the row-9 Bardeen material (regularity proof, evaluation-window convention) and a recurrence of the internal-audit-language leak. No physics error found; no headline number changed. Readiness 75 COMPUTED \u2014 rounds STOPPED under directive R2 (R11 budget spent).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.28.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.28.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
