...
export const papers: Paper[] = [
  {
    ...
    pdfMeta: "PDF · 8 pp · v1A.0.126 · updated Jul 22, 2026 · md5 6ade40c14049a316eabf21e67dc10072 — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. Archival deposit PUBLISHED (Houston go): DOI 10.5281/zenodo.21481838 (CC-BY-4.0) embedded in the availability paragraph; exact v1A.0.124 board previously truth-audited to 0 genuinely-new-real, P1A CONVERGED to human gates. Readiness cap 62 HOLDS.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.126.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.126.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "Software metapaper · 6 pp · v2B.0.14 · package 0.1.7 · 41 tests · md5 3f5c161224d1cf62a6a467fe34f5ba09 · 2026-07-22 confirmation wave: all genuinely-new-real closures landed. BOTH archival DOIs published (Houston go) and embedded: software 10.5281/zenodo.21481753 + manuscript deposit 10.5281/zenodo.21481842 (CC-BY-4.0) — the boards' persistent-identifier major is fully closed · readiness holds 56 pending human gates",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1b_namaster_proof_v2B.0.14.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1b_namaster_proof_v2B.0.14.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 11 pp · v1.7.127 · updated Jul 22, 2026 · md5 881cbc062656849beee4609996ae2351 — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. DOI BACK-PATCH: embeds the minted Zenodo archival DOI 10.5281/zenodo.21461881 (concept 21461880) in the Data and Code Availability section, closing the archive/DOI Houston-gate. The record archives the exact bytes of the reviewed v1.7.125 release (md5 174d52d55719c5955f852d2365fdb9c8); no science number changed, −35/16 UNCHANGED. Readiness cap 80 HOLDS (no uplift claimed).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/02_full_draft_v1.7.127.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/02_full_draft_v1.7.127.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r12 · updated Jul 22, 2026 · md5 37fdd322f06be11d8384ff505114afa8 — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. DOI BACK-PATCH: embeds the minted Zenodo archival DOI 10.5281/zenodo.21461888 (concept 21461887) in the Data Availability section, closing the archival-DOI Houston-gate; the distinct AAS journal digital-asset DOI stays honestly open. The record archives the exact bytes of the reviewed v3.2.0-r10 release (md5 9fb6e882068a4613132792633a9d7a60). Readiness cap 56 HOLDS (no uplift claimed).",
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_apjs_v3.2.0-r12.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_apjs_v3.2.0-r12.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 32 pp · v1.0.270 · md5 904414a10de8ddba9f7aca99be3f6fb1 — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. DOI BACK-PATCH: embeds the minted Zenodo archival DOI 10.5281/zenodo.21461899 (concept 21461898) in the abstract, Data Availability paragraph, and catalog itemize, closing the DOI Houston-gate; the complete systematics-metadata sidecar stays honestly open. The record archives the exact bytes of the reviewed v1.0.268 release (md5 4e139b56b0718c70b73ae7295e4ee7b1). Readiness holds 80 (no uplift claimed).",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.270.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.270.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 42 pp · v0.1.142-2026-07-22 · md5 a70307b01058d3688bc69758847d414f — 2026-07-22 confirmation wave: all genuinely-new-real closures landed. Prior semi-analytic forward-leakage injection closure (78–88% of large raw deviations reproduced from committed leakage components, every residual non-significant); release, exact re-review, editorial, and human AJ gates remain. Readiness holds 74.",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.142-2026-07-22.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.142-2026-07-22.pdf", kind: "secondary", download: true },
      {
