...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v0.1.23-2026-05-23",
    tldr: "v0.1.23 (cron fire #64): closed 4 MAJORs from internal Claude methodology review (0 BLOCKER / 4 MAJOR / 4 minor / 4 nit) per feedback_take_critiques_seriously. (1) Bonferroni arithmetic — K=5 α=0.01 was 2.81 → corrected to 3.09; K=4 α=0.01 was 3.29 → corrected to 3.02; Tempel σ=2.54 reframed as 'just crosses 2.498 by 0.04σ but well below empirical max-stat null'. (2) 791,635 vs 812,793 row reconciliation — added explanatory clause that 21,158-row excess is CW/CCW spirals with env labels that didn't make the high-confidence headline cut. (3) 'Five independent' → 'five complementary' with explicit qualifier on VoidFinder reuse + ZOBOV-axis independence. (4) Bright-vs-dark sign-flip joint z-test |z|≈3.4σ on both cluster + filament added to abstract + §sec:results_within_class_density. PDF 905KB / 0 overfull / 0 undef.",
    blockingItems: [
