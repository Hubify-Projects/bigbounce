...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Merges P1A and P1C into a single gr-qc/CQG paper. The derived axial spin-spin contact term is identified with Popławski's torsion-bounce repulsion mechanism (the positive result) while the same algebraic elimination closes four candidate dark-energy routes (the negative result). R2 board closed (23/23 findings, incl. two errors inherited from P1C: 8π coefficient, O5 parity) — v1N.0.3. R3 verification pass dispatched, verdicts pending.",
    path: publicationPath({}),
    pages: "10",
    refs: "—",
    readiness: 35,
    statusVariant: "amber",
    target: "Classical and Quantum Gravity — Paper (grown from Note form, 7725 words / 10 pp, above the CQG Note ceiling)",
    description:
    ...
    remainingWork: [
      "R2 board closed (Claude major-revisions, Grok reject, Gemini major-revisions) — 23/23 findings closed this round, including two errors inherited from P1C (8π coefficient, O5 parity) — v1N.0.3; R3 verification pass dispatched, verdicts pending",
      "Convex paperVersions:bump / activityFeed:add registration (this session)",
      "Page target: audit recommended 12-16pp; this closure reached 10pp/7725 words (+86% by word count) — short of the upper recommendation, flagged as a residual open item",
    ...
    pdfMeta: "PDF · 11 pp · v1N.0.3 · created Sep 2, 2026 · md5 8725f40c69027c53c7a0f6a38f05587d — R2 closure (23/23 findings closed, incl. two errors inherited from P1C: 8π coefficient, O5 parity), 2026-09-02. R3 verification pass dispatched, verdicts pending.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1bc_ech_note_v1N.0.3.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1bc_ech_note_v1N.0.3.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    remainingWork: [
      "R2 board closed (Claude major-revisions, Grok reject, Gemini major-revisions) — 21/21 findings closed this round (monopole disclosed; genuine 95% CL limit ≈0.75% by Neyman inversion) — v4P.0.3; R3 verification pass dispatched, verdicts pending",
      "Convex paperVersions:bump / activityFeed:add registration (this session)",
    ...
    pdfMeta: "PDF · 11 pp · v4P.0.3 · created Sep 2, 2026 · md5 cb7429779c820f03daf125a49b395ec5 — R2 closure (21/21 findings closed; monopole disclosed; genuine 95% CL limit ≈0.75% by Neyman inversion), 2026-09-02. R3 verification pass dispatched, verdicts pending.",
    changelog: [
      "v4P.0.3: R2 closure — 21/21 findings closed; monopole disclosed; genuine 95% CL limit ≈0.75% by Neyman inversion. R2 verdicts: Claude major-revisions, Grok reject, Gemini major-revisions. R3 verification pass dispatched, verdicts pending.",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper4prime_chirality_test_v4P.0.3.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper4prime_chirality_test_v4P.0.3.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
