...
export const papers: Paper[] = [
  {
    ...
    description: "The foundational paper. Wave 11 reframed the abstract — drops 'evidence for ECH' framing and tightens the Bayes-factor scope to the ΛCDM+ΔN_eff proxy only (closes R42 cross-model BLOCKERs P1-CM-B1 + P1-CM-B3 + P1-CM-M2 + P1-OA-B2). Documents 14 ECH structural barriers, the perturbation-transparency theorem, the ALP birefringence prediction (β = 0.27°), the f_NL = -35/8 benchmark, and the bounce-inflation discrimination landscape.",
    keyResults: [
    ...
    pdfMeta: "PDF 1.23 MB · 31 pp · May 1, 2026",
    artifacts: [
      { label: "Read PDF", href: "/arxiv_v2/main.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/arxiv_v2/main.pdf", kind: "secondary", download: true },
      { label: "LaTeX source", href: "/arxiv_v2/main.tex", kind: "secondary", download: true },
  ...
  },
  {
    ...
    statusVariant: "green",
    target: "ApJS",
    description: "The catalog paper. Wave 11 retitled to 378,280 anomalies / 37.3M sources, made the ACT-DR6 quarantine explicit, and resolved the §VI validation-vs-product mismatch (closes P3-CM-B1 + P3-OA-B2 + P3-CM-M3 + P3-OA-B6). Documents the first multi-survey AI anomaly sweep across 7 non-quarantined astronomical archives.",
    keyResults: [
    ...
    pdfMeta: "PDF 28.27 MB · 35 pp · May 1, 2026",
    artifacts: [
  ...
  },
  {
    ...
    statusVariant: "green",
    target: "MNRAS",
    description: "The chirality catalog paper. Presents the largest bias-audited galaxy handedness catalog (8.47M galaxies, 40× prior work). Wave 12 (2026-05-01) tightened the hemisphere look-elsewhere null on H200 GPU at N_MC = 10,000 to p_LEE = 9.999×10⁻⁵ — an order of magnitude tighter than Wave 11-G's 1/501 floor — closing the P4-CM-B2 + P4-CM-m2 + P4-OA-M8 hemi-LEE skeptic-channel triplet. Wave 11 also recomputed the NaMaster shot-noise floor with the corrected N_spiral = 3,321,795 denominator (cross-confirmed P4-CM-B1 + P4-OA-M7).",
    keyResults: [
    ...
    pdfMeta: "PDF 25.78 MB · 16 pp · May 1, 2026",
    artifacts: [
