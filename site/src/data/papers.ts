...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "v1B.0.111 completes the corrected physical CAMB 500-MC NaMaster production and eight-configuration robustness suite. All machine-verifiable P1B science contracts and the 230-artifact version-matched manifest pass. Exact re-review and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    description: "Standalone technical verification companion to Paper 1A. It documents a 309,189-sample Cobaya ΛCDM+ΔN_eff proxy analysis, an ALP prior-predictive diagnostic, and a corrected 500-realization NaMaster recovery suite using pinned CAMB 1.6.6 raw lensed EE/BB spectra. The canonical and seven robustness configurations recover their injected rotations at the 0.001° grid precision. These are pipeline checks, not evidence, posterior probabilities, or a sky detection.",
    keyResults: [
      ...
      "Physical CAMB 1.6.6 NaMaster production: 500 realizations per row, seeds 42–541; canonical +0.270° recovery has zero grid-resolved bias, per-realization scatter 0.01282°, and MC-mean SE 0.000573°",
      "Seven robustness controls (negative sign, f_sky 0.85/0.65, apodization 0.5°/3.0°, |lat|>30°, and B purification) recover the injected angle with zero bias at 0.001° precision",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation board on v1B.0.111 and truth-audit every finding",
      "Human review, immutable archive/DOI, venue disposition, and submission metadata remain open",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "Standalone companion · 20 pp · v1B.0.111 · sha256 defc8cafd0f71688838fd9bae8ee7a5f9e9d11b94f01a58b2787007bb5139533 · physical 500-MC NaMaster suite and 230-artifact manifest pass; exact re-review pending; readiness holds 56",
    artifacts: [
