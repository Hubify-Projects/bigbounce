...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.246",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). v1.0.246 closes bounded v1.0.245 board defects, but public release, exact training realization, and spatial covariance remain major gates. Readiness holds 80.",
    path: publicationPath({}),
    pages: "27",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with rotational-equivariance correction. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. v1.0.246 corrects the sample accounting and confusion-transfer disclosure, but submission remains blocked until the exact release payloads are public, the training realization is proven, and spatial covariance is propagated or bounded.",
    keyResults: [
    ...
    remainingWork: [
      "Obtain an exact v1.0.246 confirmation board after the remaining release/provenance/calibration gates are closed; v1.0.245 was MAJOR/MINOR/MINOR",
      ...
      "Prove the exact training split/seed/realization; propagate spatially varying confusion with covariance and rerun the GZ1 check on the supported sample",
      "Author arXiv endorsement and journal-submission decision",
    ],
    preprintId: "HUBIFY-2026-004",
    pdfMeta: "PDF · 27 pp · v1.0.246 · updated Jul 15, 2026 · sha256 0c3fd842 — bounded truth-audit closure after the v1.0.245 MAJOR/MINOR/MINOR board; release/provenance/spatial-covariance majors remain; readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.246.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.246.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
