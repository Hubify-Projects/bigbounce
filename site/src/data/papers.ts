...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF \u00b7 13 pp \u00b7 v3M.0.10 \u00b7 created Sep 4, 2026 \u00b7 md5 d3981d8b5ed2cbf6b02bd771f784ee1c \u2014 R4 verification closure + PTA channel restated as a null (gamma_pred 5.07, Omega_GW 14.3 dex below NANOGrav); rounds stopped under R2. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.10.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.10.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
