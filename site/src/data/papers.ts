...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.4. v2B.0.5 closes three truth-audited exact-board minors: strict JSON rejects non-finite constants, compatibility-helper edits trigger CI, and the synthetic mask documentation matches its native coordinate frame. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.5",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.5 · package 0.1.4 · 28 tests · sha256 f9dcbd7e76da764d2cea6cc018a3fb3d6a3ed770f4ba048860c294d20eeee6ee · strict JSON + complete compatibility CI triggers · visual audit passed · exact confirmation pending · readiness holds 56",
    artifacts: [
