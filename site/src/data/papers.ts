...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v3.2.0-r16",
    lastUpdated: "2026-08-03",
    tldr: "Recovers 181 public DESI DR1 TARGETIDs from a frozen historical anomaly list, split transparently into 170 high-coordinate-consistency core associations and 11 lower-confidence positional associations. v3.2.0-r16 closes one descriptive comparison wording minor from the r15 final-hash Gemini leg; no metric, scientific claim, or readiness value changed. This is an archive-recovery product, not a detection claim.",
    path: publicationPath({}),
    pages: "17",
    refs: "12",
    readiness: 95,
    ...
    remainingWork: [
      "Run bounded confirmation against the exact v3.2.0-r16 PDF; r15's one Gemini wording minor is closed, with no science or readiness change",
    ...
    pdfMeta: "PDF · 17 pp · v3.2.0-r16 · updated Aug 3, 2026 · md5 c57ee558b8c1e49dcdb784febcd0eca3 · sha256 22c76260da4da37d073fe78fcedc993fbaf7e56daca9a29a52a6b39226226c5f — closes one descriptive comparison wording minor from r15 final-hash Gemini. No metric, scientific claim, or readiness value changed; exact r16 confirmation remains pending.",
    artifacts: [
