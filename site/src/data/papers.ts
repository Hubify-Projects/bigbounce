...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is a focused software metapaper around namaster-proof 0.1.5. v2B.0.7 closes a reviewer-found public input-contract defect: fractional harmonic limits now fail instead of being silently truncated. Archive, confirmation, and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "35 automated tests across Linux Python 3.10–3.13 plus Windows 3.12, including strict integer harmonic inputs, non-finite JSON, and verifier/publisher concurrency regressions",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.7",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.7 · package 0.1.5 · 35 tests · sha256 77a79089a6ab959e313639ef5cb48873cc5e1d507d2b4ec645338c38918f9582 · strict integer multipole contract · visual audit passed · exact confirmation pending · readiness holds 56",
    artifacts: [
