...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.254",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). The audited v1.0.254 PDF binds a zero-violation Catalog C semantic scan and honestly marks Catalog B historical/unreleased; exact review plus training, covariance, DOI, and human gates remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    description: "The galaxy chirality catalog: 8.47M galaxies classified CW/CCW by a ViT-Small ensemble with flip-equivariant TTA. The primary HC real-space statistic is consistent with isotropy under fixed-occupancy galaxy-label randomization (z=0.7053, one-sided rank p=0.22468); pixel permutation is robustness only. The audited v1.0.254 PDF records byte-verified dataset/model contracts, a Catalog C semantic scan of all 8,474,531 rows with zero violations, and the honest historical/unreleased status of Catalog B. Training replay, spatial covariance, complete systematics metadata, a DOI-backed archive, exact v1.0.254 review, and human review remain open.",
    keyResults: [
      ...
      "Release-contract closure: HF dataset revision 85232df7 publishes the Catalog C semantic contract and current dataset card; HF model revision 3b2db93e publishes the corrected current model card",
      "Catalog C semantic validation streams all 8,474,531 rows with zero contract violations; Catalog B is historical and unreleased, not represented as a reproducible public product",
    ...
    remainingWork: [
      ...
      "Rebuild and verify the reversible deposit draft against the audited exact v1.0.254 PDF before any DOI publication",
    ...
    pdfMeta: "PDF · 29 pp · v1.0.254 · sha256 d8d4896d · md5 3a4bb461 — source-to-claim audit passes; exact review pending. Readiness holds 80.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.254.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.254.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
