...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "P1B is now a focused software metapaper around namaster-proof 0.1.1. v2B.0.2 adds a real-PyMaster benchmark: exact recovery 0.250°, effective-ℓ shortcut 0.315°, operator agreement 6.78×10⁻²¹. Archive and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "5",
    refs: "4",
    readiness: 56,
    ...
    keyResults: [
      ...
      "24 automated tests across Python 3.10–3.13, including fail-closed spectrum-support, weight-shape, sign, and finite-input regressions",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation review of v2B.0.2",
    ...
    pdfMeta: "Software metapaper · 5 pp · v2B.0.2 · package 0.1.1 · 24 tests · sha256 18b97ac5ffc48d03a60d84822b74562ccd10202430a13054ef2dabf3f267d46c · real-PyMaster benchmark added · confirmation pending · readiness holds 56",
    artifacts: [
