...
export const papers: Paper[] = [
  {
    ...
    keyResults: [
      ...
      "R26conf: App C derivation verified step-by-step clean; Cartan factor-2 normalization inconsistency disclosed (single-convention re-derivation queued, analytic); dimensionally inconsistent thermal clause removed (v1A.0.55)",
    ],
    ...
    remainingWork: [
      "Cartan factor-2 single-convention re-derivation (analytic, queued) + R27conf cross-vendor round on v1A.0.55",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper1a_ech_nogo_v1A.0.55.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper1a_ech_nogo_v1A.0.55.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    keyResults: [
      ...
      "R26conf: zero arithmetic errors across the round; 12 textual closures — cluster accounting made exact from the dedup artifact, NANOGrav Eq. E1 claim falsified by rederivation (v3.1.86)",
    ],
    ...
    remainingWork: [
      "1 ESS queued (tabular feature-scaling spec recovery, pod-side) + 2 MAJOR recomputes → R27conf cross-vendor round must come back clean on v3.1.86",
      "Houston external review round + personal sign-off (final 1%, gated)",
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/paper3_anomaly_catalog_v3.1.86.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/paper3_anomaly_catalog_v3.1.86.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
