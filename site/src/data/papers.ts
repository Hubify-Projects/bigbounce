...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v1.0.257",
    lastUpdated: "2026-07-15",
    tldr: "Classifies 8.47M galaxies and finds a null HC observed-label dipole under fixed-occupancy label randomization (z=0.7053, p=0.22468). The exact v1.0.257 board verified an FSC support mismatch and an unsafe-row exact-null rerun gate; training, covariance, archive, editorial, re-review, and human gates also remain. Readiness holds 80.",
    path: publicationPath({}),
    pages: "29",
    refs: "46",
    readiness: 80,
    ...
    pdfMeta: "PDF · 29 pp · v1.0.257 · sha256 726acd8b · md5 1fc1140e — exact board Gemini MINOR / Codex-subscription MAJOR / Grok failed 503. FSC support and unsafe-row exact-null compute gates remain; readiness holds 80.",
    changelog: [
  ...
  },
  {
    ...
    keyResults: [
      ...
      "The exact v0.1.136 board requires explicit program-by-environment interaction/leakage analysis and like-for-like K=13 clustering robustness across angular and 3-D or multiway schemes",
    ...
    pdfMeta: "PDF · 40 pp · v0.1.136-2026-07-15 · sha256 cd3c8e81 · md5 501740e8 — exact board Gemini MAJOR / Codex-subscription MAJOR / Grok failed 503. Interaction, K13 robustness, release arrays/archive, structural editing, re-review, and human AJ gates remain; readiness holds 74.",
    artifacts: [
