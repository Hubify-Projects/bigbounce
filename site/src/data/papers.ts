...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "Track A's flagship submission candidate: folds the A3 multi-channel skeleton (NANOGrav 15-yr free-spectrum \u03b3, PBH abundance, SPHEREx/MegaMapper reach) together with the P2\u2032 v2L.0.2 exact matter-contraction theory (f_NL = \u221235/16, ledger #1 CLOSED independent re-derivation, orientation-dependent squeezed limit, \u03b4N cross-check) per the 2026-09-02 lineage decision. v3M.0.11: science decision D-A3-9 (ledger row 9) integrated \u2014 the transmitted amplitude is now a two-scheme band, f_NL^after \u2208 [\u22121.25, \u22120.50] (S1 geometric vs. S2 fluid MS variable, S2 finite on the raw ADM Lagrangian). Readiness 75.",
    path: publicationPath({}),
    pages: "14",
    refs: "\u2014",
    readiness: 75,
    ...
    pdfMeta: "PDF \u00b7 14 pp \u00b7 v3M.0.11 \u00b7 created Sep 4, 2026 \u00b7 md5 56ca90f1202595c8b7ee2f91932b3c65 \u2014 science decision D-A3-9 (ledger row 9): transmitted amplitude restated as a two-scheme band f_NL^after in [-1.25,-0.50]; S2 resolved finite on the raw ADM Lagrangian. Readiness 75.",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.11.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/a3_multichannel_arxiv_v3M.0.11.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
