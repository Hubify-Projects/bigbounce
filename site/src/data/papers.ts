...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    version: "v0.1.22-2026-05-23",
    tldr: "v0.1.22 (cron fire #62): **6th independent positive evidence line landed** — P4-monopole-residual analysis. Subtract the P5 matched-spiral catalog monopole (f_CW=0.4972, σ=−5.07 — the P4 catalog-wide 9.5σ monopole propagated into spectro-confirmed subsample): ALL 4 V-Web classes fall within |σ_vs_monopole|<1.15 (void −0.56, wall +1.01, filament +0.99, cluster −1.11). The prior −4.66σ cluster and −2.61σ filament were ENTIRELY the catalog-wide classifier-bias monopole projected onto the V-Web class subsamples. Per-pixel residual distribution NSIDE=32 (n=1,821): mean=+0.020, std=1.184, skew=+0.044 — consistent with pure shot-noise around the monopole. Cleanest single-test demonstration that V-Web class deviations are not environmental. PDF 904KB / 29pp / 0 overfull / 0 undef.",
    blockingItems: [
