...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    tldr: "v1B.0.112 truth-audits the exact v1B.0.111 board and closes three real defects: executed PRIMAT BBN provenance, NaMaster estimator semantics, and the cosine-flat angular-prior median. Regression gates, PDF QA, retention, mirrors, and Convex pass. Confirmation and human review remain open; readiness holds 56.",
    path: publicationPath({}),
    pages: "20",
    refs: "32",
    readiness: 56,
    ...
    keyResults: [
      ...
      "Physical CAMB 1.6.6 NaMaster production: the canonical mean-bandpower fit is +0.270°; the mean of 500 realization-level fits is 0.269914° (bias −0.000086° ± 0.000573° SE; scatter 0.01282°)",
    ...
    remainingWork: [
      "Run an exact-PDF non-Anthropic confirmation board on v1B.0.112 and truth-audit every finding",
      "Human review, immutable archive/DOI, venue disposition, and submission metadata remain open",
    ],
    preprintId: "HUBIFY-2026-001B",
    pdfMeta: "Standalone companion · 20 pp · v1B.0.112 · sha256 d420a7f5be48f1fa5f9fc1b2cf57206708881ffe29c782ea6cdf4d65eb20331c · v1B.0.111 exact-board defects closed with regression gates; confirmation pending; readiness holds 56",
    artifacts: [
