...
export const researchPrograms: ResearchProgram[] = [
  {
    ...
    supportingLinks: [
      ...
      },
      {
        ...
        description:
          "A systematic survey of 7 foundation mechanism classes and 6 observational branches, extracted from the retired P1U barrier catalog, collapsing to 13 distinct mechanism-class constraints across 14 catalog entries and closing four candidate dark-energy routes (R1-R4). Draft v1C.0.7, compiled 18 pp, 0 undefined refs, 0 overfull boxes — closes the R4 confirmation board on the exact v1C.0.6 PDF (Claude INT minor-revisions 0 MAJOR/8 MINOR, Grok REJECT, Gemini ACCEPT WITH MINOR CORRECTIONS — the board's first ACCEPT; Perplexity leg failed): 10 genuinely-new items closed, all wording/attribution/provenance-grade — Table II R3 row re-attributed (chiral-count ansatz bound is DKS-motivated, the Benedetti-Speziale flow is the separate derived estimate), Sec V.a tier wording aligned with Table II's (II)+(III) records, the R1 benchmark's 3.6e-69 vs 3.9e-69 mantissa adjudicated as a rho_Lambda-normalization difference and both stated ((2.3 meV)^4 companion vs (2.25 meV)^4 App-A input, ~68 orders either way), Fig 1 arrows now labeled per-barrier (B8/B14), branch-letter gaps (I, K never assigned) disclosed, the Zenodo-deposit vs Aug-5-adjudication-artifact provenance boundary stated explicitly (Gemini's MAJOR), version-history parenthetical moved to a footnote, App C audit tag relocated to Data & Code, and acknowledgments rephrased to builds-on-published-work form. ST/BS coefficient transcriptions re-verified against arXiv:1402.4854 and arXiv:1111.0884 (all exact). DRAFT: R4 found genuinely-new items, so an R5 confirmation board is required; no readiness score has been computed and no venue/Zenodo kit exists yet.",
        href: "/papers/paper1c_nogo_survey_v1C.0.7.pdf",
        external: true,
      },
    ],
