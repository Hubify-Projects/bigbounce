...
export const papers: Paper[] = [
  ...
  },
  {
    ...
    pdfMeta: "PDF · 34 pp · v1.0.229 · updated Jul 9, 2026 · md5 1c394928 · 34 MB",
    changelog: [
    ...
    artifacts: [
      { label: "Read PDF", href: "/papers/chirality_catalog_paper_v1.0.229.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/chirality_catalog_paper_v1.0.229.pdf", kind: "secondary", download: true },
      {
        label: "LaTeX source",
  ...
  },
  {
    ...
    pdfMeta: "PDF · 43 pp · v0.1.112 · updated Jul 9, 2026 · md5 2474dcff — DESIVAST dual-primary reconciliation + three companion closures (no verified number changed, nothing fabricated). The abstract now leads with the single footprint-restricted primary estimand (Δf_CW = +0.0018) and demotes the unrestricted contrast (+0.0007) to a secondary sensitivity check; a 'footprint ≠ selection function' distinction is added at the primary designation (the angular-disc footprint is a geometric construction, not the published DESIVAST/BGS completeness mask); the ≈0.9pp systematic envelope is justified with the explicit quadrature term-sum (√(0.44²+0.37²+0.60²+0.37²+0.11²+0.24²+0.02²)=0.94pp); and the simultaneous Bonferroni-5 bound across all five void estimators is computed (widest per-test 99%-level CI ⇒ no void definition admits |Δf_CW|≳1.1pp at family-wise 95%).",
    artifacts: [
      { label: "Read PDF", href: "/papers/p5_desi_chirality_v0.1.112-2026-07-09.pdf", kind: "primary", external: true },
      { label: "Download PDF", href: "/papers/p5_desi_chirality_v0.1.112-2026-07-09.pdf", kind: "secondary", download: true },
      {
