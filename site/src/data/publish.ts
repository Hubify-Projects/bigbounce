  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.22), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.22: S9b derivation-statement correction -- the intrinsic flat-slice term vanishes in the growing-mode limit that defines -55/16, so it does not close the gap to -5/2 (residual 5(6-eps)/24, now attributed to the super-Hubble evolution step between slices, open item); only the comoving-slice δN (-5) is fully reconciled and the flagship -35/16 is unaffected. ROUNDS STOPPED (R2). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.22 — S9b derivation-statement correction: intrinsic flat-slice term vanishes in the growing-mode limit, does not close the -55/16 gap; residual open item in the super-Hubble evolution step. ROUNDS STOPPED (R2). Was: v3M.0.21 — literature/derivation correction naming the intrinsic term", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
