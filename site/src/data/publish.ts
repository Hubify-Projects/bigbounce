  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.7), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.7: real-KDE injection validation closed (Zenodo 8060824, γ=13/3 mean pull +0.016σ, γ=3 control mean pull +0.033σ). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
