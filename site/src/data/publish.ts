  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.12), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.12: R5 truth-audit closure C1-C7 (S1/S2 transfer-bound scoped, NANOGrav Omega_GW h^2 corrected, Fig. 1 regenerated) plus DA3M-R5-15 (first-order tensor null) and DA3M-R5-18 (gamma_cr grid coverage). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.12 — R5 closure C1-C7 + DA3M-R5-15/18 integrated: S1/S2 transfer bound scoped, NANOGrav Omega_GW corrected, Fig. 1 regenerated, first-order tensor null + gamma_cr coverage inserted; one verification round remains under R2. Was: v3M.0.11 — D-A3-9 (row 9) two-scheme band integrated", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
