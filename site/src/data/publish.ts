...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      ...
      { name: "Early-universe anomaly map", role: "Discovery paper (Track C2)", status: "Data-release + taxonomy manuscript skeleton vAF.0.1 assembled 2026-09-18: defended sample, 16-item validation contract (13 pass, 2 disclosed defects), 8-family/25-cluster evidence table, 32 named follow-up targets; no INT/EXT review board run yet", destination: "Venue chosen after a bounce-vs-inflation discriminator is earned per candidate channel", dependency: "INT/EXT review board on the vAF.0.1 draft", nextGate: "Run the first review round on the manuscript skeleton", href: "https://github.com/Hubify-Projects/bigbounce/blob/main/pipelines/p1_highz_tracers/anomaly_flagship_draft", external: true },
