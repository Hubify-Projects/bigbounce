  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.15), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.15: D-A3-10/11 science reframe -- r=16ε=24 exactly (~670× above BICEP/Keck) and a joint (r, f_NL) no-go excluding single-field matter bounces (windows disjoint 296× in c_s, strengthening Li+2016 3.8×); curvaton route named (r, n_s)-viable; PBH sign disagreement resolved (ratio 1.84±0.03). One verification board permitted (R7) under directive R2. A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.15 — D-A3-10/11 science reframe: joint (r, f_NL) no-go for single-field matter bounces (r=16ε=24, windows disjoint 296× in c_s), curvaton route named viable, PBH sign resolved (ratio 1.84±0.03). One verification board permitted (R7) under R2. Was: v3M.0.14 — R6 closure", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
