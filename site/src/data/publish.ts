  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.20), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.19: D-A3-14 (ledger row 19) -- the joint (r, f_NL) no-go generalizes to the full P(X) k-essence class: r and the bounce's own cubic term are exactly independent of the cubic-action coefficient lambda, so no lambda opens the window; the DBI best case gives r_min=12.57 (349× BICEP/Keck). ROUNDS STOPPED (R2). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.20 — D-A3-14 (row 19): no-go generalized to the full P(X) class, r and the bounce cubic term exactly lambda-independent, DBI best case r_min=12.57 (349× BICEP/Keck). ROUNDS STOPPED (R2). Was: v3M.0.18 — D-A3-13 scope statement", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
