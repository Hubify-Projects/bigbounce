...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.6 — final-review REVISE executed (abstract 307 words); injection on real NANOGrav KDE grids in progress (v3M.0.7 pending)", destination: "Physical Review D (regular article)", dependency: "Real-KDE injection closure (v3M.0.7), then final author review and Houston sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
