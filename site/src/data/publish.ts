  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.10), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.9: R3 truth-audit closure — the transmitted (post-bounce) amplitude now headlines the LSS channel (Table IV), a derivation appendix, and an induced-GW IR-slope correction. A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.10 — R4 verified + PTA null; rounds stopped (R2). Was: v3M.0.9 — R3 truth-audit closure: transmitted-amplitude LSS reach, delta N_c derivation appendix, induced-GW IR-slope correction closed", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
