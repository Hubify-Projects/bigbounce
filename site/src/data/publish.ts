  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.24), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.24: A2 monopole gap reconciled (independent adjudication 2026-09-07) -- A2=eps(3-eps)^2/3 correct, f_NL^rho=5(eps-7)/8=-55/16 at dust via the corrected 3λ composition weight; in-in -15/8, comoving -5, and uniform-density -55/16 δN values are now three well-defined variables related by exact threading maps; the flagship -35/16 is unaffected. ROUNDS STOPPED (R2). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.24 — A2 monopole gap reconciled: A2=eps(3-eps)^2/3 correct, f_NL^rho=5(eps-7)/8=-55/16 at dust via the corrected 3λ composition weight; in-in -15/8, comoving -5, and uniform-density -55/16 δN values now three well-defined variables. ROUNDS STOPPED (R2). Was: v3M.0.23 — S9c derivation-statement update", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
