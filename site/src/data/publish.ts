  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.11), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.11: science decision D-A3-9 (ledger row 9) — the transmitted amplitude is a two-scheme band, f_NL^after ∈ [−1.25, −0.50] (S1 geometric vs. S2 fluid MS variable, S2 finite on the raw ADM Lagrangian). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.11 — science decision D-A3-9 (row 9) integrated: transmitted amplitude restated as a two-scheme band [-1.25,-0.50]; R5 verification board in progress. Was: v3M.0.10 — R4 verified + PTA null; rounds stopped (R2)", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
