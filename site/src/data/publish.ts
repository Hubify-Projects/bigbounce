  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.14), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.14: R6 closure (16 genuinely-new-real findings, 0 physics errors) -- T_B mapping corrected (thirteen decades above BBN), Channel I amplitude re-paired to the free-gamma NANOGrav posterior, DESI DR1 v3 reproduction sentence added to Sec. VI. Rounds stopped under directive R2. A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.14 — R6 closure (16 genuinely-new-real, 0 physics errors): T_B mapping corrected, Channel I amplitude re-paired, DESI DR1 v3 sentence added. Rounds STOPPED under R2 pending a science decision (A3-4 r-derivation, Choudhury sign). Was: v3M.0.13 — abstract trimmed to PRD-regular cap", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
