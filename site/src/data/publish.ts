  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.21), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.21: literature/derivation correction -- the uniform-density δN value -55/16 is not reconciled by the threading-map identity (second-order rho-slice map gives -5/2 at dust, gap 15/16, attributed to an omitted intrinsic initial-data bispectrum); only the comoving-slice δN (-5) is fully reconciled and the flagship -35/16 is unaffected. ROUNDS STOPPED (R2). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.21 — literature/derivation correction: uniform-density δN (-55/16) not reconciled, rho-slice map gives -5/2 (gap 15/16), intrinsic term named as the gap. ROUNDS STOPPED (R2). Was: v3M.0.20 — D-A3-14 (row 19) no-go generalized to the full P(X) class", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
