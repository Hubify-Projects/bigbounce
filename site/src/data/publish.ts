  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.8), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.8: three science-gate results closed — method-independent f_NL cross-check, the bounce's own cubic term (f_NL^after in [-0.65,-0.50]), and a lab-own-spectrum PBH null. A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
