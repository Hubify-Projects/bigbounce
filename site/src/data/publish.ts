...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "P2′ · Track A1 flagship Letter", role: "Lead theory paper (Letter)", status: "Drafted (v2L.0.1) — ledger #1 closed, R1 board dispatched", destination: "Physical Review D — Letter / JCAP", dependency: "R1 INT board (Fable referee leg + Grok + Gemini) verdicts pending", nextGate: "Close R1 findings, then Houston visual approval + independent review", href: "/papers/paper-2l" },
