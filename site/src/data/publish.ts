  ...
  decisions: [
    {
      ...
      detail:
        "A1 · P2′'s exact-amplitude theory (ledger #1 CLOSED) is now folded into A3 (paper-a3m, v3M.0.23), the flagship submission candidate combining the exact amplitude with multi-channel consistency checks (NANOGrav γ, PBH abundance, SPHEREx/MegaMapper). v3M.0.23: S9c derivation-statement update -- the dropped-evolution-term hypothesis is NOT supported; both -55/16 (uniform-density) and -5 (comoving) δN values are well-defined; the 15/16 gap is relocated to the threading map's lapse monopole coefficient A2, under independent adjudication; the flagship -35/16 is unaffected. ROUNDS STOPPED (R2). A2 (transmission through an explicit bounce) remains a research brief in progress.",
    },
    {
...
export const publicationMap: readonly PublicationMapGroup[] = [
  {
    ...
    rows: [
      { name: "A3 · Track A flagship multi-channel paper", role: "Flagship submission candidate (A3 skeleton + P2′ theory folded in)", status: "v3M.0.23 — S9c derivation-statement update: dropped-evolution-term hypothesis NOT supported; -55/16 and -5 δN values both well-defined; 15/16 gap relocated to the threading map's lapse monopole A2, under independent adjudication. ROUNDS STOPPED (R2). Was: v3M.0.22 — S9b derivation-statement correction", destination: "Physical Review D (regular article)", dependency: "Houston final author review and sign-off for readiness 100", nextGate: "Houston visual approval + independent review, then submission", href: "/papers/paper-a3m" },
