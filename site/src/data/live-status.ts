...
export const liveStatus: LiveStatus = {
  ...
  summary:
    "R26conf wave bumped four papers — P1A v1A.0.55 · P1B v1B.0.54 · P3 v3.1.86 · P5 v0.1.57 (P2 v1.7.48 · P4 v1.0.171 unchanged, still SIGN-OFF-READY). P1B's lone substantive accusation (CPL crossing) was falsified by shown arithmetic (z*=+0.39 inside range) and every committed number chain-reproduced → SIGN-OFF-READY at 95. P1A discloses a Cartan factor-2 normalization inconsistency (analytic re-derivation queued); P3 closed 12 textual items (cluster accounting exact, NANOGrav Eq.E1 falsified); P5 closed 9 including code-verified tidal-tensor sign doc.",
  currentlyRunning: [
