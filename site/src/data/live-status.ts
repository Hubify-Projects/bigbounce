...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T15:00:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 8:00 AM PT",
  headline:
    "R46 Wave 14-AAAAA — R46 minors+nits sweep across all 4 papers closed. P1A 84→85 (+1pp v1A.0.12), P2 82→83 (+1pp v1.7.19), P3 88→89 (+1pp v3.1.30), P4 85→86 (+1pp v1.0.38). Avg 82.8→83.6 (+0.8pp). R46 surface: 0 BLOCKER + 0 MAJOR + ~3 remaining MINOR (n/a-confirmed) + 0 NIT across all 4 CCAI-reviewed papers. R46 fully cleared. Wave 14-BBBBB (R47 launch — second convergence test) next.",
  summary:
