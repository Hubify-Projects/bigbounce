...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-01T21:06:00Z",
  lastUpdatedDisplay: "2026-05-01 14:06 PT",
  headline:
    "Wave 14-DD IN-FLIGHT · DESI Legacy DR8 b/a fetch on Pod 3 (8-thread parallel, 59.5% / 5.0M rows kept / ETA ~19 min) · Wave 14-CC LANDED · 36 cross-model findings closed · ETA all-4 → 100%: ~10-24 h",
  summary:
