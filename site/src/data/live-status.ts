...
export const liveStatus: LiveStatus = {
  ...
  headline:
    "W4 EXIT WAVE CONFIRMED (INT + EXT) — ALL FIVE PAPERS PAST THE BAR (Jul 11). P5's exit crossing is now confirmed on BOTH halves: the W4-EXT leg (Grok MINOR / ChatGPT MAJOR REVISIONS on v0.1.120) surfaced 0 genuinely-new reader-visible findings — every unmatched finding a source-cited re-flag of already-disclosed content or parser noise — so P5's two-clean-waves streak HOLDS at 2. NEW: ChatGPT's EXT verdict on P5 moved REJECT → MAJOR REVISIONS, its first non-REJECT EXT verdict on this paper (raw EXT_real/H17_2026-07-10/W4/P5_chatgpt_W4.md), mirroring OpenAI's INT REJECT → MAJOR the same wave. The edit-loop program EXITS: P1U 2 · P2 3 · P3 4 · P4 4 · P5 2, all five past the bar. Remaining work is Houston-gated (arXiv wave-1 clicks + human journal referees). Grok EXT returned literal ACCEPTs on P5 (v0.1.117) and P4 (v1.0.235) — the program's first two external ACCEPTs.",
  summary:
