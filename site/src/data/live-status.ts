...
export const liveStatus: LiveStatus = {
  ...
  cronStatus: "H17F FINAL-WAVE harvested (2026-07-10). *** P5 Grok returned the program's FIRST external ACCEPT *** (raw literally 'VERDICT: ACCEPT'). ChatGPT P5 moved UP a tier REJECT→MAJOR; the P4 Grok H17 MAJOR backfire reversed to MINOR on the corrected paper. Both fused loops (P5 + P4) converged with Claude INT ACCEPTs. Truth-audit: 0 genuinely-new real+editable findings across all 6 harvested raws → no version bump, all versions stand. Every surviving MAJOR/REJECT = source-cited disposition re-flag (P5 DP5-06..22, P4 DP4-07..21, P2 DP2-01..30, P1U DP1U-02..22) or the directive-H harsh-referee floor. Caps recomputed per latest-per-reviewer verdict: P5 68→79, P4 62, P2 62, P1U/P3 56. NO paper yet at a literal 0/0/0 ACCEPT (directive-J bar). Readiness is verdict-derived, never a false high %.",
  etaToCompletion:
