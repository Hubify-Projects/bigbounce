...
export const liveStatus: LiveStatus = {
  ...
  summary:
    "Six external rounds complete. EXT6 submitted Jun 12 ~02:35 PT on R35conf-closed versions (v1A.0.66/v1B.0.63/v1.7.58/v3.1.101/v1.0.180/v0.1.70). Grok has been 6/6 ACCEPT for four consecutive rounds. Gemini fully cleared P1B for the first time. ChatGPT holds MAJOR×6; per-finding truth-audits determine the genuine residuals.",
  currentlyRunning: [
  ...
  papers: [
    {
      ...
      version: "v1A.0.66",
      readiness: 95,
      pendingWork: "v1A.0.66 — EXT6: Grok ACCEPT ×4 rounds, Gemini MINOR (fine-tuning score phrasing); ChatGPT MAJOR (NJL wrong-sign, Sec IV closure overclaim); truth-audit in progress; awaiting Houston sign-off",
    },
    {
      slug: "paper-1b",
      number: "1B",
      ...
      version: "v1B.0.63",
      readiness: 94,
      pendingWork: "v1B.0.63 — EXT6: Grok ACCEPT ×4, Gemini FULL ACCEPT (first paper fully cleared by Gemini); ChatGPT MAJOR (artifact-layer pinning, frozen artifact mismatch); awaiting Houston sign-off",
    },
    {
      slug: "paper-2",
      number: "2",
      ...
      version: "v1.7.58",
      readiness: 94,
      pendingWork: "v1.7.58 — EXT6: Grok ACCEPT ×4, Gemini MINOR (Eq 3 variable mismatch + Table IV header); ChatGPT MAJOR (narrowly — null-space interpretation + fresh numerical issues); awaiting Houston sign-off",
    },
    {
      slug: "paper-3",
      number: "3",
      ...
      version: "v3.1.101",
      readiness: 95,
      pendingWork: "v3.1.101 — EXT6: Grok ACCEPT ×4, Gemini MAJOR (fresh thread — calibration/instrumental artifacts, notation); ChatGPT MAJOR (catalogue-tier semantics, DESI denominator); awaiting Houston sign-off",
    },
    {
      slug: "paper-4",
      number: "4",
      ...
      version: "v1.0.180",
      readiness: 95,
      pendingWork: "v1.0.180 — EXT6: Grok ACCEPT ×4 (exemplary, immediate acceptance recommended), Gemini MINOR (misplaced imaging-leg paragraph in appendix); ChatGPT MAJOR (monopole interpretation, +3.64σ taxonomy residuals); awaiting Houston sign-off",
    },
    {
      slug: "paper-5",
      number: "5",
      ...
      version: "v0.1.70",
      readiness: 95,
      pendingWork: "v0.1.70 — EXT6: Grok ACCEPT (EXT5 MINOR → EXT6 ACCEPT; estimand-family coherence cleared), Gemini MINOR (appendix labeling layout sync); ChatGPT MAJOR (GALZONE estimand-family, 3.56% duplicate tracking); awaiting Houston sign-off",
    },
  ],
  blockerTally: {
