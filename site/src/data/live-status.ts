...
export const liveStatus: LiveStatus = {
  ...
  lastUpdatedDisplay: "May 15, 2026 · 3:30 AM PT",
  headline:
    "**P4 v1.0.65 → v1.0.66 — visual-formatting pass (Houston-flagged PDF readability fixes; no scientific content change; readiness stable 95).** Houston review of the v1.0.65 PDF surfaced 6 visual issues: title-page \\paperTimestamp long-history blob overflowing the title block; two raw-\\texttt{} filesystem paths spilling into the column margin (page 10 wave_14_oo_cw_flatness_morphology.json + page 18 footnote sky_balance_canonical.json); Figs 10/11/12 (multi-panel CW-fraction-by-sky-region, raw-vs-equivariant Mollweide, per-bin equivariant CW fraction) crammed into single-column figure environments at unreadably small label sizes; and a page-24 wall-of-math MC injection-recovery paragraph cramming 5 amplitudes × 3 statistics inline. **All 6 closed in v1.0.66 single bundled wave**: (1) \\paperTimestamp shortened to \"May 15, 2026 PDT\"; (2) both raw \\texttt{} paths migrated to the existing \\artifact{} macro (which uses \\discretionary line breaks on underscores); (3) Figs 10/11/12 promoted from \\begin{figure} to \\begin{figure*} with width=0.92\\textwidth; (4) page-24 paragraph extracted into proper \\begin{table}{tab:mc_injection} with verdict prose preserved below. **STANDING DIRECTIVE SAVED**: feedback_pdf_visual_formatting.md — 7 hard rules for ALL future paper compiles (P1A/P1B/P2/P3/P4 + future papers) so this class of issue stops recurring (R1: short date line ≤70 chars; R2: long file paths use \\artifact{}/\\path{}/itemize; R3: multi-panel figures use figure*; R4: wall-of-math paragraphs use tabular; R5-7: columnwidth awareness, post-compile QA checklist, all-paper applicability). **PDF 34pp / 25,905,601 bytes / 0 undef refs / sha256 6fcdd7615fc6...** (was 33pp / 25,905,151; +1 page from the new MC-injection table replacing the wall-of-math prose). 6 mirrors byte-identical. **Readiness P4 95 unchanged** (at cap; visual-formatting closures count toward gate (b) Houston sign-off readiness). Per-paper: P1A 73 (v1A.0.22, cycle-2 R-round in process: 3-vendor convergent BLOCKER on Appendix B dim-fix is word-salad-by-hand-insertion; GPT-B1 separate arithmetic catch ~35→~120 orders cosmological-constant hierarchy; closing in v1A.0.23 next tick), P1B 64 (v1B.0.6), P2 82 (v1.7.30), P3 85 (v3.1.41), **P4 95 (v1.0.66, Houston-visual-fixes)**. Cobaya unchanged: 59,832 samples / R̂−1=0.01945 / 22:53 UTC last flush; slow-mode-dominated, not stalled.",
  summary:
