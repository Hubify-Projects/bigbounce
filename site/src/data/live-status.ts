...
export const liveStatus: LiveStatus = {
  ...
  currentlyRunning: [
    "Cobaya 4-chain MPI run on RTX A5000 pod ijzftpy3klystt (SSH endpoint rotated to ijzftpy3klystt-6441139c@ssh.runpod.io after IP change) — warm-started with posterior covmat from April-6 quintom chain; DESI DR2 + Planck NPIPE + Pantheon+ + DES-Y5; w0-wa CPL PPF; target R̂−1 < 0.01. Current R̂−1 = 0.095 at 9,127 accepted (5/11 17:33 PT); up from 0.079 low-water mark at 5/10 23:02 (normal non-monotonic slow-mode exploration). Honest ETA 5–15 days.",
  ...
  etaToCompletion:
    "Compute: cobaya R̂−1 < 0.01 honest ETA 5–15 days (currently 0.095 at 9,127 accepted, up from 0.079 low water 5/10 23:02; the earlier 'ETA 1–3 days from 5/8' was a linear extrapolation from one datapoint and is now stale); P4 deep-MLP RA/Dec ablation needs an H200 spin-up. Each paper carries a backward step on R45 launch (CCAI multi-agent self-review will open new findings) and a larger backward step on cross-vendor non-Anthropic round (GPT-5/Gemini/Grok/Perplexity). True 99% is gated on BOTH a clean CCAI round AND a clean cross-vendor round AND Houston sign-off; the final 1% is Houston manually triggering arXiv submission.",
  pods: [
    {
