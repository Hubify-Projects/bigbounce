...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T04:30:00Z",
  lastUpdatedDisplay: "May 8, 2026 · 9:30 PM PT",
  headline:
    "R44 Wave 14-JJJJ — cross-paper bibitem cleanup: Golden2026P{1a,1b,2,3,4} + Eskilt2022b joint Planck+ACT now defined as proper @article entries; ALL natbib cite warnings cleared in P1A v1A.0.6 + P1B v1B.0.2",
  summary:
