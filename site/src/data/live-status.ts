...
export const liveStatus: LiveStatus = {
  ...
  summary:
    "Six external rounds complete. EXT6 submitted Jun 12 ~02:35 PT on R35conf-closed versions (v1A.0.67/v1B.0.64/v1.7.59/v3.1.102/v1.0.181/v0.1.71). Grok has been 6/6 ACCEPT for four consecutive rounds. Gemini fully cleared P1B for the first time. ChatGPT holds MAJOR×6; per-finding truth-audits determine the genuine residuals.",
  currentlyRunning: [
  ...
  papers: [
    {
      ...
      version: "v1A.0.67",
      readiness: 95,
      pendingWork: "v1A.0.67 — EXT6: Grok ACCEPT ×4 rounds, Gemini MINOR (fine-tuning score phrasing); ChatGPT MAJOR (NJL wrong-sign, Sec IV closure overclaim); truth-audit in progress; awaiting Houston sign-off",
    },
    {
      slug: "paper-1b",
      number: "1B",
      ...
      version: "v1B.0.64",
      readiness: 94,
      pendingWork: "v1B.0.64 — EXT6: Grok ACCEPT ×4, Gemini FULL ACCEPT (first paper fully cleared by Gemini); ChatGPT MAJOR (artifact-layer pinning, frozen artifact mismatch); awaiting Houston sign-off",
    },
    {
      slug: "paper-2",
      number: "2",
      ...
      version: "v1.7.59",
      readiness: 94,
      pendingWork: "v1.7.59 — EXT6: Grok ACCEPT ×4, Gemini MINOR (Eq 3 variable mismatch + Table IV header); ChatGPT MAJOR (narrowly — null-space interpretation + fresh numerical issues); awaiting Houston sign-off",
    },
    {
      slug: "paper-3",
      number: "3",
      ...
      version: "v3.1.102",
      readiness: 95,
      pendingWork: "v3.1.102 — EXT6: Grok ACCEPT ×4, Gemini MAJOR (fresh thread — calibration/instrumental artifacts, notation); ChatGPT MAJOR (catalogue-tier semantics, DESI denominator); awaiting Houston sign-off",
    },
    {
      slug: "paper-4",
      number: "4",
      ...
      version: "v1.0.181",
      readiness: 95,
      pendingWork: "v1.0.181 — EXT6: Grok ACCEPT ×4 (exemplary, immediate acceptance recommended), Gemini MINOR (misplaced imaging-leg paragraph in appendix); ChatGPT MAJOR (monopole interpretation, +3.64σ taxonomy residuals); awaiting Houston sign-off",
    },
    {
      slug: "paper-5",
      number: "5",
      ...
      version: "v0.1.71",
      readiness: 95,
      pendingWork: "v0.1.71 — EXT6: Grok ACCEPT (EXT5 MINOR → EXT6 ACCEPT; estimand-family coherence cleared), Gemini MINOR (appendix labeling layout sync); ChatGPT MAJOR (GALZONE estimand-family, 3.56% duplicate tracking); awaiting Houston sign-off",
    },
  ],
  blockerTally: {
