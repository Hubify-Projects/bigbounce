...
export const liveStatus: LiveStatus = {
  ...
  papers: [
    ...
    },
    {
      ...
      version: "v1.0.223",
      readiness: 74,
      pendingWork: "Error-clean + verified, NOT reviewer-accepted. FULL8 board (Jul 8): Grok MINOR · Gemini MINOR · ChatGPT MAJOR (moved off REJECT). v1.0.223 closed all Grok+Gemini minors (Table I cosmological-weight footnote, Table VII synthesis, GZ1 forward-pointer, IV.A selection-function scope, citation template) + softened the A95 falsification-language (ChatGPT concrete fix: 'excluded'→'not reliably recovered'). Real-space ℓ=1 dipole +0.41σ null robust; every number preserved.",
    },
    {
      slug: "paper-5",
      number: "5",
      ...
      version: "v0.1.107",
      readiness: 80,
      pendingWork: "Error-clean + verified, NOT reviewer-accepted. FULL8 board (Jul 8): Grok MINOR · Gemini MINOR · ChatGPT MAJOR (moved off REJECT; closest to review-clean). v0.1.107 closed all Grok+Gemini minors (headline scoped to DESIVAST contrast + 0.5–0.6pp bound, post-hoc primary caveat foregrounded, RSD membership-shift bound quantified, artifact availability made concrete, BGS→ViT propagation explained) + ChatGPT editable majors (void-membership caveat, T-Web marked failed/diagnostic secondary, Paper-IV dependency disclosed). Every number preserved.",
    },
  ],
  blockerTally: {
