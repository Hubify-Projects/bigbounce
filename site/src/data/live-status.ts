...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-01T23:20:00Z",
  lastUpdatedDisplay: "May 1, 2026 · 4:20 PM PT",
  headline:
    "Readiness rule (2026-05-01 16:20 PT cron fire): 99% is the cap until Houston signs off + an external peer-review round closes with zero MAJOR/MINOR findings · the final 1% is reserved for that sign-off, not awarded by the cron · per-paper: P1 99% · P2 99% · P3 98% · P4 96% · Wave 14-JJ P4-CM-B2 PSF cross-correlation BLOCKER still in flight on Pod 3 H200 (+22min wall, sustained ~19-core CPU, output block-buffered through HEALPix map build pre-correlation) · SPARCL fetch (PID 25860) at +14h on separate CPU core · 39 R42 cross-model findings closed cumulative · 1 conditional BLOCKER + 6 open MAJORs + 13 open MINORs across all 4 papers · Wave 14-II LANDED earlier (P3 v3.1.14 → v3.1.15 quantitative systematics-marginalization Fisher recompute, FULL HARD FIX of P3-CM-M1) · Wave 14-FF/EE/DD chirality grid + DR8 b/a fetch carried forward",
  summary:
