...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T11:30:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 4:30 AM PT",
  headline:
    "R46 Wave 14-WWWW — P1A v1A.0.11 R46 BLOCKER B1 + MAJORs M1-M3 closed. P1A 78→84 (+6pp). Avg 77.8→79.0. R46 surface: 2 BLOCKER + 12 MAJOR (P2 1+4, P3 1+4, P4 0+4). Route 2 closure now correct via dimensionless α_em/(4π)·H_0/M_Pl ratio (~10^-58 suppression); R4 reframed as CC-tuning relocation rather than amplitude mismatch.",
  summary:
