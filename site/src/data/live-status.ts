...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T12:00:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 5:00 AM PT",
  headline:
    "R46 Wave 14-XXXX-r46 — P2 v1.7.18 R46 BLOCKER B1 (QSFI parenthetical fixed) + MAJORs M1-M4 closed. P2 76→82 (+6pp). Avg 79.0→80.2. R46 surface: 1 BLOCKER + 8 MAJOR (P3 1+4, P4 0+4). Table 4 now has explicit BF~17 row retiring the abstract-vs-table reconciliation deflection.",
  summary:
