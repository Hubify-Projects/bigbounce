...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T04:00:00Z",
  lastUpdatedDisplay: "May 8, 2026 · 9:00 PM PT",
  headline:
    "R44 Wave 14-IIII — P1A v1A.0.5 four-route no-go appendix scaffolded (NJL + one-loop EA + Immirzi + parity-CMB; +5 standard bibitems; +2 pages of referee-grade content; replaces non-public Golden2026supplement assertion)",
  summary:
  ...
  papers: [
    {
      ...
      readiness: 99,
      pendingWork:
        "Houston sign-off + clean external R44 peer-review round (R44 MAJOR M3 four-route no-go appendix scaffolded Wave 14-IIII: 4 explicit subsections (NJL Hehl-Datta + one-loop Mercuri-Capozziello + Immirzi Date-Kaul-Sengupta + parity-CMB Lue-Wang-Kamionkowski), each closed at amplitude level with standard cite — replaces single-paragraph forward-reference to non-public Golden2026supplement; +5 bibitems added) + arXiv submission",
    },
    {
      slug: "paper-1b",
      number: "1B",
