...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T03:00:00Z",
  lastUpdatedDisplay: "May 8, 2026 · 8:00 PM PT",
  headline:
    "R44 Wave 14-GGGG — P4 v1.0.33 R44 MAJORs M1+M2+M3 + nit2 shipped (p_LEE upper-bounded, GZ1 Platt 6 sig figs, McNemar paired test, PUSHBACK token cleanup)",
  summary:
