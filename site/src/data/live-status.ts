...
export const liveStatus: LiveStatus = {
  ...
  papers: [
    ...
    },
    {
      ...
      version: "v1.7.101",
      readiness: 74,
      pendingWork: "Error-clean + verified, NOT reviewer-accepted. v1.7.101 (REALWORK re-test): closed the ChatGPT r=0.84 vs r_eff≈0.99 apparent-inconsistency — added ONE crisp reconciliation (§spherex): r=0.84 is the flat-weight shape-overlap cosine adopted as the conservative recast factor; r_eff≈0.99 is the survey-optimal (squeezed-dominated) amplitude recovery of an actual multi-tracer estimator — different quantities, not a contradiction; the Fisher CONFIRMS 0.84 is conservative. Also hardened Fisher presentation (explicit survey spec + closed-form covariance). NO NUMBER CHANGED. r_eff≈0.99 validation of the recast unchanged; f_NL=−35/16 3-way certified.",
    },
    {
      slug: "paper-3",
      number: "3",
