...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T03:30:00Z",
  lastUpdatedDisplay: "May 8, 2026 · 8:30 PM PT",
  headline:
    "R44 Wave 14-HHHH — P2 v1.7.13 R44 BLOCKERs B1+B2 shipped (9.9σ reframed as pre-systematic-budget, convention-reversal halving stated for both 5.25σ→2.6σ AND 3-5σ→1.5-2.5σ)",
  summary:
