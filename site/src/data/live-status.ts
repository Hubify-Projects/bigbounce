...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T09:30:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 2:30 AM PT",
  headline:
    "R45 Wave 14-SSSS — P3 v3.1.27 R45 BLOCKER B1 + MAJORs M1-M5 closed. P3 80→88 (+8pp forward step under cycle). Avg 79.6→81.2. R45 surface: 1 BLOCKER + 6 MAJOR remaining (P4 1+6, then minors+nits → R46 launch).",
  summary:
