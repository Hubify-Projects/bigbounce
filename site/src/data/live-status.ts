...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T09:00:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 2:00 AM PT",
  headline:
    "R45 Wave 14-RRRR — P2 v1.7.16 R45 BLOCKERs B1+B2 + MAJORs M1-M6 closed. P2 73→82 (+9pp forward step under cycle). Avg 77.8→79.6. R45 surface: 2 BLOCKER + 11 MAJOR remaining (P3 1+5, P4 1+6).",
  summary:
