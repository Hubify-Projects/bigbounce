  ...
  papers: [
    {
      ...
      version: "v1A.0.64",
      readiness: 95,
      pendingWork: "v1A.0.64 — EXT4 closures landed (Fig 3 caption mechanism/rotation split; ALP benchmark scoping); Grok ACCEPT ×2 rounds, Gemini MINOR; awaiting Houston sign-off",
    },
    {
      slug: "paper-1b",
      number: "1B",
      ...
      version: "v1B.0.61",
      readiness: 94,
      pendingWork: "v1B.0.61 — EXT4 hygiene closures (CHANGELOG/README/citation); Grok ACCEPT ×2; w0wa addendum pending c15 convergence; awaiting Houston sign-off",
    },
    {
      slug: "paper-2",
      number: "2",
      ...
      version: "v1.7.56",
      readiness: 94,
      pendingWork: "v1.7.56 — EXT4: App A c-scaling sentence corrected (both ∝ 1/c); Grok ACCEPT ×2, Gemini MAJOR→MINOR; awaiting Houston sign-off",
    },
    {
      slug: "paper-3",
      number: "3",
      ...
      version: "v3.1.99",
      readiness: 95,
      pendingWork: "v3.1.99 — EXT4 closure wave (recount cross-refs at 3 downstream sites + 5 polish); Grok ACCEPT ×2, Gemini MAJOR falsified-bulk; awaiting Houston sign-off",
    },
    {
      slug: "paper-4",
      number: "4",
      ...
      version: "v1.0.178",
      readiness: 95,
      pendingWork: "v1.0.178 — EXT4: catalog-wide flip-identity QC artifact recomputed, every QC number now traces (2.94%/0.0901/4.26e-7); Grok ACCEPT ×2; awaiting Houston sign-off",
    },
    {
      slug: "paper-5",
      number: "5",
      ...
      version: "v0.1.68",
      readiness: 95,
      pendingWork: "v0.1.68 — EXT4: GALZONE two-sample contrasts computed (z=−1.25/+0.72, clean nulls; Bonferroni-5 estimand-coherent); Grok ACCEPT ×2; awaiting Houston sign-off",
    },
  ],
  blockerTally: {
