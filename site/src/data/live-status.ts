...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-15T08:30:00Z",
  lastUpdatedDisplay: "May 15, 2026 · 1:30 AM PT",
  headline:
    "**P1B v1B.0.5 → v1B.0.6 — 1st real cross-vendor R-round on P1B closed in single bundled wave; DESI DR2 chain stall transparency closure + cross-paper Table refresh. ROTATION COMPLETE: all 5 papers (P4→P2→P3→P1A→P1B) now received their 1st new real-vendor R-round this session.** Per-vendor: DeepSeek 3 BLOCKERs (sample-count + Δχ²/ΔNeff incompatibility + Savage-Dickey provenance) + 2 MAJORs; GPT-5.5 2 BLOCKERs + 4 MAJORs; Gemini 2 MAJORs + 4 minors; Grok-4 2 BLOCKERs + 2 MAJORs (5th 502-FAIL pattern broken — Grok landed this round); Perplexity 1 FALSE-POSITIVE BLOCKER (Liu 2025 ECTorsionDESI2025 already in bib with arXiv:2507.04265). **Closed in v1B.0.6**: (a) DESI DR2 chain stall status across 4 sites — all now report 'stalled at R̂−1=0.01775 / 53,736 samples / no advance ~12+h' replacing 'running ~3 days ETA / monotonically descending'; calendar ETA removed; (b) Cross-paper Table 1 refreshed to current versions/readinesses (P1A v1A.0.22 73% / P1B v1B.0.6 64% / P2 v1.7.29 81% / P3 v3.1.40 84% / P4 v1.0.64 95%); (c) 14→13 barrier framing aligned with P1A v1A.0.22. **Deferred on-record (compute-bound) to v1B.0.7**: Δχ²/AIC/BIC/ln B recompute from frozen-thinned chain (3-vendor convergent); (ω/H)_0 parameter-scope; NaMaster per-injection bias table; Savage-Dickey provenance script; sample-count provenance script. **PDF 8pp / 682,006 bytes / 0 undef refs / sha256 `b35d95a1f522...`** (was 676,642 / sha fd1c311a; +5,364 bytes for stall-status updates + cross-paper refresh + barrier framing). 3 mirrors byte-identical. **Readiness P1B 64 unchanged**. **Per-paper FINAL ROTATION-COMPLETE STATE**: P1A 73 (v1A.0.22), P1B 64 (v1B.0.6), P2 81 (v1.7.29), P3 84 (v3.1.40), **P4 95 (v1.0.64, at cap awaiting Houston sign-off)**. All 5 papers received their 1st new real-vendor R-round closures across the 5-tick rotation this session (commits 7c8131db, a19514f6, f3bf861d, 7e6b441a, and this commit). **P4 remains publish-ready pending only Houston sign-off**. Cobaya iter2-OMP6 stalled at 0.01775 / 53,736 samples for ~12h; 16-rank mpirun alive (slow-mode-dominated).",
  summary:
