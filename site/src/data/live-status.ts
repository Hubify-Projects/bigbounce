...
export const liveStatus: LiveStatus = {
  lastUpdatedISO: "2026-05-09T18:00:00Z",
  lastUpdatedDisplay: "May 9, 2026 · 11:00 AM PT",
  headline:
    "R47 Wave 14-DDDDD — P2 v1.7.19→v1.7.20 R47 BLOCKER B1 + 3 MAJORs M1-M3 all closed. P2 76→82 (+6pp). R47 surface: 0 BLOCKER + 5 MAJOR + 13 MINOR + 7 NIT remaining (P3 0+2, P4 0+3 only). Avg 80.4→81.6 (+1.2pp). The R47 cycle is now BLOCKER-free across all 4 papers — only 5 MAJORs remain and the <3 BLOCKER + <5 MAJOR exit condition is one MAJOR away. Wave 14-EEEEE (P3 R47 2 MAJORs) next, then FFFFF (P4 R47 3 MAJORs), GGGGG (R47 minors+nits sweep), HHHHH (R48 launch — third convergence test).",
  summary:
