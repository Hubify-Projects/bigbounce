...
export const liveStatus: LiveStatus = {
  ...
  papers: [
    ...
    },
    {
      ...
      version: "v3M.0.17",
      readiness: 75,
      pendingWork: "D-A3-12: tensor no-go is scheme-independent (lambda_T=lambda_zeta^S1 identity; r_after^S1=24.0, r_after^S2~9.4e2); bounce cubic term now c_s-dependent, strengthening the joint (r,f_NL) window to c_s>=0.600/r>=14.4 (400x BICEP/Keck). One verification board permitted (R8) under directive R2. Houston final review pending.",
    },
    {
      slug: "paper-3",
      number: "3",
    ...
    },
    {
      ...
      version: "v1S.0.2",
      readiness: 55,
      pendingWork: "D-PSU-1 reframe: exact invertible change of variable (not a 'failure'); R1 board closed (21 genuinely-new-real findings closed, all science gates resolved). R2 verification round in progress; venue/arXiv category pending.",
    },
  ],
  blockerTally: {
    closed: 920,
