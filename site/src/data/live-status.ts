...
export const liveStatus: LiveStatus = {
  ...
  lastUpdatedDisplay: "May 15, 2026 · 4:30 AM PT",
  headline:
    "**P1A v1A.0.22 → v1A.0.23 — Cycle-2 2nd R-round on upgraded model stack closed 3-vendor convergent BLOCKER + 1 NEW load-bearing physics finding + 1 arithmetic catch; readiness 73 → 74.** **Per-vendor verdicts on v1A.0.22** (Gemini-3.1-Pro / Grok-4.3 / GPT-5.5 / DeepSeek-V4-Pro / Sonar Pro, reasoning_effort=high): (1) **3-vendor CONVERGENT BLOCKER** Gemini-B1 + Grok-B4 + GPT-B1 — the v1A.0.22 \"M_Pl² volume integration density\" insertion in Appendix B is by-hand-not-EFT-derived word salad, not a true dimensional fix. (2) **GPT-B1 NEW arithmetic catch** — M_Pl⁴/ρ_Λ ~ 10¹²⁰ (cosmological-constant hierarchy) not \"~35 orders\" as the appendix claimed; (3) **2-vendor convergent Gemini-M2 + Grok** — \"plausibly erased\" understates N_tot~92 e-fold erasure (k_bounce = k_SPHEREx × e³⁰ deep inside inflationary subhorizon, so erasure is definitive); (4) **2-vendor convergent Grok-B1 + GPT-B4** — \"no-go theorem\" overclaim should be channel-level closure given Jackiw-Pi + parity-odd four-fermion partner not in operator basis; (5) **Gemini-M1 NEW load-bearing physics finding** — reheating thermal fermion bath overwrites bounce-era torsion regardless of inflationary dilution (strengthens B14); (6) **Perplexity-B1 FALSE POSITIVE** (Freidel2005 bib entry already correct hep-th/0507253). **Closed in v1A.0.23 single bundled wave**: (a) Appendix B framing honesty (relabeled to \"Dimensional Status\"; explicit phenomenological-ansatz framing; alternative coupling-rescaling reading shown as equivalent dimensional assignment); (b) cosmological-constant hierarchy arithmetic corrected ~35 → ~120 orders + N_tot ≈ 94 derived directly; (c) \"plausibly erased\" → \"definitively erased\" propagated 4 sites with explicit k_SPHEREx × e^N_tot anchor; (d) NEW thermal-reset barrier paragraph added (Gemini-M1 finding) strengthening B14 with independent thermodynamic erasure channel; (e) theorem-overclaim softening 2 sites; (f) Mercuri attribution scope tightened to \"motivated by\" + \"phenomenological ansatz\". **Visual-formatting QC per feedback_pdf_visual_formatting**: \\paperTimestamp blob shortened to \"May 15, 2026 PDT\"; executive-summary table 914pt overflow eliminated by terselizing cell content. **PDF 19pp / 806,797 bytes / 0 undef refs / sha256 `c6c1aaeb...`** (was 18pp / 797,976; +1 page from thermal-reset + Appendix B rewrite). 3 mirrors byte-identical. **Route 2 dimensional re-derivation remains on-record-deferred to v1A.0.24**. Per-paper: **P1A 74 (v1A.0.23, +1pp)**, P1B 64 (v1B.0.6), P2 82 (v1.7.30), P3 85 (v3.1.41), P4 95 (v1.0.66). Cobaya unchanged: 59,832 samples / R̂−1=0.01945; P1B compute-gated.",
  summary:
