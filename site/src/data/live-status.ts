...
export const liveStatus: LiveStatus = {
  ...
  papers: [
    ...
    },
    {
      ...
      version: "vAF.0.8",
      readiness: 80,
      pendingWork: "vAF.0.8 (lane LAF5, 2026-09-22): DAF-19 closed by adopting the corrected spherical-embedding taxonomy (vAF.0.7), then the directive-R2-authorized board ran on that exact PDF: Grok API REJECT, Gemini API ACCEPT WITH MINOR CORRECTIONS, one Claude-opus verdict-blind referee MAJOR REVISIONS (17 ESSENTIAL/17 MAJOR/27 MINOR, the most exhaustive single-leg report this paper has received). All three legs converged on the manuscript's own leaked internal review-process prose. 9 genuinely-new-real findings closed with real edits: removed leaked review-process language from the body/Acknowledgments/abstract; resolved a self-contradiction about the taxonomy's hyperparameter provenance; Table VIII's caption now defines every column; the corrected taxonomy's separate provenance record disclosed with its real SHA-256; feature standardisation disclosed; the latent-space permutation null bumped 50->10,000 draws (empirical p sharpened to 0.0041); Sec VI.A/VI.B reconciled; three cross-references and one rendering artifact fixed. 5 findings independently FALSIFIED against source (Grok repeated a backwards-date error a prior round already caught; claimed-missing abstract statements already present verbatim). 12 further real findings (DAF-41..52) named honestly for future closure lanes, not fabricated shut. Directive-G clean: 4-pass, 0 errors/undef refs/overfull, 19pp, 5-way md5-verified mirror, standalone tarball text-identical. Directive R2's board budget spent again -- no further board without another intervening science/scope decision. Readiness 80 COMPUTED.",
    },
  ],
  blockerTally: {
    closed: 920,
