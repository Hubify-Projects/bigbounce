...
or CI secret-mounted file; never commit them. Provisioning a project Ed25519
key and registering its public half with Hubify remains a release-owner
operation. Until that is done, publishing is intentionally gated.
