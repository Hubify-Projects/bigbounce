...
(before `\section{...}\label{app:mcs_derivation}`, ≈ line 4229):
...
## Edit 2 — abstract / fbox (lines 1055-1057). Change
...
## Edit 6 — §Residual scope (lines 2402-2408). Change
...
## Edit 7 — conclusion (lines 2877-2879). Change
...
proof supports (single-species minimal ECH; multi-flavor noted as a mechanical
extension inside the new appendix). Class-closure and $M_{\rm Pl}$-power
arguments already cover the multi-flavor case.
