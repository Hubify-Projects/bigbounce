...
Tracking META findings across 8 autoloop fires.
Rounds: ['auto-2026-06-05_1418pt', 'auto-2026-06-05_1517pt', 'auto-2026-06-05_1617pt', 'auto-2026-06-05_1717pt', 'auto-2026-06-05_1817pt', 'auto-2026-06-05_1919pt', 'auto-2026-06-06_0004pt', 'auto-2026-06-06_0021pt']
...
### 🔴 LOAD-BEARING P3 — `dedup` (4/8 rounds)
...
### 🔴 LOAD-BEARING P4 — `cross-match` (4/8 rounds)
...
### 🔴 LOAD-BEARING P5 — `label` (4/8 rounds)
...
### 🔴 LOAD-BEARING P4 — `binomial` (3/8 rounds)
...
### 🔴 LOAD-BEARING P4 — `master` (3/8 rounds)

Seen in rounds: ['auto-2026-06-05_1717pt', 'auto-2026-06-06_0004pt', 'auto-2026-06-06_0021pt']
...
### 🟡 RECURRING P3 — `deduplication` (2/8 rounds)
...
### 🟡 RECURRING P4 — `monopole` (2/8 rounds)
...
### 🟡 RECURRING P4 — `leakage|master|monopole|post-master|pre-master` (2/8 rounds)
...
### 🟡 RECURRING P4 — `table_ii` (2/8 rounds)
...
### 🟡 RECURRING P1B — `label` (2/8 rounds)
...
### 🟡 RECURRING P4 — `leakage` (2/8 rounds)
...
### 🟡 RECURRING P1B — `table_ii` (2/8 rounds)
...
### 🟡 RECURRING P5 — `table_iv` (2/8 rounds)
...
### 🟡 RECURRING P1B — `leakage` (2/8 rounds)

Seen in rounds: ['auto-2026-06-05_1817pt', 'auto-2026-06-06_0004pt']
...
### 🟡 RECURRING P4 — `binomial|monopole` (2/8 rounds)
...
### 🟡 RECURRING P5 — `table_ii` (2/8 rounds)
