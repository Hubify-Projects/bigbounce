...
- [ ] **AUG-019 — Anomaly enrichment execution:** preflight is complete: the 3,810-row selected cohort spans 3,128 coadd groups, the contract-bound model hash verifies, 161 GiB is free locally, and the required public zcatalog is 22.37 GB but not staged. Stage/checksum the zcatalog, then run the checkpointed enrichment → cross-match → taxonomy chain. See [`ANOMALY_ENRICHMENT_PREFLIGHT_2026-08-26.md`](ANOMALY_ENRICHMENT_PREFLIGHT_2026-08-26.md).
