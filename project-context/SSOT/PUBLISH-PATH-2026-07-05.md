...
papers" ARE THE OTHER PAPERS IN THIS REPO. P5's "Paper IV" = P4 (v1.0.220). P1A's
...
### P4 — chirality catalog (v1.0.220) — WAVE 1, FIRST
...
### P1B — MCMC/NaMaster/ALP companion (v1B.0.102) — WAVE 1
...
### P3 — anomaly catalog (v3.1.140) — WAVE 1
...
### P2 — f_NL forecast + Cai/Li resolution (v1.7.98) — WAVE 1
...
### P5 — DESI environmental chirality (v0.1.104) — WAVE 2
...
### P1A — ECH no-go (v1A.0.111) — WAVE 2
