...
type: ssot
paper: 2
last_updated: 2026-06-03 PDT (R9 GEM-M1 closure-introduced math regression fix; v1.7.42 -> v1.7.43)
...
version: v1.7.43 (2026-06-03; R9 GEM-M1 closure-introduced math regression fix — six-monomial basis demoted from "complete S_3-symmetric" overclaim to honest Cai-physics-restricted subset)
headline_pct: 95
