...
type: ssot
paper: 2
last_updated: 2026-06-10 PDT (R24conf confirmation-round closure wave; v1.7.46 -> v1.7.47)
...
version: v1.7.47 (2026-06-10, R24conf closure wave; md5 a6ea2ee9 / 24 pp / 0 errors / 0 undef refs; mirror site/public/papers/paper2_fnl_forecast_v1.7.47.pdf). Prior: v1.7.46 (2026-06-09, R23conf closure wave; md5 45ee3af4). Earlier: v1.7.43 (2026-06-03; R9 GEM-M1 closure-introduced math regression fix — six-monomial basis demoted from "complete S_3-symmetric" overclaim to honest Cai-physics-restricted subset)
headline_pct: 92
