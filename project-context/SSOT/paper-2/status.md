...
type: ssot
paper: 2
last_updated: 2026-06-09 PDT evening (R23conf confirmation-round closure wave; v1.7.45 -> v1.7.46)
...
version: v1.7.46 (2026-06-09, R23conf closure wave; md5 45ee3af4 / 23 pp / 0 errors / 0 undef refs; mirror site/public/papers/paper2_fnl_forecast_v1.7.46.pdf). Prior: v1.7.43 (2026-06-03; R9 GEM-M1 closure-introduced math regression fix — six-monomial basis demoted from "complete S_3-symmetric" overclaim to honest Cai-physics-restricted subset)
headline_pct: 92
