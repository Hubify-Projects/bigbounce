...
1. **ECH Note → CQG** (§1): confirm the Zenodo DOI is minted (see
   ...
   abstract already final (v1N.0.5, trimmed to 298 words 2026-09-02).
2. **P4′ → ApJS** (§2): confirm the P5 Zenodo DOI is minted (see
   ...
   and abstract already final (v4P.0.7 as of 2026-09-05 — row-16 disclosure
   subsection integrated, arXiv tarball rebuilt as
   paper4prime_chirality_test_arxiv_v4P.0.7.tar.gz, abstract text unchanged
...
95) → CQG, **P4′** (v4P.0.7, APPROVE, readiness 95, P5 folded in) → ApJS.
...
30-bin injection test; rounds stopped per directive R2, budget 2/2
consumed); status is now **automated review converged; final author review
+ science gate pending (method-independent f_NL check; bounce cubic term;
...
target is now the final `arxiv/paper1bc_ech_note/main.tex` v1N.0.5
...
| Article type | **Paper** (not Note — the final v1N.0.5 manuscript exceeds the ≤2500-word Note form; per the 2026-09-02 final-review recommendation, submit as a regular CQG Paper) | Final-review recommendation, `FINAL_REVIEW_RECOMMENDATIONS_2026-09-02.md` |
| Length limit | N/A for Paper article type (Note's implicit length cap no longer applies) | — |
| Title | **"What Minimal Einstein–Cartan Torsion Does for the Bounce and Cannot Do for Dark Energy"** (FINAL — `arxiv/paper1bc_ech_note/main.tex` v1N.0.5) | arxiv/paper1bc_ech_note/main.tex |
| Abstract cap | **300 words hard cap** — "we may rescind the manuscript and ask you to re-write it" if over | CQG guidelines page |
| Abstract | Final v1N.0.5 abstract (298 words, trimmed to the 300-word cap 2026-09-02), verbatim — see `ENDORSER_OUTREACH_2026-09-02.md` §1 for the full text | arxiv/paper1bc_ech_note/main.tex |
| Keywords | Free-text, no PACS required. Use: Einstein–Cartan gravity, Holst action, torsion bounce, Popławski cosmology, four-fermion interaction, dark energy, no-go (verbatim `\keywords{}` from v1N.0.5) | CQG guidelines page + arxiv/paper1bc_ech_note/main.tex |
...
| Title | **FINAL — "The Largest Test of a Preferred Galaxy-Spin Axis: An 8.47-Million-Galaxy DESI Chirality Catalog, a Void-Environment Contrast, and a Sensitivity Confrontation with the Rotating-Black-Hole-Universe Prediction"** (`pipelines/p4prime_chirality_test/paper/main.tex` v4P.0.7 — P5 folded in as the void-environment contrast; v4P.0.7 adds the row-16 (iv-b) BGS environment result only, abstract text unchanged) | pipelines/p4prime_chirality_test/paper/main.tex |
...
above are now FINAL (v4P.0.7, P5 folded in as the void-environment
...
injection) clear and Houston confirms its target venue/article type.
...
- ECH Note (v1N.0.5) and P4′ (v4P.0.7) manuscripts ARE compiled, merged
