...
|---|---|---|---|---|
| C1. NaMaster pipeline validation at fsky=0.85 + 0.65 | P1B (#A3-4) | ~4h CPU | published analyses use 0.85/0.65; ours validates only 0.32 | **DONE 2026-06-09 19:53 UTC (71 min, NSIDE=512 full fidelity)** — recovery bias −0.033° (0.85) / −0.034° (0.65), statistically identical to canonical 0.32 (0.032°): bias is fsky-INDEPENDENT apodization property, ≪ σ_β^obs=0.094° everywhere. Integrated → P1B v1B.0.49 §IV. Artifact: reproducibility/p1_namaster_500mc/results/c1_fsky_sweep.json |
...
| C5. P1B Caγ continuous grid MCMC [4,60] | P1B (#A3-5) | 25 min (!) | original prior [1,30] truncates data-required [9,51] | **DONE 2026-06-09 19:52 UTC** — converged R̂−1=0.0095, 8,955 samples / 4 MPI chains. Median Caγ=20.7, 16-84% [7.3,45.6], **69% of posterior mass in EOM-required [9,51]**; β posterior 0.326°±0.099° matches obs 0.342°±0.094°. Old [1,30] prior truncated ~28% of mass above 30 → rerun was necessary. Integrated → P1B v1B.0.49 (incl. EB-likelihood wording fix + regenerated triangle). Chains: research/branch_R_alp_birefringence/phase2_mcmc/chains/c5_continuous/ |
