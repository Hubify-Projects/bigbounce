...
canonical_pdf: P1A → arxiv/paper1a_ech_nogo.pdf (832,528 bytes / 20 pp / 0 undef refs / md5 6452b513; mirrored byte-identical to public/papers/ + site/public/papers/). P1B → arxiv/paper1b_mcmc_companion.pdf (699,400 bytes / 11 pp / 0 undef refs / md5 263ec963; mirrored byte-identical to public/papers/ + site/public/papers/).
version: P1A v1A.0.35 + P1B v1B.0.30 (both §4.4.1-cascaded-loop-confirmed as of 2026-05-26 portfolio milestone, held through 2026-05-28). Legacy v2.3.18 long-form refers to the deprecated arxiv/main.tex.
headline_pct: 100
