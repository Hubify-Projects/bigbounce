...
canonical_pdf: pipelines/p5_desi_chirality/paper/p5_desi_chirality.pdf (927,499 bytes / 17 pp / 0 undef refs / md5 75a76e1c; mirrored byte-identical to public/papers/ + site/public/papers/ + site/out/papers/)
version: v0.1.32-2026-05-26 (§4.4.1 cascaded-loop-exit satisfied; tick 200 R10+R11+R12 cross-model rotation + R-ext-v2 + R-ext-v32verify + R-ext-maint×4 all 5/5 PERFECTLY CLEAN through 2026-05-28; Gemini-M1 RSD anisotropy + Gemini-M2 ALP-density EFT + Gemini-M3 Alexander&Yunes+Lue-Wang-Kamionkowski foundational citations all closed in v0.1.32)
headline_pct: 95
