...
headline_pct: 85
submission_status: PAPER FULLY DRAFTED + SIX-DECOMPOSED CLUSTER-BOUNDARY-LEAKAGE + THREE-ALGORITHM DESIVAST ROBUSTNESS + CATALOG-NATIVE V2 GALZONE MEMBERSHIP (cron fires #25 / #33-#36 / #40-#41 / #43-#45 / #47 / #49, ticks 146-171) — 26 pp LaTeX. New since v0.1.16: catalog-native V2 membership cross-check (fire #49) using DESIVAST's own GALZONE+ZONEVOID zone-to-void mapping joined by DESI TARGET ID (cleaner than fire-#47 sphere-approximation). V2-REVOLVER catalog-native n_void=86,276 f_CW=0.4996 σ=−0.24 (near-perfect null; cleanest single chirality-in-voids measurement at n>80,000 in P5). V2-VIDE catalog-native n_void=64,514 f_CW=0.4979 σ=−1.06. Catalog-native σ values are smaller in magnitude than sphere-approximation analogues, confirming the DESIVAST-anchored chirality null sharpens when restricted to catalog-internal high-confidence void members. Cluster −4.7σ now SIX-decomposed. PDF 780 KB / 0 overfull / 0 undef refs / 0 undef cites. arXiv tarball pre-built + smoke-tested standalone at arxiv/submission_tarballs/p5_v0.1.17_arxiv.tar.gz (444 KB). First R-round blocked on OpenRouter per-key weekly cap. Remaining gates: first R-round + Houston sign-off + arXiv endorsement.
---
