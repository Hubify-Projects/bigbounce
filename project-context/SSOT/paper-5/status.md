...
type: ssot
paper: 5
last_updated: 2026-06-10 PDT, late night (pod session: stratified Phase-2 LEE + void-membership null + z-tail no-op; v0.1.55 -> v0.1.56-2026-06-10)
canonical_source: pipelines/p5_desi_chirality/paper/p5_desi_chirality.tex
canonical_pdf: pipelines/p5_desi_chirality/paper/p5_desi_chirality.pdf (27 pp / 0 errors / 0 undef refs / md5 4061bf5c; mirrored to site/public/papers/p5_desi_chirality_v0.1.56.pdf)
version: v0.1.56-2026-06-10 (pod-session wave; md5 4061bf5c / 27 pp / 0 errors / 0 undef refs; mirror site/public/papers/p5_desi_chirality_v0.1.56.pdf). Prior: v0.1.55-2026-06-10 (unique-TARGETID parent rebuild wave; md5 d07c14e8). Earlier: v0.1.54-2026-06-10 (R24conf closure wave; md5 1d42599a). Earlier: v0.1.53-2026-06-09 (R23conf closure wave; md5 b86b03f9). Earlier still: v0.1.44-2026-06-03 (R-upgraded-round9 closure bundle: title retitled to lead with DESIVAST primary path; "strongest/largest-sample" wording softened; RSD anisotropic-eigenvalue reframing 3-way; PER-M1 abstract DESIVAST scope tightened; GEM-m1 "any future model" scoped to bounce-chirality coupling class @ 25 Mpc/h; §XI.B retitled; 380-line preamble changelog stripped & archived. Cascaded-exit counter rolled back to 0/3 per synthesis; next round = R-upgraded-round10. Toy EFT appendix RETAINED with v0.1.41 caveat per Houston decision.)
headline_pct: 92
...
**🎯 Last authoritative update: 2026-06-10 (PDT, late night) — P5 v0.1.55 → v0.1.56-2026-06-10 — POD SESSION CLOSED QUEUE #17–19 (stratified Phase-2 LEE + void-membership + z-clamp); #16 randoms-data-missing DOCUMENTED.** Pod-session results: (a) **stratified Phase-2 LEE rerun (#17 CLOSED)** — leg×program-stratified global max-stat p = 0.36 / 0.27, headline null robust under the look-elsewhere stratification; (b) **void membership (#18 CLOSED)** — maximal-sphere vs any-hole membership definitions BOTH null; (c) **z-clamp sensitivity (#19 CLOSED)** — the 1.7<z≤2.0 clamp is a no-op: zero galaxies above z=1.6979 in the matched sample; (d) **#16 (completeness-weighted δ) blocked-and-documented** — DESI LSS randoms not on disk; the data gap is disclosed in-text and the row stays open until the randoms are acquired. PDF 27 pp / 0 errors / 0 undef refs / md5 4061bf5c, mirrored to site/public/papers/p5_desi_chirality_v0.1.56.pdf. **Readiness 91 → 92** (pod queue emptied of runnable substantive items). **Close-the-gap: R26conf cross-vendor round clean on v0.1.56 → Houston external round + sign-off → arXiv (last in queue, after P4; tarball rebuilding as paper5_arxiv_v0.1.56.tar.gz — supersedes the v0.1.55 build).**
