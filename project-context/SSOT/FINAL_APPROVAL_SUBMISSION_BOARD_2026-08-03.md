# Final approval, endorsement, and submission board
...
- All six papers remain **95/100** under Directive P: the complete agent gate is
...
| P3 | ApJS | READY | Sign-off; live corridor/UAT/data-asset/fee choices | NOT STARTED |
...
Recommended journal order after approvals: **P2 → P1A → P3 → P4 → P1B → P5**.
This clears the simplest current packets first while preserving the archive and
reviewer-information dependencies.
...
| `L8TIPN` | astro-ph.IM · P1B/P3 | Same | READY | NO | NONE | NO |
