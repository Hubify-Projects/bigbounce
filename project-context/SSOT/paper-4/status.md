...
Last authoritative update: 2026-05-01 (PDT, 07:59) — **R42 Wave 11-G LANDED**: hemisphere look-elsewhere null v3 retired the P4 skeptic-channel triplet **P4-CM-B2 + P4-CM-m2 + P4-OA-M8** in a single 1874s Pod 3 fire — vectorized chunked float32 max-statistic null over 768 healpix directions (NSIDE=8) on the 8.47M-galaxy catalog (3,201,160 spirals: 1,592,107 CW + 1,609,053 CCW). **max\|A\|(data) = 8.530930e-3 at dir #731 (RA, Dec) = (78.75°, −66.44°)** vs max-null mean 6.692e-3 / median 6.635e-3 / p99 7.635e-3; **look-elsewhere-corrected global p-value = 0.001996** (0/500 nulls reached the data — at the precision floor 1/501 of the 500-MC budget). N_MC reduced 1000→500 vs original spec to fit Pod 3's 2 GB system RAM (hemisphere boolean was already 2.46 GB). Result is a positive surviving-correction signal at the LEE-corrected level — NOT a flat null — and is consistent with the §validation hemispheric PASS direction at the catalog level. Promotion path: N_MC=10,000 on a higher-RAM pod is queued as a Wave 12 micro-task. Artifact: `pipelines/h200_results/wave11g_hemi_2026-05-01/{results.json, max_null.npy, wave11g_hemi_v3.log, wave11g_hemi_v3.py}`.
