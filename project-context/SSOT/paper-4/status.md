...
Last authoritative update: 2026-05-01 (PDT, 07:30) — **R42 Wave 11-C closed: version-bump v1.0.5 → v1.0.6, date 02:55 → 07:30 PDT.** P4-CM-B1 + P4-OA-M7 (NaMaster shot-noise N_spiral fix), P4-OA-B3 (confidence calibration contradiction), and P4-OA-B1 (NS-count abstract/§1/§3/conclusion language) all closed in this commit; numerical recompute artifact at `pipelines/h200_results/wave11c_nspiral_recompute_2026-05-01/results.json`. **PDF is STALE pending pod recompile** (local Mac has no LaTeX; main thread will batch on H200/H100).
