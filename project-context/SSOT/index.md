...
Last authoritative update: 2026-04-17 (post P1/P2/P3/P4 PDF-RECOMPILE + P1-CORNER-PLOTS + P4-DIPOLE-JSON-REBUILD)
...
|---|---|---|---:|---|---|---|
| **1** | **Spin-Torsion Cosmology** | v2.3.0, 27 pp, 63+ refs, 10+ revision rounds. Most mature paper. β = 0.264° ALP already integrated (L391). **2026-04-17:** P1-LINE-299-WORDSMITH ✓ + P1-FIGURES-VERIFY ✓ + P1-WIKI-SYNC ✓ + P1-TARBALL (partial) + **P1-PDF-RECOMPILE ✓** (707 KB, 0 undef) + **P1-CORNER-PLOTS ✓** (H0=67.69±1.06, ΔNeff=-0.019±0.169 on 119,617 samples). Remaining: site sync, insert corner figure into §IV text. | **99.5 %** | 7 queue tasks — 5 done + 1 partial + 1 open (P1-SITE-SYNC) | `arxiv/main.tex` | [paper-1/status.md](paper-1/status.md) |
| **2** | **f_NL Forecast (SPHEREx / MegaMapper)** | v1.6.0, 375 lines, 6 figures. Science complete: σ(f_NL) forecasts, Bayes factors 8–17, bias validation 1.58× on Gold+Silver QSOs. **2026-04-17:** P2-CURRENT-STATUS-SYNC ✓ + P2-WIKI-POINTER ✓ + P2-XREF-AUDIT ✓ + P2-REVTEX4-2-CONVERT ✓ + P2-TARBALL ✓ + **P2-COMPILE-POD ✓** (614 KB, 0 undef, abstract+sec:viable fixed) + **P2-BIB-RESOLVE ✓** (0 `[?]`) + **P2-PDF-PUBLISH ✓** (file committed). Remaining: site sync. | **97 %** | 9 queue tasks — 8 done + 1 open (P2-SITE-SYNC / paper.html link) | `research/focused_paper_source_integration/02_full_draft.tex` | [paper-2/status.md](paper-2/status.md) |
| **3** | **Multi-Survey Anomaly Catalog** | Locked 2026-04-16. 8 surveys · 37.3 M sources · 319,443 anomalies · 58.8 % novel · σ(f_NL) +16.4 % · SPHEREx 4.38σ · NANOGrav γ = 3.20 ± 0.42. **2026-04-17:** **P3-PDF-RECOMPILE ✓** (27 MB, 27 pp, 21 figs embedded, 0 undef). | **99 %** | 8 queue tasks — 2 done + 6 open (P3-A..C, figures.html, data-explorer.html, HF upload) | `pipelines/p3_anomaly_engine/paper3_draft.tex` | [paper-3/status.md](paper-3/status.md) |
| **4** | **Galaxy Chirality Catalog** | Science-complete. 8.47 M galaxies · 8/8 bias tests · 0.43σ null dipole · Shamir refuted 7×. **2026-04-17:** **P4-DIPOLE-JSON-REBUILD ✓** (80-line JSON from log, no re-compute) + **P4-PDF-RECOMPILE ✓** (25 MB, 11 pp, 0 undef) + P4-HF-DOI ✓. | **98 %** | 7 queue tasks — 3 done + 4 open (P4-PDF-CANON, site sync, P2 cross-ref, LSST line) | `pipelines/p2_chirality/chirality_catalog_paper.tex` | [paper-4/status.md](paper-4/status.md) |
