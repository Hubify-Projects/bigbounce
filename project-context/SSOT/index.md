...
| **3** | **Multi-Survey Anomaly Catalog** | Locked 2026-04-16. 8 surveys · 37.3 M sources · 319,443 anomalies · 58.8 % novel · σ(f_NL) +16.4 % · SPHEREx 4.38σ · NANOGrav γ = 3.20 ± 0.42. **2026-04-17 fire #9:** fresh compile via Docker TeX Live — **28 MB PDF, 0 undefined refs**, Siemens2013 + Rosado2015 bibitems rendered, 3 Golden companion-paper cross-refs rendered, §6 "when-decisive" paragraph rendered, mirrored to `public/papers/paper3_anomaly_catalog.pdf`. | **100 %** | 8 queue tasks — 5 done + 3 deferred (P3-A TESS periodicity, P3-B archival deep cross-match, P3-HF-UPLOAD — all non-blocking for arXiv acceptance) | `pipelines/p3_anomaly_engine/paper3_draft.tex` | [paper-3/status.md](paper-3/status.md) |
...
**Program-level arXiv ETA:** All four papers compile cleanly via Docker TeX Live as of 2026-04-17 — revtex4-2, **0 undefined refs across all four**, figures embedded (945 KB / 632 KB / 28 MB / 25.7 MB). All four PDFs mirrored to `public/papers/`. Paper 1 tarball rebuilt clean (440 KB, 3 figures, clean-revtex smoke-tested). **All four papers are at 100 % on the content + compile axes.** The only remaining open items are (a) Houston's one-line review of the LSST projection line in Paper 4 (P4-LSST-LINE-REVIEW) and (b) Houston-owned arXiv submission (fill the arXiv form for each paper). Recommended submission order: Paper 4 → Paper 3 → Paper 1 → Paper 2.
