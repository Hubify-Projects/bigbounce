...
Last authoritative update: 2026-04-20 (drive-to-100 fire #117 — P3-PATHC-DESI-KFOLD criterion #4 advanced 0 → 20 % by staging `pipelines/p3_anomaly_engine/pathc_desi_kfold/{desi_kfold_plan.md, train_desi_kfold.py, aggregate_kfold.py}` (3 files, ~450 lines). Plan specifies 5-fold split of the published 47K DESI training sample with gate val_loss ≤ 0.30 and Jaccard ≥ 0.70 at top-1%. Launch-blocked on SDSS + LAMOST natives freeing A100 (ETA ~26 / 36 h). Compute budget ~$6 total, well under cap. SDSS rescore flushed 130 → 135/471 as predicted (ETA 35.8h); LAMOST 410 → 420 nights (ETA 26.3h). Budget ~$56.20/$400.)
