...
Last authoritative update: 2026-04-20 (drive-to-100 fire #116 — P3-PATHC-DEDUP-LOCAL advanced 5/8 → 6/8 surveys loaded by staging ACT DR6 cross-transfer top-200 parquet + updating SURVEYS registry to load ACT from the cross-transfer catalog (honest Path-C framing matching fire #114 status.html: ACT is NOT native-retrained — CMB coverage via Planck native fire #95 — ACT joins dedup for multi-survey coincidence search only). Re-ran dedup: 197,246 → 197,446 detections (+200 ACT), 191,432 → 191,632 unique physical objects, 0 multi-survey matches preserved. Criterion #7 bumped 70 → 80 %. SDSS rescore 130 → 135/471 flush expected in ~13 min (ETA 36h); LAMOST 400 → 410 nights (ETA 26h). Budget ~$55.80/$400.)
