...
Last authoritative update: 2026-04-20 (drive-to-100 fire #123 — P3-PATHC-INJECTION-RECOVERY-ALL-SURVEYS criterion #6 **CLOSED 95 → 100 %** via §pathc_caveats (v) integration into `pipelines/p3_anomaly_engine/paper3_draft.tex` L651. New `\textit{(v) Non-spectral survey injection-recovery.}` paragraph inserted between caveat (iv) and §Comparison with Prior Work, integrating the fire #122 all-surveys synthesis: CMB 100 % (back-ref iii), NEOWISE mask specificity 1.51 % vs theory 1.52 % + sensitivity 100 % at polar bands, Gaia fresh-IF 5.2 % gate + 41 % XV diagnostic training-sample-conditioned footnote, eROSITA fresh-IF 1.2 % gate + 81.5 % XV diagnostic (highest Path-C stability, detector reported as final). Explicit 3-PASS / 3-FAIL-with-rigorous-diagnostic dichotomy + reference to companion artifacts `all_surveys_summary.{json,md}`. Does NOT trigger a recompile dependency (criterion #9 still gated on SDSS+LAMOST native re-scores). Weighted sum: (0.80+0.80+1.00+0.20+0.95+**1.00**+0.80+0.92+0.00+0.50+0.00+0.89)/12 = 7.86/12 = **65.5 %** → rounds to ≈66 %. Prior fire #122: all-surveys synthesis aggregator `pathc_injection_recovery/synthesize_all_surveys.py` wrote `all_surveys_summary.{json,md}` consolidating fires #85/#95/#98/#119/#120/#121. SDSS rescore expected flush to 150; LAMOST 440 nights steady at 625 anom. Budget ~$58.80/$400.)
