...
Last authoritative update: 2026-04-20 (drive-to-100 fire #113 — Paper 3 §7.4 (iii) CMB CLOSED rewrite: caveat (iii) converted from pre-fire-#95 "If gate met / withdrawal fallback" pending language to explicit "CLOSED" state with fire-#95 metadata (val_loss 0.4437, 500/500 @5σ, 25.3s A100 re-score) + SMICA-only second-map post-submission extension flagged as new scientific follow-up. Integration criterion #8 bumped 90 → 92, overall Paper 3 % edges 59 → 60. SDSS rescore advanced batch 120 → 125/471 (26.5% done, ETA 36.5h); LAMOST 360 → 380 nights (32.3% done, ETA 27.1h).)
