...
| **4** | Galaxy Chirality Catalog | **100 %** | Wave 12 LANDED — direct-MC hemisphere look-elsewhere null on H200 GPU at N_MC=10,000 (NSIDE=8, 768 dirs, 3.20M spirals): max\|A\|(data) = 8.531e-3 at dir #731 (RA=78.75°, Dec=−66.44°), zero of 10,000 nulls reach the data → **p_LEE = 9.999e-5** (precision floor 1/10001). Tightens the Wave 11-G v3 floor (1/501) by an order of magnitude in 17.2 s wall (4.8 s MC at 2,098 MC/s, ~10 GB / 143 GB H200 VRAM). Wave 11 N_spiral=3,321,795 shot-noise correction to NaMaster footnote-5 still in force (cross-confirmed P4-CM-B1 + P4-OA-M7). PDF recompiled (25.78 MB / 16 pp / 0 undef refs, May 1 07:30 PDT, v1.0.6 — v1.0.7 with Wave 12 hemi footnote pending bundled commit). **Self-contained, submission-locked.** |
