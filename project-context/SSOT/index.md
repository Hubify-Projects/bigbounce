...
Last authoritative update: 2026-04-20 (drive-to-100 fire #115 — explained.html "Multi-Survey Extension" paragraph Path-C catchup: pre-rebuild "Four surveys passed quality gates; the other four have identified systematics ... queued for re-runs with proper masks" language replaced with "cross-transfer" qualifier on the 319,443/58.8% headline + amber-bordered plain-English Path-C rebuild callout (SDSS/LAMOST native gate-PASS + Planck CMB 100% @5σ + NEOWISE ecliptic mask + 197,246 → 191,432 unique physical objects + before/after baseline framing + drive-to-100.md pointer + public GitHub repo link). Site-sync criterion #12 bumped 87 → 89. SDSS batch flushed 125 → 130/471 (+5, ETA 36.2h); LAMOST rescore advanced 390 → 400 nights (ETA 26.4h). Budget ~$55.40/$400.)
