...
Last authoritative update: 2026-04-20 (drive-to-100 fire #114 — status.html survey table Path-C catchup: Planck CMB + ACT DR6 + NEOWISE rows refreshed from pre-fire-#95 red "QC FAIL / Needs Re-run" badges to current Path-C state (Planck green CLOSED fire #95, NEOWISE green CLOSED fire #84, ACT DR6 amber cross-transfer-baseline honest framing). Site-sync criterion #12 bumped 85 → 87. LAMOST rescore advanced 380 → 390 nights (ETA 26.7h); SDSS batch 125/471 UNCHANGED — flush-boundary artifact pattern again as in fire #112.)
