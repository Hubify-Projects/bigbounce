...
**Current versions (EXT3-closed, mirrored, tarballed):** P1A **v1A.0.61** · P1B **v1B.0.58** · P2 **v1.7.53** · P3 **v3.1.94** · P4 **v1.0.175** · P5 **v0.1.65-2026-06-11**.
...
### P3 — Multi-survey anomaly catalog (pipelines/p3_anomaly_engine/paper3_draft.tex, v3.1.94)
