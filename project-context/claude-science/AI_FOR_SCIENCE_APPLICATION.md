...
1. **P4 chirality robustness battery**: full-catalog GZ1-only re-inference (the completed run was reduced-N), empirical b/a axis-ratio cross-match (a Gemini MAJOR), and the ≥200-random-axis harmonic injection battery for the look-elsewhere null (an OpenAI MAJOR).
