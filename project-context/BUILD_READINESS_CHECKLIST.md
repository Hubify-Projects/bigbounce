...
**L status:** 10/12 = 83% — L1 (sidepeek kill iter 1) + L2 (detail breathing room) + L3 (dead sidepeek DOM+CSS deleted) + L4 (rename pass) + L6 (Director rebuild) + L7 (papers full pages) + L8 (sidebar drastic reduction) + L9 (projects-as-threads) + L11 (Lab Dossier 10-section) + L12 (Chats scope-organized) shipped. L5, L10 remain.
