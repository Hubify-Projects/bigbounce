...
**L status:** 3/12 = 25% — L1 (sidepeek kill iter 1) + L6 (Director rebuild) + L8 (sidebar drastic reduction, this iteration) shipped. L2-L5, L7, L9-L12 remain.
...
| **L. UX rebuild (kill sidepeeks · director · papers · dossier)** | **3** | **12** | **25%** |
| **OVERALL** | **152** | **172** | **88.4%** |
