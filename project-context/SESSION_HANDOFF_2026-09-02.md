...
| Pod 8ofv5d4ynu7hku phase 3 | monitor | COMPLETE 2026-09-03 15:18Z (enrichment 3128/3128 zero errors 18:08→03:50Z; SIMBAD/NED 03:50→13:19Z; WISE 13:19→15:17Z; taxonomy 15:17→15:18Z); landing lane running (v1 artifacts, labelled SAMPLE-V1-CONTAMINATED; POD STOP HELD). FINDING: S>8 sample 84.8% sky fibers (negative TARGETID/OBJTYPE=SKY) — see ANOMALY_SAMPLE_CONTAMINATION_2026-09-03.md; corrected run: pipeline code landed (build_flagship_sample.py --science-targets-only, gates/check_sample_provenance.py, 33/33 tests; a0ecb4d8); unattended v2 chain (pod_phase3_v2.sh, 3bf6d65f; stage-3 fix 66f59e79) running: science-only S>3 1,244 / S>4 152 / S>5 44 / S>8 2; sky fraction >99.5% per bin; threshold 3 chosen by the pre-declared rule (1,244 objects); enrichment→crossmatch→WISE→taxonomy in progress; monitor armed for PHASE3_V2_DONE; public candidate counts being restated as raw-row counts (site/Convex lane) |
