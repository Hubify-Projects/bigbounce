...
SPLITS = {
    "gallat_high": lambda d: np.abs(gal_b(d["RA"], d["DEC"])) > 40,
    "gallat_low": lambda d: np.abs(gal_b(d["RA"], d["DEC"])) <= 40,
    "photsys_N": lambda d: d["PHOTSYS"] == b"N",
    "photsys_S": lambda d: d["PHOTSYS"] == b"S",
}
