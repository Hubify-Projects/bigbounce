...
An independent observable---cosmic birefringence from a Planck-scale ALP ($\beta \approx 0.27^\circ$, consistent with the $3.6\sigma$ Eskilt \etal~\cite{Eskilt2022} joint Planck analysis and the $2.9\sigma$ ACT~DR6 measurement (Diego-Palazuelos \etal~\cite{DiegoPalazuelos2025}))---provides a complementary test of bounce-motivated physics through NaMaster pseudo-$C_\ell$ EB cross-power analysis on Planck SMICA data (Minami~\&~Komatsu~\cite{Minami2020} methodology).
