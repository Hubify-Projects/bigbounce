...
\end{equation}
where $\Gamma$ is any region of phase space. The bounce, being governed by the modified Friedmann equation (Eq.~\ref{eq:modfriedmann} of Paper~I), is a smooth, time-reversible Hamiltonian flow. It cannot irreversibly contract the accessible phase-space volume.
...
This dilemma is a manifestation of the technical naturalness problem~\citep{tHooft:1979nat}: a small parameter ($H_0/\Mpl$) is natural only if setting it to zero enhances the symmetry of the theory. No bounce mechanism provides such a symmetry.
