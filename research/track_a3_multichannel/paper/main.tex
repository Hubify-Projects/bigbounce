...
\textit{Scope statement.}---The factor of two has \emph{not} been settled by an
independent second-method derivation (for example a Salopek--Bond gradient
expansion or a $\delta N$ computation). We therefore never state a channel result
at $-35/16$ alone where the two values differ materially.
