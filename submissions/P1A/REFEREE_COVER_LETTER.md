# Cover Letter — Paper 1A

**Title area:** An Einstein–Cartan–Holst (ECH) spin-torsion channel assessment of late-time dark energy
**Source:** `arxiv/paper1a_ech_nogo.tex`
**Suggested venue:** Physical Review D

Dear Editor,

Please consider this manuscript for publication. This cover letter states its
contribution, scope, and known limitations honestly, so the referee can judge
the paper against what it actually claims.

## Contribution
The paper assesses four enumerated minimal-ECH spin-torsion channels (R1 NJL
contact; R2 one-loop effective action; R3 Immirzi running; R4 parity-CMB
coupling) as candidate sources of late-time dark energy, and finds each
constrained under stated assumptions. Its most rigorous result is a
**perturbation-transparency result**: for canonical scalar matter, the Holst
dual contraction vanishes identically on the torsion-free branch by the
algebraic Bianchi identity, so the Holst sector decouples from all scalar/tensor
perturbation equations of motion. This is a Tier-I, operator-level statement and
was truth-audited as sound (an earlier reviewer misread of the underlying
variational argument has been clarified in the text, not by weakening the
result). The two previously-omitted parity-odd operators (Jackiw–Pi
gravitational Chern–Simons; parity-odd four-fermion partner) are now closed
