...
| 4 | **P2** f_NL forecast + Cai/Li resolution | `submissions/P2/arxiv_p2_v1.7.96.tar.gz` (md5 0f137b32) | v1.7.96 | 34 | Positioned as honest forecast + the −35/16 literature resolution. v1.7.96 DATA-UNLOCK: named Cov_B gate strengthened — Heinrich 2023 per-triangle bispectrum covariance confirmed NOT publicly released, so the ρ=−0.868-proxy bracket is the best currently-constructible estimate. Zenodo DOI at submit. |
