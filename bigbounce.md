...
Regarding observational evidence, galaxy spin asymmetry claims remain actively disputed. Comprehensive reanalyses by Patel & Desmond (2024, arXiv:2404.06617; 2025, MNRAS) find all publicly available galaxy-spin datasets consistent with isotropy within 3σ, indicating no statistically significant dipole anisotropy. Shamir (2024) contests these conclusions, arguing that Patel & Desmond's Bayesian method fails to detect asymmetries even in artificially biased datasets, and maintains that simpler chi-squared analyses show reproducible evidence across multiple sky surveys. Small JWST samples show marginal asymmetries (e.g., 24 of 34 spirals clockwise in one field, p ≈ 0.012; Webb's First Deep Field shows 21 counterclockwise vs 19 clockwise, nearly 50/50), but these suffer from small-number statistics and potential systematics (sky-location correlations, redshift-dependent effects suggesting solar motion or selection bias). The cosmological principle predicts isotropy; no observational consensus yet contradicts this prediction. Planck measurements suggest cosmic birefringence at β = 0.35° ± 0.14° (2.4σ), a hint that may reflect residual systematics and requires confirmation by next-generation experiments.
