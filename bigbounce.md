...
We outline—but do not execute—a full Bayesian parameter-inference framework (Section 3.6) that would be necessary to quantitatively assess whether this model alleviates the Hubble (H₀ = 67.36 ± 0.54 vs 73.04 ± 1.04 km s⁻¹ Mpc⁻¹, ~5σ tension) and matter-clustering (S₈ discrepancy ~2–3σ) tensions. Without marginalized posterior distributions, Bayes factors, or MCMC fits comparing this model to ΛCDM, we cannot claim tension alleviation; we present only qualitative motivation for why geometric effects might contribute. Any quantitative assessment is deferred to future work. This manuscript focuses on rigorous theoretical derivations, transparent statement of assumptions, and falsifiable observational predictions to guide experimental tests over the coming decade.
