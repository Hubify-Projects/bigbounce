...
- **P5** v0.1.26-2026-05-23 — **separate companion**: Environmental dependence of spiral chirality across DESI LSS. Paper R-round-clean per AGENT_RULES §4.4.1 (29 pp / 907 KB) covering Phase 1 V-Web + Phase 2 sensitivity sweep + Tempel+2014 FoF cross-validation + LEE correction + 6 figures + RSD-robustness + **§sec:tweb_compare three-VAC concurrent-literature cross-validation + direct DESIVAST per-galaxy cross-match + DESIVAST-anchored void classifier + three-algorithm DESIVAST robustness + catalog-native V2 GALZONE membership** (T-Web DR1 arXiv:2604.02463, ASTRA EDR arXiv:2604.01456, DESIVAST DR1 BGS arXiv:2411.00148 / ApJ 982 38; per-galaxy 0/6 V-Web void spirals inside DESIVAST holes; DESIVAST-anchored void classifier at n=56,981 = 133× V-Web sample → Δf_CW=0.0007 statistically indistinguishable; three-algorithm robustness on VoidFinder + V2-REVOLVER + V2-VIDE — all three |Δf_CW|<0.002; **catalog-native V2 membership via GALZONE+ZONEVOID joins — V2-REVOLVER σ=−0.24 near-perfect null on n=86,276**) + **§sec:results_within_class_density cluster-class 6-decomposed boundary-leakage** (density Q3-null + z uniform + tracer-program bright-vs-dark sign-flip + DESIVAST-anchored re-analysis + 3-algorithm DESIVAST robustness + catalog-native GALZONE) + **filament-class within-class decomposition reproducing bright-vs-dark sign-flip on 2nd V-Web class** + **MAXIMAL voids HEALPix sky-position stratification (NSIDE=16, 3,765 maximal voids): catalog-level −5σ headline concentrated ENTIRELY in "0 maximal voids per pixel" bin (n=378,511 σ=−4.75); pixels WITH voids σ ∈ [−2.04, −0.09] all below Bonferroni-4; signal tracks survey-mask geometry NOT environment density — 5th independent positive evidence line** + **per-pixel Pearson r(N_voids, σ_chirality) = +0.006 (p=0.88) at NSIDE=32 across 727 valid pixels — quantitatively indistinguishable from zero correlation; new 2-panel Mollweide sky-map figure** + **abstract Robustness block (fire #60)** + **cross-survey P4-monopole-residual analysis (fire #62): subtracting f_CW^P5=0.4972 (the P4 9.5σ catalog monopole) ALL 4 V-Web classes fall within |σ_vs_monopole|<1.15 (void −0.56, wall +1.01, filament +0.99, cluster −1.11); per-pixel residual distribution mean+0.020/std 1.184/skew+0.044 — cleanest single-test demonstration that V-Web class deviations are monopole-projection, not environmental — 6th independent positive evidence line** + **internal Claude methodology R1 review (fire #64) closed 4 MAJORs + R2 verification (fire #67) returned 0 BLOCKER + 0 MAJOR meeting §4.4.1 cascaded-loop-exit; R2 caught + corrected fire-#64 cluster-side joint-z computation error (cluster joint z=−0.52σ NULL, not 3.4σ; filament joint z=−3.4σ stands): Bonferroni arithmetic corrected (K=5 α=0.01 was 2.81 → 3.09; K=4 α=0.01 was 3.29 → 3.02), 791,635 vs 812,793 row totals reconciled, "5 independent" → "4 complementary" with VoidFinder/ZOBOV-axis qualifier, bright-vs-dark joint z=3.4σ quantified, range 1.7pp → 1.98pp, Pearson r robustness across NSIDE/threshold added, n=6 DESIVAST 0/6 demoted to sub-clause, monopole-residual at HEALPix bins quantified (−1.55σ at 0-voids/pix, +0.60σ at 6+/pix)**. Readiness 95% — ALL 6 PAPERS NOW AT THE SAME 95% CEILING. PDF 0 overfull / 0 undef refs / 0 undef cites. Pipeline at `pipelines/p5_desi_chirality/`. SSOT: `project-context/SSOT/paper-5/status.md`. **First R-round still blocked on OpenRouter per-key weekly cap.**
...
- w0-wa bound discussed theoretically only — not implemented computationally in this program (Paper 1 §VII.H explicitly: zero free-w0-wa samples among the 309,189 frozen posterior samples; earlier "quintom-B at 98.6%" bookkeeping was fire-#21 confabulation, corrected fire #25; "309,789" headline corrected to "309,189" at cron fire #79 tick 201 R25a-BLK-1 close after direct chain row count = 176,240 + 132,949 = 309,189)
- MCMC verification: ΔNeff ≈ 0 in all datasets; H₀ = 67.68 (standard ΛCDM)
- 309,189 MCMC posterior samples across 2 frozen dataset combinations (Paper 1(b) canonical figure: 176,240 + 132,949 = 309,189; corrected fire #79 tick 201 from earlier "424,781 + 3 frozen + 176,840 + 114,992" headline that confabulated a third never-frozen Planck-only dataset and a 600-sample paper-side typo in the full_tension count; ground-truth is reproducibility/cosmology/frozen/full_tension_20260311_1728 = 176,240 lines + reproducibility/cosmology/frozen/planck_bao_sn_20260312_1954 = 132,949 lines; no third frozen directory exists)
