...
- **P5** v0.1.10-2026-05-22 — **separate companion**: Environmental dependence of spiral chirality across DESI LSS. Paper fully drafted (23 pp / 745 KB) covering Phase 1 V-Web + Phase 2 sensitivity sweep (9 grid configs) + Tempel+2014 FoF cross-validation (filament concordance 0.026pp) + LEE correction + 6 figures + RSD-robustness Limitations item + **§sec:tweb_compare three-VAC concurrent-literature cross-validation** (T-Web DR1 arXiv:2604.02463 sheet/filament agree to ~5pp, ASTRA EDR arXiv:2604.01456 probabilistic-classifier complementary framing, DESIVAST DR1 BGS arXiv:2411.00148 / ApJ 982 38 void-subsample follow-up). PDF 0 overfull / 0 undef refs / 0 undef cites. Pipeline at `pipelines/p5_desi_chirality/`. SSOT: `project-context/SSOT/paper-5/status.md`. Readiness 75%. **First R-round still blocked on OpenRouter per-key weekly cap.**
