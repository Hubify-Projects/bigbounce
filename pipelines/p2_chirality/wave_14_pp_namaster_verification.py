...
Outputs:
  - /workspace/r42_wave14pp/results.json — full numerical record
  - /workspace/r42_wave14pp/cl_pseudo_data.npy
  - /workspace/r42_wave14pp/cl_pseudo_mc.npy
  - /workspace/r42_wave14pp/cl_deconv_data.npy
  - /workspace/r42_wave14pp/fig8_data.npz
"""
...
results = {
    "wave": "14-PP",
    "issue": "P4 B-1 NaMaster cross-seed verification (Wave 14-PP)",
    "n_total": int(n_total),
