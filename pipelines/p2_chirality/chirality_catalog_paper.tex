...
\newcommand{\paperVersion}{v1.0.188}
...
Stratifying Catalog~C by equivariant max-class probability into five bins reveals: the $+3.3\sigmaunit$ in the $1.87$M-galaxy $[0.5,0.6)$ bin does not survive the sample-purity ladder (cutting to $p_{\rm eq}\!>\!0.6$ gives $-0.03\sigmaunit$); results available in the public data repository (see Data Availability).
