...
\newcommand{\paperVersion}{v1.0.157}
...
\begin{table*}[t]
\caption{\label{tab:headline_summary}Headline-estimator summary. $N_{\rm catalog\,spiral}$ is the underlying Catalog~C spiral count; $N_{\rm map\,weighted}$ is the pixel-weighted galaxy count feeding the analysis-mask map.}
\begin{ruledtabular}
