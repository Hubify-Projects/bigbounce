...
\DeclareRobustCommand{\artifact}[1]{%
 ...
 \href{https://github.com/Hubify-Projects/bigbounce/blob/81c67790/\art@urlpath}{%
 \begingroup
 \let\_\artbreak@us
 \texttt{#1}%
 \endgroup
