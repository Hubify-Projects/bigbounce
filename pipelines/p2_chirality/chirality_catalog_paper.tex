...
Repository state for this version: commit \texttt{7c03bb64} (v1.0.172, June 2026); headline sample is HC-broad $N=949{,}584$ ($p_{\rm eq}>0.6$) spirals at this snapshot, with real-space dipole $+0.41\sigmaunit$ ($p=0.31$); a Zenodo DOI snapshot will accompany the journal submission.
