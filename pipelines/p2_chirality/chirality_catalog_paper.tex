...
\newcommand{\paperVersion}{v1.0.230}
...
\textbf{P2} clean-$1.7\%$ exclusion & block- & $z\!\approx\!-18$ \\
...
(g) WLS template fit & $z_{\rm boot}\!\approx\!-18.1$ vs.\ a clean $1.7\%$ dipole & \textsc{sys} \\
