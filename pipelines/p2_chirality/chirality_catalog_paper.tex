...
\newcommand{\paperVersion}{v1.0.156}
...
\begin{table}[t]
\caption{Global CW fraction across catalog tiers. Uncertainties are $1\sigmaunit$ binomial with $N_{\rm spiral}\!=\!3{,}201{,}160$. \label{tab:cw_frac}}
\begin{ruledtabular}
\begin{tabular}{lccc}
