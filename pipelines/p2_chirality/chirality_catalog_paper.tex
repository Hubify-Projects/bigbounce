...
\newcommand{\paperVersion}{v1.0.182}
...
\begin{table}[h]
\caption{Harmonic-channel ($\ell\!=\!1$ MASTER) injection-recovery completeness. Null: label-shuffle ($10^3$ injections/amplitude/axis; artifact c9b). $3\sigmaunit$ threshold uses the MASTER $\ell\!=\!1$ label-shuffle null (not the real-space convention). Median $z$ range is axis-dependent. \emph{Not interchangeable with real-space falsification boundary ($A_{50}\!\approx\!0.75\%$).}\label{tab:harmonic_completeness}}
\begin{ruledtabular}
\begin{tabular}{cccc}
...
\hline
Pixel count ($N_{\rm spiral}\!\geq\!10$) & $24{,}061$ & $24{,}061$ \\
