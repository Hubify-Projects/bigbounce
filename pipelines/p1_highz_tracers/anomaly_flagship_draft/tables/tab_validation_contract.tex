...
V6 & the taxonomy covers exactly the SIMBAD/NED-unmatched subset; 23 clusters roll up into 9 families; per-family counts sum to the unmatched count and match the per-object labels & \textsc{pass} \\
