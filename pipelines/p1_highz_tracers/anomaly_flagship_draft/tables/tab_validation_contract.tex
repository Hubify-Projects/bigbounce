...
V3 & the manifest chain closes end to end: sample -> enrichment -> cross-match -> taxonomy, each stage binding the exact SHA-256 of its input and output, under one run contract, with the model / inference-code / zcatalog hashes recorded & \textsc{pass} \\
