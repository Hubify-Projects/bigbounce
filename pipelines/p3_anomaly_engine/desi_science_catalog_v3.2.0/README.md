...
The two historical inputs are pinned at annotated tag `p3-v3.1.161`, which peels to commit
`cdaaa03a72c69d86f011be128d93f261dc5b39a8`. The DESI checksum was recomputed locally and matched
the current official checksum file at
`https://data.desi.lbl.gov/public/dr1/spectro/redux/iron/zcatalog/v1/redux_iron_zcatalog_v1.sha256sum`.
...
- `SELECTION_AUDIT.json` / `SELECTION_AUDIT.md` — independent rejoin, waterfall,
  distribution, separation-tail, null, duplicate, and provenance audit.
