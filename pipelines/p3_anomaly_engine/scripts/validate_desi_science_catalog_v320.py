...
def main() -> None:
    ...
    report = {
        ...
        "provenance": {
            ...
            "remote_range_parity": {
                "status": "PASS",
                "method": "Independent director compared local and live-remote 1 MiB byte ranges.",
                "matching_samples": 8,
                "offsets_bytes": [
                    0, 104857600, 1073741824, 5368709120, 10737418240,
                    17179869184, 21474836480, 22370224064,
                ],
                "note": "Full SHA-256 was computed locally and equals the current official checksum; remote parity was sampled, not a second 22 GB download.",
            },
        },
        "cross_checks": {
