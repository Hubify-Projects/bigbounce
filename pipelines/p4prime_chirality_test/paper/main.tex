...
\newcommand{\paperVersion}{v4P.0.4}
...
observed-label $95\%$ detection-power sensitivity floor
$A_{95}^{\rm obs}\simeq0.98\%$ (full-amplitude; the corresponding Neyman
$95\%$ CL upper limit on the measured amplitude is
$A_{95}^{\rm CL}\simeq0.75\%$, and we confront the model with the more
conservative floor). A companion DESIVAST
