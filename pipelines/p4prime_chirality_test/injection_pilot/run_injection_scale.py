#!/usr/bin/env python3
"""Row 13 Part A AT SCALE: pixel-level parity-injection test through the
...
IMG_SIZE = 224
BATCH = 64
CACHE_DIR = HERE / "cutout_cache_scale"
OUT_PATH = HERE / "scale_pairs.parquet"
CKPT_EVERY = 500
...
def main(limit=None):
    ...
    sample = pd.read_parquet(HERE / "scale_sample.parquet")
    if limit:
