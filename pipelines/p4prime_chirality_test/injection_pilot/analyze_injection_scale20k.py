#!/usr/bin/env python3
"""Row 16 step (ii): analyze the N=20,000 production-equivariant
...
def main():
    df = pd.read_parquet(HERE / "scale20k_pairs.parquet")
    n = len(df)
    ...
    (HERE / "scale20k_injection_results.json").write_text(json.dumps(summary, indent=2))
