...
\newcommand{\paperVersion}{v1A.0.79}
...
\node[below=0.12cm of R1, font=\footnotesize] at (5.1,-0.52) {\textit{All four routes closed (13 independent barriers)}};
...
logically-independent barriers are shown; B8 is not counted separately.
