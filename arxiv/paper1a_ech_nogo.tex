...
\newcommand{\paperVersion}{v1A.0.3}
\newcommand{\paperTimestamp}{2026-05-08 17:25 PDT}
...
\date{May 8, 2026, 17:25 PDT --- \paperVersion}
...
galaxies confirms the null at the dipole level (full numbers, including the
equivariant CW fraction, dipole significance, hemisphere look-elsewhere null,
and bias-audit suite, are reported in Paper~IV~\cite{Golden2026P4}; we do not
duplicate them here). Galaxy spin asymmetry is not a prediction of the theory.
...
An independent ViT-Small chirality classifier on $8{,}474{,}531$ DESI Legacy DR8
galaxies---the largest bias-audited catalog to date---returns a null all-sky
dipole; Shamir's claimed $3\%$ asymmetry is refuted at high significance.
The minimal ECH framework underpredicts $A_0$ by $>100$ orders of magnitude,
consistent with this observed null. Headline numbers (equivariant CW fraction
with monopole vs.\ dipole separation, hemisphere $p_{\rm LEE}$, dipole MC
injection-recovery threshold, full bias-audit suite) are reported in
Paper~IV~\cite{Golden2026P4} and are not duplicated here.
...
Survey galaxies. The catalog is $4.3\times$ larger than CE-ResNet and
$6.5\times$ larger than Shamir's largest catalog, and the equivariant
CW-fraction monopole and dipole are each consistent with the canonical
results of Paper~IV~\cite{Golden2026P4} to which we forward all explicit
numbers. The observational conclusion is the null result of
Sec.~\ref{sec:spinobs}: the all-sky dipole is null and Shamir's $3\%$
claim is refuted.
