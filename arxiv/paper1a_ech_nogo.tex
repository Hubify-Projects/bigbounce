...
\newcommand{\paperVersion}{v1A.0.12}
\newcommand{\paperTimestamp}{2026-05-09 14:00 PDT}
...
$^{\ddagger}$The frozen MCMC posteriors hosted in Paper~I(b) contain zero free-$w_0 w_a$ samples (see Paper~I(b) \S VII.H); the $w_0 w_a$ extension was never implemented computationally for any of these rows, so none of them carry a posterior-preference verdict against (or for) the DESI $w_0 w_a$ evidence. The asymmetry between the Quintom-B row and the others is one of theoretical accommodation, not of fit quality measured in this program.
\end{table*}
