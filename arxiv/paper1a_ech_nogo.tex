...
\newcommand{\paperVersion}{v1A.0.23}
...
required) and the $\fnl=-35/8$ prediction (\emph{definitively} erased by $N_{\rm tot}\gtrsim 60$ inflationary $e$-folds at SPHEREx-relevant scales; the SPHEREx accessible wavenumbers $k\sim 10^{-4}$--$10^{-1}\,h/$Mpc are pushed by inflationary expansion to bounce-era comoving scales $k\,e^{N_{\rm tot}}\sim e^{30}\times k_{\rm SPHEREx}$, deep inside the inflationary subhorizon regime where the surviving bispectrum signal is purely vacuum-inflationary, not matter-bounce contraction-mode). This
...
($\alpha/M \to \alpha\,\MPl^{2}/M$), promoting the operator to
$\alpha\,\MPl^{2}\,\varepsilon\,e\,e\,\mathcal{F}/M$. Either reading is a
