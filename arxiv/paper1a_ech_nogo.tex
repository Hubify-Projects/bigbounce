...
\newcommand{\paperVersion}{v1A.0.20}
...
Sec.~\ref{sec:four_routes}, would require $N_{\rm tot}\approx 92$ post-bounce
...
check} on the four-route amplitude-level no-go of Sec.~\ref{sec:four_routes}
