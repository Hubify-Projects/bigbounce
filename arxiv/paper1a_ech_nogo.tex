...
\newcommand{\paperVersion}{v1A.0.8}
...
\end{equation}
\textit{Derivation of Eq.~\eqref{eq:Dinf}.}---The two factors arise
from independent steps in the bounce-to-reheating matching and are
each derived rather than postulated. (i) The $\exp[-3N_{\rm tot}]$
