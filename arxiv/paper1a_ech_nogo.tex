...
\newcommand{\paperVersion}{v1A.0.98}
...
this is of order $10^{-2}$--$10^{-1}$. We therefore adopt
$\Delta\gamma/\gamma \sim 10^{-2}$ as a representative conservative
order-of-magnitude estimate --- \emph{not} a precisely derived value,
the full perturbative running being the $|\gamma|$-dependent
$\beta$-function of Benedetti~\&~Speziale~\cite{Benedetti2011} ---
and note that the Route-3 closure below is insensitive to its precise
value (taking the larger $10^{-1}$ end still leaves $\gtrsim 60$ orders
of suppression margin). The Holst sector amplitude that this running can source is
