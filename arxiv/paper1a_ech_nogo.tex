...
\newcommand{\paperVersion}{v1A.0.63}
...
(i.e.\ $\Xi = \rho_\Lambda/\MPl^2 \approx 10^{-123}$) with baseline
cosmology $H_0=67.7\,\text{km/s/Mpc}$, $\Omega_m=0.308$; the
$\Delta H/H_{\Lambda\rm CDM}$ deviation is ${\sim}2$--$3\%$ across $z=0$--$3$.
...
The closure argument does not rest on this amplitude being numerically small
in absolute units (a naive order-of-magnitude estimate using post-recombination
baryon densities $n_\psi\sim\mathcal{O}(10^2)\,\text{cm}^{-3}$ gives
$\rho_{\rm NJL}\sim\mathcal{O}(1)\,\text{eV}^4$ in natural units, far above
$\rho_\Lambda\sim(10^{-3}\,\text{eV})^4$);
instead, the physical suppression is that the operator
$(\bar\psi\,\gamma^a\gamma^5\,\psi)^2$ is \emph{parity-even}
and $\langle J^5\rangle\approx 0$ in an unpolarized thermal bath,
so the effective contribution to the dark-energy density vanishes
...
release (DOI to be inserted at submission) will pin all artifacts to the
