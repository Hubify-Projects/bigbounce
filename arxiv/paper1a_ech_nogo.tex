...
\newcommand{\paperVersion}{v1A.0.65}
\newcommand{\paperTimestamp}{June 12, 2026 PDT}
...
$2.6$--$5\sigma$ quote and Sec.~\ref{sec:falsification}); detailed Fisher forecast in
...
with baseline cosmology $H_0=67.7\,\text{km/s/Mpc}$, $\Omega_m=0.308$; the
...
ans\"atze. Curve families labeled $\rho=0,\,0.3,\,0.5$ correspond to the
...
$\gamma$ & Barbero-Immirzi & Fixed: 0.274 & $0.274$ (scheme range $\sim\!0.037$) & LQG area spectrum (Eq.~\ref{eq:gamma}) \\
