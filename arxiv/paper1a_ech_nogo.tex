...
\newcommand{\paperVersion}{v1A.0.25}
...
\paragraph{Real cross-vendor adversarial-review deferrals (v1A.0.21; status updated v1A.0.24 — Route 2 dimensionless reduction is now executed in-line in Sec.~\ref{sec:route2} above, no longer deferred).}
...
re-derivation---was \textbf{closed in v1A.0.24 / v1A.0.25}: the dimensionless reduction is now executed in-line in Sec.~\ref{sec:route2} above (Eq.~\ref{eq:route2_ratio}, with the $H_0\to H_0/M_{\rm Pl}$ factor restored in the numerator), no longer deferred to a dedicated photon-Chern-Simons follow-up; the channel-level amplitude
...
inflationary subhorizon ($k_{\rm bounce}\sim k\,e^{N_{\rm tot}}\sim
