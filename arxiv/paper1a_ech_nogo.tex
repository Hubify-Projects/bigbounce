...
\newcommand{\paperVersion}{v1A.0.53}
...
redshifts. (The panel's burned-in annotation quotes the equivalent bound as
a fractional contribution to the expansion rate,
$|\omega^2/H^2| < 10^{-20}$; the two statements bound the same rotation
term in different units.) The dark-energy mechanism in this paper is therefore the
...
carries no additional factors of $a$. In temporal gauge, decomposing
...
for CMB photons against the cosmological field considered here) the WKB
...
$\alpha/M \equiv C_{a\gamma}\,\alpha_{\rm em}/(2\pi f_a)$ and
