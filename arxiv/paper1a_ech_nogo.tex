...
\newcommand{\paperVersion}{v1A.0.99}
...
\emph{not} a precisely derived value, the full perturbative running being
the $|\gamma|$-dependent $\beta$-function of
Benedetti~\&~Speziale~\cite{Benedetti2011} --- and note that the Route-3
