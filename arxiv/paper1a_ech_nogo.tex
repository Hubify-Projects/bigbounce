...
\newcommand{\paperVersion}{v1A.0.37}
...
\tilde F_{\mu\nu} F^{\mu\nu}$ (the standard ALP-photon Chern-Simons coupling with all indices fully contracted; the integrated-by-parts equivalent $(\alpha/M)\,\partial_\mu\theta\, K^\mu$ where $K^\mu \equiv \epsilon^{\mu\nu\rho\sigma} A_\nu F_{\rho\sigma}$ is the standard Chern-Simons 4-current (whose divergence $\partial_\mu K^\mu = \tfrac{1}{2}\tilde F_{\mu\nu}F^{\mu\nu}$ recovers the parity-odd contraction; R23 Perplexity/Gemini PAPER-GEM-n1 inline-definition closure) is also valid; v1A.0.28 R7 GPT-M3 closure: prior $(\alpha/M)\,\partial_\mu\theta\, \tilde F^{\mu\nu} F_{\mu\nu}$ left $\mu$ uncontracted on $\partial_\mu\theta$) into the rotation angle
\begin{equation}
