...
\newcommand{\paperVersion}{v1A.0.58}
...
$R_{\mu[\nu\rho\sigma]}=0$ (equivalently, by the pair-exchange symmetry
$R_{\mu\nu\rho\sigma}=R_{\rho\sigma\mu\nu}$ combined with the antisymmetry of
$\epsilon^{\mu\nu\rho\sigma}$), and the Holst sector therefore decouples from all
...
Equivalently, the pair-exchange symmetry
$R_{\mu\nu\rho\sigma}=R_{\rho\sigma\mu\nu}$ (which requires metric compatibility
and is the more transparent route) combined with
the antisymmetry of $\epsilon^{\mu\nu\rho\sigma}$ under the same swap gives
$\epsilon^{\mu\nu\rho\sigma}R_{\mu\nu\rho\sigma} =
\epsilon^{\mu\nu\rho\sigma}R_{\rho\sigma\mu\nu} = -\epsilon^{\mu\nu\rho\sigma}R_{\mu\nu\rho\sigma}=0$;
both routes require both $T=0$ \emph{and} metric compatibility, and the
vanishing can fail in non-metric connections even when torsion is zero.
...
\end{center}
The bundle is labelled \texttt{v1A.0.58-bundle} (resynced 2026-06-10) to
track the present manuscript title and version; the bump from
\texttt{v1A.0.57-bundle} covers the R29 internal-round textual-closure edits only,
