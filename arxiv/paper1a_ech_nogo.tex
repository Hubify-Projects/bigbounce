...
\newcommand{\paperVersion}{v1A.0.26}
...
\paragraph{Real cross-vendor adversarial-review deferrals (v1A.0.21; status updated v1A.0.24 — Route 2 dimensionless reduction is now executed in-line in Sec.~\ref{sec:route2} below, no longer deferred).}
