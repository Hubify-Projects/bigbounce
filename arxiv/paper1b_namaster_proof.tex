...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.2}
\newcommand{\paperTimestamp}{2026-07-16 11:09 PT}
...
Version 0.1.1 contains 24 automated tests covering numerical behavior, invalid
