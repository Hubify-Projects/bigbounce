...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.4}
\newcommand{\paperTimestamp}{2026-07-16 11:55 PT}
...
Version 0.1.3 contains 26 automated tests covering numerical behavior, invalid
...
Version 0.1.3 requires Python 3.10 or later and NumPy 1.24 or later. PyMaster
...
must bind version 0.1.3 to an immutable archive before journal submission.
