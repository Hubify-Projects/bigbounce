...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.5}
\newcommand{\paperTimestamp}{2026-07-16 12:28 PT}
...
Version 0.1.4 contains 28 automated tests covering numerical behavior, invalid
...
\texttt{windowed\_bandpowers(response, beta\_deg=0.25)}; the complete executable
...
metadata are synchronized on POSIX systems after atomic replacement.

\paragraph{Programming language and dependencies.}
Version 0.1.4 requires Python 3.10 or later and NumPy 1.24 or later. PyMaster
...
Citation metadata are supplied in \texttt{CITATION.cff}.
\par\endgroup
...
must bind version 0.1.4 to an immutable archive before journal submission.
