...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.3}
\newcommand{\paperTimestamp}{2026-07-16 11:31 PT}
...
Version 0.1.2 contains 25 automated tests covering numerical behavior, invalid
...
Version 0.1.2 requires Python 3.10 or later and NumPy 1.24 or later. PyMaster
...
must bind version 0.1.2 to an immutable archive before journal submission.
