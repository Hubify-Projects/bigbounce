...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.8}
\newcommand{\paperTimestamp}{2026-07-16 13:31 PT}
...
Version 0.1.6 contains 41 automated tests covering numerical behavior, invalid
...
Version 0.1.6 requires Python 3.10 or later and NumPy 1.24 or later. PyMaster
...
must bind version 0.1.6 to an immutable archive before journal submission.
