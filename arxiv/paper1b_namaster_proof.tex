...
\newcommand{\paperVersion}{v2B.0.11}
\newcommand{\paperTimestamp}{2026-07-16 18:40 PT}
...
\paragraph{Archive.}
A persistent archival identifier is not yet available. This is an explicit
submission blocker, not a completed release claim. The submission candidate
must bind version 0.1.7 to an immutable archive before journal submission.
