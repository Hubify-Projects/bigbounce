...
\newcommand{\Cl}{C_\ell}
\newcommand{\paperVersion}{v2B.0.7}
\newcommand{\paperTimestamp}{2026-07-16 13:14 PT}
...
Version 0.1.5 contains 35 automated tests covering numerical behavior, invalid
...
Version 0.1.5 requires Python 3.10 or later and NumPy 1.24 or later. PyMaster
...
must bind version 0.1.5 to an immutable archive before journal submission.
