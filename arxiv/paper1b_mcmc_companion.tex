...
\begin{equation}
\Delta\phi/f_a \approx 0.42 \quad (m = 2H_0,\; \theta_i = 1;\text{ one corner of the natural-parameter box}).
\end{equation}
...
anharmonic corrections at $\mathcal{O}(\theta_i^2/12)$ shift $\Omega_a$ by $\lesssim 5\%$
for $\theta_i\sim 1$, sub-dominant to the prior width) satisfies $\Omega_a < 0.1$
