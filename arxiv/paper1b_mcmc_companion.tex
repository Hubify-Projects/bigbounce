...
\newcommand{\paperVersion}{v1B.0.99}
\newcommand{\paperTimestamp}{July 4, 2026}
...
\sim n_f^2 \sim (g_\ast\,T^3)^2$, the standard finite-temperature average of a
four-fermion (Fermi-type) contact operator in the early-universe
plasma~\cite{KapustaGale2006}, so that
\begin{equation}
...
\;\sim\;
\begin{cases}
7\times 10^{-45}, & T\!\sim\!1\ \mathrm{MeV},\\[2pt]
5\times 10^{-58}, & T\!\sim\!0.26\ \mathrm{eV},
\end{cases}
\label{eq:neff_bound}
\end{equation}
at BBN and recombination respectively.
...
samples), which is reported as ``indicative only.'' All posterior-mass
