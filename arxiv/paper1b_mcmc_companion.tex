...
\newcommand{\paperVersion}{v1B.0.64}
...
\chi^2(\beta) = \sum_b
\frac{\bigl[C_b^{EB,\rm decoupled} - \tfrac{1}{2}\sin(4\beta)\,C_b^{EE,\rm tmpl}\bigr]^2}
     {\sigma_b^2},
\end{equation}
where $C_b^{EE,\rm tmpl}$ is the Planck-2018 semi-analytic $EE$ template, $\sigma_b$ is
the per-bin Monte Carlo scatter across 500 realizations (unweighted: $\sigma_b$ is
computed from the scatter of the decoupled $EB$ spectrum itself, not the inverse-variance
weight of the template), and the sum runs over all 20 bins
$30\!\le\!\ell\!\le\!1536$.
