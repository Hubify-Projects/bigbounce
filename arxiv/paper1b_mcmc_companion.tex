...
\newcommand{\paperVersion}{v1B.0.62}
...
values, with the same $\sim 25\times$ misalignment tuning required to recover
...
$\Omega_a<0.1$             & $44\%$                   & $0.328\pm 0.100$  & post.-supported            & broad                 & post.-supported               & marginal-restricted          \\
$\Omega_a<0.01$ (safe)     & $13\%$                   & $0.28\pm 0.10$    & post.-supported            & smaller-weighted      & post.-supported               & marginal-restricted          \\
...
Table~I and the Table~III/Table~IV reproducibility and
claim-classification entries of this paper:
