...
\newcommand{\paperVersion}{v1B.0.78}
\newcommand{\paperTimestamp}{June 26, 2026}
...
(tail-distances $+4.3\sigma$ in $w_0$, $-3.6\sigma$ in
...
$w_0+w_a = -1.48 \pm 0.15$ indicating phantom crossing; these figures
...
\textit{Spectator-ALP consistency.}---Within the $\Omega_a < 0.01$ spectator-safe
subset ($13\%$ of the posterior mass; median $m\simeq 40.5\,H_0$,
$\Omega_a < 0.01$), an ALP with $f_a\sim\MPl$ and posterior median $m\simeq 40.5\,H_0$ (not $m\sim H_0$; the scan-prior envelope spans $m\sim H_0$ but the posterior-supported fixed-$C_{a\gamma}=8$ fit shifts well above the prior midpoint)
