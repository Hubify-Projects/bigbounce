...
\newcommand{\paperVersion}{v1B.0.49}
...
bias of $0.032^\circ$. The $\sim\!12\%$ multiplicative under-recovery is
...
and $69\%$ of the posterior mass falls inside the EOM-required band $[9,51]$
(22\% below, consistent with the low-$\Delta\phi/f_a$ tail). The recovered
...
the full required coupling range rather than at fixed benchmarks. Convergence:
...
$\beta = 0.324^\circ\pm 0.099^\circ$, is consistent within $1\sigma$ with
...
constant-product degeneracy enforced by the $EB$-spectrum data through
...
\textit{Likelihood stack.}---Both fits use a Gaussian summary likelihood on
the published joint Planck PR4 + ACT~DR6 isotropic-birefringence measurement
$\beta_{\rm obs}=0.342^\circ\pm0.094^\circ$~\cite{Eskilt2022,DiegoPalazuelos2025}
--- i.e.\ the constraint enters at the level of the published combined
$\beta$ posterior, not as a direct re-analysis of the $EB$ spectra. The MCMC
