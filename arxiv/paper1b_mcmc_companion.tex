...
\newcommand{\paperVersion}{v1B.0.38}
...
$\beta=0.342^\circ\pm 0.094^\circ$ ($3.6\sigma$)~\cite{Eskilt2022} without
...
to $\sim 51$. The lower end ($\sim 9$) sits within standard
GUT-scale / DFSZ benchmark ranges; the upper end ($\sim 51$) is large
relative to simple ALP benchmarks and requires either a UV-completion that
enhances the photon coupling (e.g.\ chiral fermion-loop enhancement,
clockwork constructions) or a field displacement at the upper end of the
