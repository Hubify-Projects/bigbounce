...
\newcommand{\paperVersion}{v1B.0.41}
\newcommand{\paperTimestamp}{2026-06-02 PDT}
...
enhancement well above standard KSVZ/DFSZ $\mathcal{O}(1)$ benchmarks. We previously
closed an earlier reported product
...
$\beta = 0.342^\circ$ by a factor of $\sim 3$.
