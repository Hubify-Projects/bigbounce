...
\newcommand{\paperVersion}{v1B.0.68}
...
forward as the pipeline-recovery bias floor --- both are MC
...
the repository \texttt{CHANGELOG.md} (entry for the v1B.0.59 closure
wave) and in the adjacent
