...
\newcommand{\paperVersion}{v1B.0.40}
...
of any single parameter (see Appendix~\ref{app:alp_priors} for the full ALP-MCMC
sampled-parameter list, priors, and dataset-likelihood configuration).
...
benchmark, but the upper-coupling end is not generic. R2
