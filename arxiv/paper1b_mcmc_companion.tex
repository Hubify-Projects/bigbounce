...
\url{https://github.com/Hubify-Projects/bigbounce/tree/paper1b-v1B.0.36/reproducibility}.
...
background (as in Sec.~\ref{sec:cosmo_fits} iter2) shifts $H(z)$ at
...
\url{https://github.com/Hubify-Projects/bigbounce} (pinned to tag \texttt{paper1b-v1B.0.36})
contains:
