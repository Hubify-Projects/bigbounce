...
\newcommand{\paperVersion}{v1B.0.60}
...
by default: $Y_{\rm He}$ is set self-consistently with $\Neff$ at each
MCMC sample. The prior range $\Neff\in[2.046, 5.046]$ remains within the
