...
\newcommand{\paperVersion}{v1B.0.96}
\newcommand{\paperTimestamp}{July 2, 2026}
...
$\Delta\Neff$ & Extra effective relativistic degrees of freedom (generic radiation-like proxy, \emph{not} a spin-torsion prediction) \\
