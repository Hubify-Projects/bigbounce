...
\newcommand{\paperVersion}{v1B.0.92}
...
are converged only to $R\!-\!1\approx0.06$, which is above the
$R\!-\!1<0.01$ Gelman--Rubin threshold used for the load-bearing
$\Lambda$CDM$+\Delta\Neff$ chains of Sec.~\ref{sec:cosmo_fits}. At this
