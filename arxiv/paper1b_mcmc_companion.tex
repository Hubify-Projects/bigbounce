...
\newcommand{\paperVersion}{v1B.0.87}
...
a ${\sim}25$-fold fine-tuning of the misalignment initial condition
relative to the natural $\cos\theta_i$-flat prior midpoint, quantified
...
\emph{deferred to a dedicated follow-up}: they require fresh MPI MCMC runs
beyond the compute scope of this verification companion, and until they are
run no robustness of the quintom-B direction against the overlap systematic
is claimed. The goodness-of-fit decomposition ($\chi^2_{\rm BAO}$,
