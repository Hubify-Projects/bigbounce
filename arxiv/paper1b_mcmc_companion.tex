...
\newcommand{\paperVersion}{v1B.0.97}
...
$\propto\kappa^2\propto G_N^2\sim M_{\rm Pl}^{-4}$: the interaction is
Planck-suppressed. In a thermal fermion gas the coherent spin-torsion energy
density is $\rho_{\rm tor}\sim\alpha\,n_f^2$ with $\alpha=\kappa(\hbar
