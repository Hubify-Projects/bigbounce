...
\newcommand{\paperVersion}{v1B.0.8}
...
auditable script is on-record-deferred to v1B.0.8.
...
P1(b) & v1B.0.7 & 66\% & Model-comparison recompute (deferred v1B.0.8) \\
...
2026-05-14 22:53~UTC the chain has accumulated $59{,}832$ accepted
samples across the 16 chains and reports $\hat R - 1 = 0.01945$
(slow-mode-dominated; see Table~\ref{tab:mcmc_inventory} caption); we
...
Model-comparison $\Delta$AIC/BIC/$\ln B$               & Numerical & Deferred & Removed v1B.0.7; recompute v1B.0.8 \\
