...
Phenomenological Constraints, Structural Barriers, and Perturbation Transparency}
...
$\sigma_8$/$S_8$ tension ($2$--$3\sigma$) & $\sigma_8 = 0.803$; $S_8 = 0.814$ & Standard (Planck-consistent)$^b$ \\
...
\item \textit{MCMC verification revealing null result}: Independent Cobaya verification across two frozen dataset combinations demonstrates that $\Delta\Neff$ is consistent with zero, $H_0$ recovers the standard Planck $\Lambda$CDM value of $67.68 \pm 1.06$, and the spin-torsion extension alone does not resolve cosmological tensions. The earlier reported tension reduction was driven by the SH0ES prior, not by the framework.
...
\textit{Sound-horizon-free $H_0$.}---Pantos \& Perivolaropoulos~\cite{Pantos2026} compiled a diverse set of sound-horizon-free $H_0$ measurements, finding convergence at $H_0 = 69.37 \pm 0.34$. This is $1.5\sigma$ above our verification value of $67.68 \pm 1.06$, indicating that the spin-torsion framework does not naturally explain the sound-horizon-free measurement.
...
$H_0$ (km/s/Mpc) & 67.4 or 73.0 & 68--71 & 68--70 & $\mathbf{67.68\pm 1.06}$ \\
$\sigma_8$ & 0.811 or 0.766 & 0.79--0.82 & 0.78--0.80 & $\mathbf{0.803\pm 0.008}$ \\
$H_0$ tension (vs.\ SH0ES) & ${\sim}4.9\sigma$ & Partial & Partial & $\mathbf{3.6\sigma}$ (not resolved) \\
$\sigma_8$ tension (vs.\ Planck) & $2$--$3\sigma$ & Marginal & Partial & \textbf{Standard} \\
...
\textbf{Spin-Torsion} & $(\alpha/M)\Dinf+c_\omega\omega^2$ & $\sim\mathbf{10^{5}}$\footnote{Reparameterized as sensitivity to $N_{\rm tot}$, not solved; see Sec.~\ref{sec:gdp}.} \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
$\Delta \Neff$ & Extra species & Flat $[0,1]$ & $-0.020\pm 0.169$\,\textsuperscript{a} & Consistent with zero \\
