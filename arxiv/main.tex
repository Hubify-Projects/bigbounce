...
\item \textit{ALP birefringence consistency}: A spectator ALP with natural parameters ($f_a \sim \MPl$, $m \sim H_0$) reproduces the observed cosmic birefringence $\beta = 0.242^\circ \pm 0.061^\circ$ ($3.9\sigma$) without fine-tuning, providing a consistency check between the ECH parity structure and CMB polarization data.
\end{enumerate}
