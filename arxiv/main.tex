...
\hline
$H_0$ tension (${\sim}4.9\sigma$, Planck--SH0ES) & $69.2\pm 0.8$ km/s/Mpc & $2.9\sigma$ vs.\ SH0ES$^a$ \\
...
\end{ruledtabular}
\vspace{2pt}
{\small $^a$$(69.2-73.04)/\sqrt{0.8^2+1.04^2} = 2.93\sigma$. \quad $^b$Our derived $S_8 = 0.80 \pm 0.02$ vs.\ DES~Y3 ($S_8 = 0.776 \pm 0.017$): $(0.80-0.776)/\sqrt{0.02^2+0.017^2} = 0.91\sigma$; Planck $\Lambda$CDM gives $S_8 = 0.832$, which is ${\sim}3\sigma$ from DES~Y3.\\[3pt]
...
Independent verification using Cobaya~v3.6.1 with Planck NPIPE CamSpec TTTEEE + lowl TT/EE + lensing has produced two frozen dataset combinations with publication-quality convergence. A third (Planck-only) is in progress and a fourth (Planck+BAO) is pending; results will be incorporated when available.
...
Min ESS & 4{,}744 & 4{,}692 \\
\hline
Planck-only & \multicolumn{2}{c}{\textit{[PENDING---in progress]}} \\
Planck+BAO & \multicolumn{2}{c}{\textit{[PENDING---not yet started]}} \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
\item \textit{Posterior distributions}: The original analysis reported Fisher-matrix error estimates; independent verification with full MCMC chains (Sec.~\ref{sec:verification}) now provides posterior distributions for two of four dataset combinations, with the remaining two in progress. Corner plots showing parameter degeneracies (particularly the strong $r(\alpha/M,\Dinf)=-0.89$ anticorrelation) will be presented in a companion data release.
\end{itemize}
