...
\end{itemize}
The spread from ${\sim}0.17^\circ$ to ${\sim}0.34^\circ$ across these measurements reflects genuine differences in methodology (different data, masks, galactic contamination levels, and analysis pipelines), not internal inconsistency. All values are mutually consistent within $1$--$2\sigma$. The ALP model's natural parameter range comfortably brackets all measurements. We adopt the ACT~DR6 measurement $\beta = 0.342^\circ \pm 0.094^\circ$ ($3.6\sigma$, Eskilt~\etal\ joint Planck+ACT) as the headline observational constraint, as it represents the most precise joint single-analysis determination. Combined values from inverse-variance combinations of Planck and ACT range from $0.242^\circ$ to $0.342^\circ$ depending on methodology and systematics treatment.
