...
\newcommand{\paperVersion}{v1C.0.11}
...
four-fermion contact operator $\kappa^{2}(J^5\!\cdot\!J^5)$ --- itself
parity-even (Appendix~\ref{app:parity}); the parity-odd label belongs to
