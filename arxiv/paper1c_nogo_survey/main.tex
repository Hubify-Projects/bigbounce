...
\newcommand{\paperVersion}{v1C.0.3}
...
Applying $F$ to the current--current product $(J^5\!\cdot\!J^5)$ requires,
beyond the c-number matrix identity of Eq.~(\ref{eq:fierzmatrix}), the
anticommuting-field (Grassmann) exchange step appropriate to a genuine
operator rearrangement, $F_{\rm op}=-F_{\rm c}$. The resulting
operator-level decomposition is
