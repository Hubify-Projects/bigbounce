...
\newcommand{\paperVersion}{v1C.0.7}
...
Appendix~\ref{app:fierz}); the third independently adjudicates the Fierz
...
commit
\href{https://github.com/Hubify-Projects/bigbounce/tree/9b92721d5d7eb6601ebf48c49379318238b7100b}{\texttt{9b92721d5d7e}}\footnote{A
later repository revision clarifies the first script's descriptive text
only; the checks performed and their pass/fail results are identical.}.
...
(CC-BY-4.0, deposited 2026 July 22)~\cite{Golden2026P1a}, whereas the
2026-08-05 adjudication artifacts listed above post-date that deposit
and are available at the pinned repository commit only, not within the
Zenodo deposit.
