...
\newcommand{\paperVersion}{v1C.0.4}
...
appendix~\cite{Golden2026P1a} and giving the mean-field scalar-channel
coupling $G_s=-3\kappa/16$ quoted in Sec.~\ref{sec:conventions}. This
