...
%%
%% CANONICAL SOURCE: ../paper1b_namaster_proof.tex  (v2B.0.16, 2026-07-24)
...
Python. \software{} version 0.1.7 requires Python 3.10 or later.
...
cited above. The separate stamp carried in this document's page header
