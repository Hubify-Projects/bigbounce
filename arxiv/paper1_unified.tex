...
\newcommand{\paperVersion}{v1U.0.8}
...
$-1+2=+1$). We state this off-shell mismatch deliberately.
\emph{The dimension-$+1$ form of Eq.~\eqref{eq:Seff_comp} is an on-shell
presentation shorthand, not the fundamental action term.} The formally
dimension-$4$, gauge-invariant, diffeomorphism-covariant off-shell operator
of which it is the leading representative is the closed local expansion
...
invariant. Concretely, the six densities are (names as in
