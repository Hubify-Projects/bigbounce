...
\newcommand{\paperVersion}{v1U.0.16}
...
coupling is far sub-critical; mean-field NJL framework),
...
$G_{\rm PP}=+\tfrac{3}{64}\kappa>0$; these are not excluded by the sign leg but
are disposed of by the magnitude leg below, since
$|G_{\rm PP}|=|G_{\rm scalar}|$ is equally sub-critical.) Second,
...
Fierz-projected repulsive and the coupling far sub-critical
...
disposed of by leg (B) below, since $|G_{\rm PP}|=|G_{\rm scalar}|$ is equally
