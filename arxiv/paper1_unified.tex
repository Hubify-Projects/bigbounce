...
\newcommand{\paperVersion}{v1U.0.15}
...
strength or cutoff, so no condensate forms. Second,
the magnitude: even taking $|G_{\rm eff}|$, the coupling is far sub-critical
...
condensate forms at any coupling strength or cutoff}. \textbf{(B) Magnitude (belt-and-suspenders).}
...
any coupling), and $|G_{\rm eff}|$ is far sub-critical in every case scanned.
