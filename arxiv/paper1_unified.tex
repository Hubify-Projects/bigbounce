...
%
% UNIFIED PAPER 1: P1A body + P1B (MCMC / NaMaster / spectator-ALP) folded in as appendices.
% Built by merge/p1-unified worktree from paper1a_ech_nogo.tex (v1A.0.113) + paper1b_mcmc_companion.tex (v1B.0.103).
% All P1B content is now IN-PAPER: every former companion-imported number resolves to an internal \ref.
...
\newcommand{\paperVersion}{v1A.0.113}
...
(the folded MCMC/reproducibility appendices, II, III, IV; all posted concurrently in the coordinated submission,
...
Appendix~\ref{app:cosmo_methodology}, coordinated submission), consolidated in
...
as independently peer-reviewable values until the folded MCMC/reproducibility appendices is publicly
...
\colrule
$H_0$ & $67.68\pm 1.06$ km/s/Mpc & Appendix~\ref{app:cosmo_methodology} &
...
samples).\strut} \\[3pt]
$\Delta\Neff$ & $-0.020\pm 0.169$ (full-tension) & Appendix~\ref{app:cosmo_methodology} &
\parbox[t]{0.36\textwidth}{\raggedright Same joint MCMC chain; consistent with
$0$.\strut} \\[3pt]
$\sigma_8$ & $0.803\pm 0.008$ & Appendix~\ref{app:cosmo_methodology} &
\parbox[t]{0.36\textwidth}{\raggedright Derived parameter of the same MCMC
chain.\strut} \\[3pt]
$\Omega_m$ & $0.308\pm 0.005$ & Appendix~\ref{app:cosmo_methodology} &
\parbox[t]{0.36\textwidth}{\raggedright Derived parameter of the same MCMC
chain.\strut} \\[3pt]
...
NaMaster $EB$ pipeline & validated & Appendix~\ref{app:cosmo_methodology} &
...
on convergence of the dedicated the folded MCMC/reproducibility appendices chain.
...
convergence diagnostics are in the folded MCMC/reproducibility appendices (Appendix~\ref{app:cosmo_methodology}).
\end{itemize}
...
MCMC analysis (Appendix~\ref{app:cosmo_methodology}) and are not independently
