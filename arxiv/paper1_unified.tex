...
\newcommand{\paperVersion}{v1U.0.6}
...
$\MPl^{2}$ inside the operator definition. This is the point ChatGPT's W12
referee pass correctly raised: calling the bare invariants ``dimension-$4$
with dimensionless $c_n$'' was a bookkeeping slip; the corrected definitions
above carry the $\MPl^{2}$ prefactors explicitly so that every
