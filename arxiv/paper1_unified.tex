...
\newcommand{\paperVersion}{v1U.0.18}
...
(Jackiw-Pi gravitational Chern-Simons $R\!\wedge\!\tilde R$; the vector--axial
four-fermion partner with $\gamma_{\rm BI}/(\gamma_{\rm BI}^2+1)\cdot 8\pi G$
coefficient, which per Freidel--Minic--Takeuchi arises only under non-minimal
fermion coupling --- minimal coupling gives only the axial--axial R1 term) are now closed explicitly at the operator level
...
(Appendix~\ref{app:dim4_completion}, with the two load-bearing tensor
identities verified symbolically --- the $\varepsilon R=0$ Bianchi contraction
and the Lorentzian $\varepsilon\varepsilon=-3!\,\delta$ collapse --- not a completeness
proof, which is argued analytically): every enumerated
