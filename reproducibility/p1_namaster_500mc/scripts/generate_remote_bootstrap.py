...
{checks}
{chr(10).join(install)}
python reproducibility/p1_namaster_500mc/scripts/remote_production_runner.py --manifest {shlex.quote(str(manifest_path.resolve()))} --repo {shlex.quote(str(repo))} --state-dir {shlex.quote(str(state_dir.resolve()))}
"""
